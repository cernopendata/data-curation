# /cdaq/physics/Run2012PI/PilotRun/PIHLT/V4 (CMSSW_5_2_6_HLT3)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string( '/cdaq/physics/Run2012PI/PilotRun/PIHLT/V4' )
)
...
process.datasets = cms.PSet(
  ...
  ExpressPhysics = cms.vstring( 'HLT_PAL1Tech53_MB_v1',
    'HLT_PARandom_v1',
...
process.hcalRecAlgos = cms.ESProducer( "HcalRecAlgoESProducer",
  ...
  SeverityLevels = cms.VPSet(
    ...
    cms.PSet(
      RecHitFlags = cms.vstring( "HBHEHpdHitMultiplicity", "HFDigiTime", "HBHEPulseShape", "HOBit", "HFInTimeWindow", "ZDCBit", "CalibrationBit", "TimingErrorBit", "HBHEFlatNoise", "HBHESpikeNoise", "HBHETriangleNoise", "HBHETS4TS5Noise" ),
      ChannelStatus = cms.vstring(  ),
      Level = cms.int32( 8 )
    ),
    cms.PSet(
      RecHitFlags = cms.vstring( "HFLongShort", "HFS8S1Ratio", "HFPET" ),
      ChannelStatus = cms.vstring(  ),
      Level = cms.int32( 11 )
    ),
    cms.PSet(
...
process.hltESPAK5CaloL1L2L3 = cms.ESProducer( "JetCorrectionESChain",
  correctors = cms.vstring( "hltESPL1FastJetCorrectionESProducer", "hltESPL2RelativeCorrectionESProducer", "hltESPL3AbsoluteCorrectionESProducer" ),
  appendToDataLabel = cms.string( "" )
)
process.hltESPAK5CaloL2L3 = cms.ESProducer( "JetCorrectionESChain",
  correctors = cms.vstring( "hltESPL2RelativeCorrectionESProducer", "hltESPL3AbsoluteCorrectionESProducer" ),
  appendToDataLabel = cms.string( "" )
)
process.hltESPAK5PFL1L2L3 = cms.ESProducer( "JetCorrectionESChain",
  correctors = cms.vstring( "hltESPL1PFFastJetCorrectionESProducer", "hltESPL2PFRelativeCorrectionESProducer", "hltESPL3PFAbsoluteCorrectionESProducer" ),
  appendToDataLabel = cms.string( "" )
)
process.hltESPAK5PFNoPUL1L2L3 = cms.ESProducer( "JetCorrectionESChain",
  correctors = cms.vstring( "hltESPL1PFNoPUFastJetCorrectionESProducer", "hltESPL2PFNoPURelativeCorrectionESProducer", "hltESPL3PFNoPUAbsoluteCorrectionESProducer" ),
  appendToDataLabel = cms.string( "" )
)
...
process.MessageLogger = cms.Service( "MessageLogger",
  ...
  limit = cms.untracked.string( "" ),
  timespan = cms.untracked.string( "" ),
  suppressError = cms.untracked.vstring( "hltOnlineBeamSpot", "hltL3MuonCandidates", "hltL3TkTracksFromL2OIState", "hltPFJetCtfWithMaterialTracks", "hltL3TkTracksFromL2IOHit", "hltL3TkTracksFromL2OIHit" )
)
...
process.PrescaleService = cms.Service( "PrescaleService",
  ...
  prescaleTable = cms.VPSet(
    cms.PSet(
      pathName = cms.string( "HLT_Activity_Ecal_SC7_v13" ),
      prescales = cms.vuint32( 0, 0, 0, 0, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_BeamGas_HF_Beam1_v5" ),
      prescales = cms.vuint32( 0, 0, 0, 0, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_BeamGas_HF_Beam2_v5" ),
      prescales = cms.vuint32( 0, 0, 0, 0, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_BeamHalo_v13" ),
      prescales = cms.vuint32( 0, 0, 0, 0, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_HcalPhiSym_v11" ),
      prescales = cms.vuint32( 0, 0, 0, 0, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_HcalNZS_v10" ),
      prescales = cms.vuint32( 0, 0, 0, 0, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_GlobalRunHPDNoise_v8" ),
      prescales = cms.vuint32( 0, 0, 0, 0, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_Physics_v5" ),
      prescales = cms.vuint32( 10000, 10000, 10000, 10000, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "DST_Physics_v5" ),
      prescales = cms.vuint32( 0, 0, 0, 0, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "AlCa_EcalPhiSym_v13" ),
      prescales = cms.vuint32( 60, 60, 60, 30, 60 )
    ),
    cms.PSet(
      pathName = cms.string( "AlCa_RPCMuonNoTriggers_v9" ),
      prescales = cms.vuint32( 0, 0, 0, 0, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "AlCa_RPCMuonNoHits_v9" ),
      prescales = cms.vuint32( 0, 0, 0, 0, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "AlCa_RPCMuonNormalisation_v9" ),
      prescales = cms.vuint32( 0, 0, 0, 0, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "AlCa_LumiPixels_ZeroBias_v4" ),
      prescales = cms.vuint32( 1113, 1113, 1113, 550, 1113 )
    ),
    cms.PSet(
      pathName = cms.string( "AlCa_LumiPixels_Random_v1" ),
      prescales = cms.vuint32( 30, 30, 30, 30, 30 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1SingleJet16_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1SingleJet36_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PASingleForJet15_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PASingleForJet25_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAak5CaloJet20_NoJetID_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAak5CaloJet40_NoJetID_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAak5CaloJet60_NoJetID_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1SingleMuOpen_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1SingleMu3_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1SingleMu7_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1SingleMu12_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1DoubleMu0_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PADimuon0_NoVertexing_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAMu5_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAMu8_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1SingleEG5_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1SingleEG7_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1SingleEG12_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAPhoton10_CaloIdVL_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAPhoton15_CaloIdVL_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAPhoton20_CaloIdVL_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAPhoton30_CaloIdVL_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1ETM30_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1ETM70_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAPixelTracks_Multiplicity70_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAPixelTracks_Multiplicity90_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PARomanPots_Tech52_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1Tech53_MB_SingleTrack_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1Tech54_ZeroBias_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAT1minbias_Tech55_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1Tech_HBHEHO_totalOR_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAMinBiasHF_v1" ),
      prescales = cms.vuint32( 3, 2, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAMinBiasHF_OR_v1" ),
      prescales = cms.vuint32( 3, 2, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAMinBiasBSC_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAMinBiasBSC_OR_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAMinBiasHfOrBSC_v1" ),
      prescales = cms.vuint32( 3, 2, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAZeroBias_v1" ),
      prescales = cms.vuint32( 191, 191, 191, 97, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAZeroBiasPixel_SingleTrack_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAHFOR_SingleTrack_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAZeroBiasPixel_DoubleTrack_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PADoubleMu4_Acoplanarity03_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAExclDijet35_HFAND_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1DoubleEG3_FwdVeto_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PAL1DoubleJet20_RomanPotsOR_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PADoubleJet20_ForwardBackward_v1" ),
      prescales = cms.vuint32( 1, 1, 1, 1, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_PARandom_v1" ),
      prescales = cms.vuint32( 0, 0, 0, 0, 30 )
    ),
    cms.PSet(
      pathName = cms.string( "DQM_FEDIntegrity_v11" ),
      prescales = cms.vuint32( 10, 10, 10, 10, 10 )
    ),
    cms.PSet(
      pathName = cms.string( "HLT_LogMonitor_v4" ),
      prescales = cms.vuint32( 0, 0, 0, 0, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "BOutput" ),
      prescales = cms.vuint32( 0, 0, 0, 0, 0 )
    ),
    cms.PSet(
      pathName = cms.string( "DQMOutput" ),
  ...
  lvl1DefaultLabel = cms.string( "PAPilotEM" ),
  lvl1Labels = cms.vstring( "PAPilotEM", "PAPilot8BunchesEM", "PAPilot8Bunches", "PAPilot4Bunches", "Interfill" )
)
...
process.hltLogMonitorFilter = cms.EDFilter( "HLTLogMonitorFilter",
  ...
  categories = cms.VPSet(
    cms.PSet(
      name = cms.string( "TooManyTriplets" ),
    ...
    cms.PSet(
      name = cms.string( "L3MuonCandidateProducer" ),
      threshold = cms.uint32( 0 )
    ),
    cms.PSet(
      name = cms.string( "MatrixInversionFailure" ),
      threshold = cms.uint32( 0 )
    ),
    cms.PSet(
      name = cms.string( "BasicTrajectoryState" ),
      threshold = cms.uint32( 0 )
    )
  )
)
...
process.hltPreExpressOutputSmart = cms.EDFilter( "TriggerResultsFilter",
  ...
  triggerConditions = cms.vstring( "HLT_PAL1Tech53_MB_v1 / 6", "HLT_PAZeroBiasPixel_SingleTrack_v1 / 6", "HLT_PARandom_v1" ),
  throw = cms.bool( True ),
  daqPartitions = cms.uint32( 1 )
)
...
process.hltPreHLTDQMOutputSmart = cms.EDFilter( "TriggerResultsFilter",
  ...
  l1techIgnorePrescales = cms.bool( False ),
  hltResults = cms.InputTag( "TriggerResults" ),
  triggerConditions = cms.vstring( "HLT_PASingleForJet15_v1", "HLT_PASingleForJet25_v1", "HLT_PAMu5_v1", "HLT_PAMu8_v1" ),
  throw = cms.bool( True ),
  daqPartitions = cms.uint32( 1 )
)
...
process.hltOutputA = cms.OutputModule( "ShmStreamConsumer",
  SelectEvents = cms.untracked.PSet(
    SelectEvents = cms.vstring( "HLT_Activity_Ecal_SC7_v13", "HLT_BeamGas_HF_Beam1_v5", "HLT_BeamGas_HF_Beam2_v5", "HLT_BeamHalo_v13", "HLT_GlobalRunHPDNoise_v8", "HLT_HcalNZS_v10", "HLT_HcalPhiSym_v11", "HLT_LogMonitor_v4", "HLT_PADimuon0_NoVertexing_v1", "HLT_PADoubleJet20_ForwardBackward_v1", "HLT_PADoubleMu4_Acoplanarity03_v1", "HLT_PAExclDijet35_HFAND_v1", "HLT_PAHFOR_SingleTrack_v1", "HLT_PAL1DoubleEG3_FwdVeto_v1", "HLT_PAL1DoubleJet20_RomanPotsOR_v1", "HLT_PAL1DoubleMu0_v1", "HLT_PAL1ETM30_v1", "HLT_PAL1ETM70_v1", "HLT_PAL1SingleEG12_v1", "HLT_PAL1SingleEG5_v1", "HLT_PAL1SingleEG7_v1", "HLT_PAL1SingleJet16_v1", "HLT_PAL1SingleJet36_v1", "HLT_PAL1SingleMu12_v1", "HLT_PAL1SingleMu3_v1", "HLT_PAL1SingleMu7_v1", "HLT_PAL1SingleMuOpen_v1", "HLT_PAL1Tech53_MB_SingleTrack_v1", "HLT_PAL1Tech53_MB_v1", "HLT_PAL1Tech54_ZeroBias_v1", "HLT_PAL1Tech_HBHEHO_totalOR_v1", "HLT_PAMinBiasBSC_OR_v1", "HLT_PAMinBiasBSC_v1", "HLT_PAMinBiasHF_OR_v1", "HLT_PAMinBiasHF_v1", "HLT_PAMinBiasHfOrBSC_v1", "HLT_PAMu5_v1", "HLT_PAMu8_v1", "HLT_PAPhoton10_CaloIdVL_v1", "HLT_PAPhoton15_CaloIdVL_v1", "HLT_PAPhoton20_CaloIdVL_v1", "HLT_PAPhoton30_CaloIdVL_v1", "HLT_PAPixelTracks_Multiplicity70_v1", "HLT_PAPixelTracks_Multiplicity90_v1", "HLT_PARandom_v1", "HLT_PARomanPots_Tech52_v1", "HLT_PASingleForJet15_v1", "HLT_PASingleForJet25_v1", "HLT_PAT1minbias_Tech55_v1", "HLT_PAZeroBiasPixel_DoubleTrack_v1", "HLT_PAZeroBiasPixel_SingleTrack_v1", "HLT_PAZeroBias_v1", "HLT_PAak5CaloJet20_NoJetID_v1", "HLT_PAak5CaloJet40_NoJetID_v1", "HLT_PAak5CaloJet60_NoJetID_v1", "HLT_Physics_v5" )
  ),
  outputCommands = cms.untracked.vstring( "drop *", "keep *_hltL1GtObjectMap_*_*", "keep FEDRawDataCollection_rawDataCollector_*_*", "keep FEDRawDataCollection_source_*_*", "keep edmTriggerResults_*_*_*", "keep triggerTriggerEvent_*_*_*" )
)
process.hltOutputALCAP0 = cms.OutputModule( "ShmStreamConsumer",
  SelectEvents = cms.untracked.PSet(
    SelectEvents = cms.vstring( "AlCa_EcalEtaEBonly_v6", "AlCa_EcalEtaEEonly_v6", "AlCa_EcalPi0EBonly_v6", "AlCa_EcalPi0EEonly_v6" )
  ),
  outputCommands = cms.untracked.vstring( "drop *", "keep *_hltAlCaEtaEBUncalibrator_*_*", "keep *_hltAlCaEtaEEUncalibrator_*_*", "keep *_hltAlCaEtaRecHitsFilterEEonly_etaEcalRecHitsES_*", "keep *_hltAlCaPi0EBUncalibrator_*_*", "keep *_hltAlCaPi0EEUncalibrator_*_*", "keep *_hltAlCaPi0RecHitsFilterEEonly_pi0EcalRecHitsES_*", "keep L1GlobalTriggerReadoutRecord_hltGtDigis_*_*", "keep edmTriggerResults_*_*_*" )
)
process.hltOutputALCAPHISYM = cms.OutputModule( "ShmStreamConsumer",
  SelectEvents = cms.untracked.PSet(
    SelectEvents = cms.vstring( "AlCa_EcalPhiSym_v13" )
  ),
  outputCommands = cms.untracked.vstring( "drop *", "keep *_hltAlCaPhiSymUncalibrator_*_*", "keep L1GlobalTriggerReadoutRecord_hltGtDigis_*_*", "keep edmTriggerResults_*_*_*", "keep triggerTriggerEvent_*_*_*" )
)
process.hltOutputALCALUMIPIXELS = cms.OutputModule( "ShmStreamConsumer",
  SelectEvents = cms.untracked.PSet(
    SelectEvents = cms.vstring( "AlCa_LumiPixels_Random_v1", "AlCa_LumiPixels_ZeroBias_v4", "AlCa_LumiPixels_v8" )
  ),
  outputCommands = cms.untracked.vstring( "drop *", "keep *_hltFEDSelectorLumiPixels_*_*", "keep L1GlobalTriggerReadoutRecord_hltGtDigis_*_*", "keep edmTriggerResults_*_*_*" )
)
process.hltOutputCalibration = cms.OutputModule( "ShmStreamConsumer",
  SelectEvents = cms.untracked.PSet(
    SelectEvents = cms.vstring( "HLT_DTCalibration_v2", "HLT_EcalCalibration_v3", "HLT_HcalCalibration_v3" )
  ),
  outputCommands = cms.untracked.vstring( "drop *", "keep *_hltDTCalibrationRaw_*_*", "keep *_hltEcalCalibrationRaw_*_*", "keep *_hltHcalCalibrationRaw_*_*", "keep edmTriggerResults_*_*_*", "keep triggerTriggerEvent_*_*_*" )
)
process.hltOutputEcalCalibration = cms.OutputModule( "ShmStreamConsumer",
  SelectEvents = cms.untracked.PSet(
    SelectEvents = cms.vstring( "HLT_EcalCalibration_v3" )
  ),
  outputCommands = cms.untracked.vstring( "drop *", "keep *_hltEcalCalibrationRaw_*_*", "keep edmTriggerResults_*_*_*", "keep triggerTriggerEvent_*_*_*" )
)
process.hltOutputExpress = cms.OutputModule( "ShmStreamConsumer",
  SelectEvents = cms.untracked.PSet(
    SelectEvents = cms.vstring( "HLT_PAL1Tech53_MB_v1", "HLT_PARandom_v1", "HLT_PAZeroBiasPixel_SingleTrack_v1" )
  ),
  outputCommands = cms.untracked.vstring( "drop *", "keep *_hltL1GtObjectMap_*_*", "keep FEDRawDataCollection_rawDataCollector_*_*", "keep FEDRawDataCollection_source_*_*", "keep edmTriggerResults_*_*_*", "keep triggerTriggerEvent_*_*_*" )
)
process.hltOutputHLTDQM = cms.OutputModule( "ShmStreamConsumer",
  SelectEvents = cms.untracked.PSet(
    SelectEvents = cms.vstring( "HLT_PAMu5_v1", "HLT_PAMu8_v1", "HLT_PASingleForJet15_v1", "HLT_PASingleForJet25_v1" )
  ),
  outputCommands = cms.untracked.vstring( "drop *", "keep *_hltTriggerSummaryAOD_*_*", "keep DcsStatuss_hltScalersRawToDigi_*_*", "keep L1GlobalTriggerReadoutRecord_hltGtDigis_*_*", "keep LumiScalerss_hltScalersRawToDigi_*_*", "keep edmTriggerResults_*_*_*" )
)
process.hltOutputHLTMON = cms.OutputModule( "ShmStreamConsumer",
  SelectEvents = cms.untracked.PSet(
    SelectEvents = cms.vstring( "AlCa_EcalEtaEBonly_v6", "AlCa_EcalEtaEEonly_v6", "AlCa_EcalPhiSym_v13", "AlCa_EcalPi0EBonly_v6", "AlCa_EcalPi0EEonly_v6", "AlCa_LumiPixels_Random_v1", "AlCa_LumiPixels_ZeroBias_v4", "AlCa_LumiPixels_v8", "AlCa_RPCMuonNoHits_v9", "AlCa_RPCMuonNoTriggers_v9", "AlCa_RPCMuonNormalisation_v9", "HLT_Activity_Ecal_SC7_v13", "HLT_BeamGas_HF_Beam1_v5", "HLT_BeamGas_HF_Beam2_v5", "HLT_BeamHalo_v13", "HLT_GlobalRunHPDNoise_v8", "HLT_HcalCalibration_v3", "HLT_HcalNZS_v10", "HLT_HcalPhiSym_v11", "HLT_LogMonitor_v4", "HLT_PAL1ETM30_v1", "HLT_PAL1SingleEG5_v1", "HLT_PAL1SingleJet16_v1", "HLT_PAL1SingleJet36_v1", "HLT_PAL1SingleMu12_v1", "HLT_PAL1SingleMuOpen_v1", "HLT_PAL1Tech_HBHEHO_totalOR_v1", "HLT_PAMu5_v1", "HLT_PAMu8_v1", "HLT_PAPixelTracks_Multiplicity70_v1", "HLT_PARandom_v1", "HLT_PASingleForJet15_v1", "HLT_PASingleForJet25_v1", "HLT_PAZeroBiasPixel_DoubleTrack_v1", "HLT_Physics_v5" )
  ),
  outputCommands = cms.untracked.vstring( "drop *", "keep *_hltDoublePFTau25TrackPt5MediumIsolationProng4L1HLTMatched_*_*", "keep *_hltDoublePFTau25TrackPt5MediumIsolationProng4_*_*", "keep *_hltDoublePFTau25TrackPt5MediumIsolation_*_*", "keep *_hltDoublePFTau25TrackPt5_*_*", "keep *_hltDoublePFTau25_*_*", "keep *_hltEle20CaloIdVTTrkIdTDphiFilter_*_*", "keep *_hltIter1Merged_*_*", "keep *_hltIter2Merged_*_*", "keep *_hltIter3Merged_*_*", "keep *_hltIter4Merged_*_*", "keep *_hltL1extraParticlesCentral_*_*", "keep *_hltL1extraParticlesNonIsolated_*_*", "keep *_hltL1extraParticlesTau_*_*", "keep *_hltL1extraParticles_*_*", "keep *_hltL1sDoubleTauJet44erorDoubleJetC64_*_*", "keep *_hltL1sL1EG18er_*_*", "keep *_hltL1sL1ETM36ORETM40_*_*", "keep *_hltL1sMu16Eta2p1_*_*", "keep *_hltL3TkTracksFromL2_*_*", "keep *_hltL3crIsoL1sMu16Eta2p1L1f0L2f16QL3f18QL3crIsoRhoFiltered0p15_*_*", "keep *_hltOverlapFilterEle20LooseIsoPFTau20OldVersion_*_*", "keep *_hltOverlapFilterIsoMu18LooseIsoPFTau20_*_*", "keep *_hltOverlapFilterIsoMu18PFTau25TrackPt5Prong4_*_*", "keep *_hltPFTau20IsoMuVertex_*_*", "keep *_hltPFTau20TrackLooseIso_*_*", "keep *_hltPFTau20Track_*_*", "keep *_hltPFTau20_*_*", "keep *_hltPFTau25TrackPt5MediumIsolationProng4IsoMuVertex_*_*", "keep *_hltPFTau25TrackPt5MediumIsolationProng4_*_*", "keep *_hltPFTau25TrackPt5MediumIsolation_*_*", "keep *_hltPFTau25TrackPt5_*_*", "keep *_hltPFTau25_*_*", "keep *_hltPFTau35TrackPt20LooseIsoProng2_*_*", "keep *_hltPFTau35TrackPt20LooseIso_*_*", "keep *_hltPFTau35TrackPt20_*_*", "keep *_hltPFTau35Track_*_*", "keep *_hltPFTau35_*_*", "keep *_hltPFTauEleVertex20_*_*", "keep *_hltPixelTracks_*_*", "keep *_hltPixelVertices3DbbPhi_*_*", "keep *_hltPixelVertices_*_*", "keep *_hltTriggerSummaryAOD_*_*", "keep *_hltTriggerSummaryRAW_*_*", "keep FEDRawDataCollection_rawDataCollector_*_*", "keep FEDRawDataCollection_rawDataRepacker_*_*", "keep FEDRawDataCollection_source_*_*", "keep edmTriggerResults_*_*_*", "keep recoCaloJets_*_*_*", "keep recoCaloMETs_*_*_*", "keep recoCompositeCandidates_*_*_*", "keep recoElectrons_*_*_*", "keep recoIsolatedPixelTrackCandidates_*_*_*", "keep recoMETs_*_*_*", "keep recoPFJets_*_*_*", "keep recoPFTaus_*_*_*", "keep recoRecoChargedCandidates_*_*_*", "keep recoRecoEcalCandidates_*_*_*", "keep triggerTriggerEventWithRefs_*_*_*", "keep triggerTriggerEvent_*_*_*", "keep triggerTriggerFilterObjectWithRefs_*_*_*" )
)
process.hltOutputNanoDST = cms.OutputModule( "ShmStreamConsumer",
  SelectEvents = cms.untracked.PSet(
    SelectEvents = cms.vstring( "DST_Physics_v5" )
  ),
  outputCommands = cms.untracked.vstring( "drop *", "keep *_hltFEDSelector_*_*", "keep L1GlobalTriggerReadoutRecord_hltGtDigis_*_*", "keep L1MuGMTReadoutCollection_hltGtDigis_*_*", "keep edmTriggerResults_*_*_*" )
)
process.hltOutputRPCMON = cms.OutputModule( "ShmStreamConsumer",
  SelectEvents = cms.untracked.PSet(
    SelectEvents = cms.vstring( "AlCa_RPCMuonNoHits_v9", "AlCa_RPCMuonNoTriggers_v9", "AlCa_RPCMuonNormalisation_v9" )
  ),
...
process.hltOutputTrackerCalibration = cms.OutputModule( "ShmStreamConsumer",
  SelectEvents = cms.untracked.PSet(
    SelectEvents = cms.vstring( "HLT_TrackerCalibration_v3" )
  ),
  outputCommands = cms.untracked.vstring( "drop *", "keep *_hltTrackerCalibrationRaw_*_*", "keep edmTriggerResults_*_*_*", "keep triggerTriggerEvent_*_*_*" )
)
...
process.HLTSchedule = cms.Schedule( process.HLTriggerFirstPath, process.HLT_Activity_Ecal_SC7_v13, process.HLT_BeamGas_HF_Beam1_v5, process.HLT_BeamGas_HF_Beam2_v5, process.HLT_BeamHalo_v13, process.HLT_HcalPhiSym_v11, process.HLT_HcalNZS_v10, process.HLT_GlobalRunHPDNoise_v8, process.HLT_Physics_v5, process.DST_Physics_v5, process.HLT_DTCalibration_v2, process.HLT_EcalCalibration_v3, process.HLT_HcalCalibration_v3, process.HLT_TrackerCalibration_v3, process.AlCa_EcalPi0EBonly_v6, process.AlCa_EcalPi0EEonly_v6, process.AlCa_EcalEtaEBonly_v6, process.AlCa_EcalEtaEEonly_v6, process.AlCa_EcalPhiSym_v13, process.AlCa_RPCMuonNoTriggers_v9, process.AlCa_RPCMuonNoHits_v9, process.AlCa_RPCMuonNormalisation_v9, process.AlCa_LumiPixels_v8, process.AlCa_LumiPixels_ZeroBias_v4, process.AlCa_LumiPixels_Random_v1, process.HLT_PAL1SingleJet16_v1, process.HLT_PAL1SingleJet36_v1, process.HLT_PASingleForJet15_v1, process.HLT_PASingleForJet25_v1, process.HLT_PAak5CaloJet20_NoJetID_v1, process.HLT_PAak5CaloJet40_NoJetID_v1, process.HLT_PAak5CaloJet60_NoJetID_v1, process.HLT_PAL1SingleMuOpen_v1, process.HLT_PAL1SingleMu3_v1, process.HLT_PAL1SingleMu7_v1, process.HLT_PAL1SingleMu12_v1, process.HLT_PAL1DoubleMu0_v1, process.HLT_PADimuon0_NoVertexing_v1, process.HLT_PAMu5_v1, process.HLT_PAMu8_v1, process.HLT_PAL1SingleEG5_v1, process.HLT_PAL1SingleEG7_v1, process.HLT_PAL1SingleEG12_v1, process.HLT_PAPhoton10_CaloIdVL_v1, process.HLT_PAPhoton15_CaloIdVL_v1, process.HLT_PAPhoton20_CaloIdVL_v1, process.HLT_PAPhoton30_CaloIdVL_v1, process.HLT_PAL1ETM30_v1, process.HLT_PAL1ETM70_v1, process.HLT_PAPixelTracks_Multiplicity70_v1, process.HLT_PAPixelTracks_Multiplicity90_v1, process.HLT_PARomanPots_Tech52_v1, process.HLT_PAL1Tech53_MB_v1, process.HLT_PAL1Tech53_MB_SingleTrack_v1, process.HLT_PAL1Tech54_ZeroBias_v1, process.HLT_PAT1minbias_Tech55_v1, process.HLT_PAL1Tech_HBHEHO_totalOR_v1, process.HLT_PAMinBiasHF_v1, process.HLT_PAMinBiasHF_OR_v1, process.HLT_PAMinBiasBSC_v1, process.HLT_PAMinBiasBSC_OR_v1, process.HLT_PAMinBiasHfOrBSC_v1, process.HLT_PAZeroBias_v1, process.HLT_PAZeroBiasPixel_SingleTrack_v1, process.HLT_PAHFOR_SingleTrack_v1, process.HLT_PAZeroBiasPixel_DoubleTrack_v1, process.HLT_PADoubleMu4_Acoplanarity03_v1, process.HLT_PAExclDijet35_HFAND_v1, process.HLT_PAL1DoubleEG3_FwdVeto_v1, process.HLT_PAL1DoubleJet20_RomanPotsOR_v1, process.HLT_PADoubleJet20_ForwardBackward_v1, process.HLT_PARandom_v1, process.DQM_FEDIntegrity_v11, process.HLT_LogMonitor_v4, process.HLTriggerFinalPath, process.BOutput, process.DQMOutput, process.AOutput, process.ALCAP0Output, process.ALCAPHISYMOutput, process.ALCALUMIPIXELSOutput, process.CalibrationOutput, process.EcalCalibrationOutput, process.ExpressOutput, process.HLTDQMOutput, process.HLTMONOutput, process.NanoDSTOutput, process.RPCMONOutput, process.TrackerCalibrationOutput )
