...
# with command line options: reco -s RAW2DIGI,L1Reco,RECO,ALCA:@MuOniaParked,USER:EventFilter/HcalRawToDigi/hcallaserhbhehffilter2012_cff.hcallLaser2012Filter,DQM --data --conditions FT_R_53_V18::All --eventcontent AOD,DQM --datatier AOD,DQM --customise Configuration/DataProcessing/RecoTLR.customisePrompt --no_exec --python reco_2012C_MuOniaParked.py
