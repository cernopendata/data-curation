...
def main(dataset_list,
    ...
    step 3) get McM scripts to run cmsDriver
        ...
        It also queries the input_dataset (GEN-SIM) if given in DATASET_LIST 
        (use CMS-2016-pileup-dataset.txt).
    ...
    step 5) generate the records (the first only for PREMIX: CMS-2016-premix.txt)
