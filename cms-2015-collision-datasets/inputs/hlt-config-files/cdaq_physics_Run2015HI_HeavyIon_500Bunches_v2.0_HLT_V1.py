# /cdaq/physics/Run2015HI/HeavyIon/500Bunches/v2.0/HLT/V1 (CMSSW_7_5_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2015HI/HeavyIon/500Bunches/v2.0/HLT/V1')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIPuAK4CaloJet60_Eta5p1_v1" ),
        prescales = cms.vuint32( 1, 1, 2, 7, 9, 7, 5, 3, 2, 1, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HICentralityVeto_v1" ),
        prescales = cms.vuint32( 5, 5, 5, 38, 34, 38, 50, 38, 25, 33, 20, 20 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1MinimumBiasHF1AND_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 5, 4, 5, 6, 5, 4, 5, 3, 3 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1MinimumBiasHF1ANDPixel_SingleTrack_v1" ),
        prescales = cms.vuint32( 40, 40, 40, 299, 267, 299, 399, 299, 199, 259, 159, 159 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1Centralityext30100MinimumumBiasHF1AND_v1" ),
        prescales = cms.vuint32( 2, 2, 3, 2, 2, 2, 7, 9, 8, 6, 4, 4 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1Centralityext50100MinimumumBiasHF1AND_v1" ),
        prescales = cms.vuint32( 1, 1, 2, 1, 1, 1, 5, 7, 5, 3, 2, 2 )
      ),
