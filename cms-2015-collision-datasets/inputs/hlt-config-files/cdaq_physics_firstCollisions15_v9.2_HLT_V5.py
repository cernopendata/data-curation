# /cdaq/physics/firstCollisions15/v9.2/HLT/V5 (CMSSW_7_4_6)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions15/v9.2/HLT/V5')
)
...
process.streams = cms.PSet( 
  ...
  Physics = cms.vstring( 'Commissioning',
    'EGamma',
    'HLTPhysics',
    'HcalNZS',
    'Jet',
...
process.datasets = cms.PSet( 
  ...
  HcalNZS = cms.vstring( 'HLT_HcalNZS_v9',
    'HLT_HcalPhiSym_v10',
    'HLT_HcalUTCA_v1' ),
  Jet = cms.vstring( 'HLT_L1SingleJet36_v1',
    'HLT_L1SingleJet68_v1' ),
  ...
  SingleMu = cms.vstring( 'HLT_L1SingleMu16_v1',
    'HLT_L1SingleMuOpen_v1' ),
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG5_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 2, 2, 50, 100, 100, 50 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG20_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 1, 2, 6, 4, 2 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleJet36_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 1, 15, 45, 30, 15 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleJet68_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 1, 2, 6, 4, 2 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleMuOpen_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 2, 2, 35, 100, 70, 35 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleMu16_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 2, 2, 35, 100, 100, 100 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_v4" ),
        prescales = cms.vuint32( 50, 50, 50, 50, 50, 100, 100, 2000, 2000, 2000, 200 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_part0_v1" ),
        prescales = cms.vuint32( 72, 72, 72, 72, 72, 144, 144, 144, 144, 144, 1600 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_Random_v2" ),
        prescales = cms.vuint32( 2000, 2000, 2000, 2000, 2000, 60, 60, 60, 2000, 2000, 60 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_Random_v1" ),
        prescales = cms.vuint32( 400, 400, 400, 400, 400, 12, 12, 12, 400, 400, 400 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_v1" ),
        prescales = cms.vuint32( 22, 22, 22, 22, 22, 44, 44, 44, 44, 44, 88 )
      )
    ),
    lvl1DefaultLabel = cms.string( "2b Colliding" ),
...
process.hltL1sAlCaEcalPi0Eta = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_HTT125 OR L1_SingleJet128 OR L1_TripleJet_92_76_64 OR L1_QuadJetC40 OR L1_DoubleJetC84 OR L1_SingleIsoEG22er OR L1_DoubleEG_15_10 OR L1_SingleEG25" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
    L1UseAliasesForSeeding = cms.bool( True ),
...
process.HLT_L1SingleMu16_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleMu16 + process.hltPreL1SingleMu16 + process.HLTEndSequence )
...
process.PhysicsOutput = cms.EndPath( process.hltGtDigis + process.hltPrePhysicsOutput + process.hltOutputPhysics )
