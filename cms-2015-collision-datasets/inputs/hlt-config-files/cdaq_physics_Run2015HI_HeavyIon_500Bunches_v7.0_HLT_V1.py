# /cdaq/physics/Run2015HI/HeavyIon/500Bunches/v7.0/HLT/V1 (CMSSW_7_5_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2015HI/HeavyIon/500Bunches/v7.0/HLT/V1')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1DoubleMu0_2HF_v1" ),
        prescales = cms.vuint32( 150, 100, 20, 10, 5, 3, 1, 1, 1, 1, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1MinimumBiasHF2ANDExpress_v1" ),
        prescales = cms.vuint32( 100, 100, 100, 250, 250, 250, 666, 750, 500, 650, 400, 400 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1MinimumBiasHF2ANDPixel_SingleTrack_v1" ),
        prescales = cms.vuint32( 50, 50, 50, 125, 125, 125, 334, 375, 250, 330, 200, 200 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1Centralityext30100MinimumumBiasHF2AND_part1_v1" ),
        prescales = cms.vuint32( 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 0, 3 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1Centralityext50100MinimumumBiasHF2AND_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 2, 2, 0, 0, 0, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1Centralityext010MinimumumBiasHF1ANDForZS_v1" ),
        prescales = cms.vuint32( 190, 188, 715, 750, 2000, 1500, 1000, 750, 500, 325, 200, 200 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIPhysics_v1" ),
        prescales = cms.vuint32( 1300, 1300, 1300, 1300, 1300, 1300, 800, 600, 400, 260, 160, 160 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_EcalPhiSymForHI_v2" ),
        prescales = cms.vuint32( 1, 1, 1, 6, 6, 6, 8, 6, 4, 3, 2, 2 )
      ),
      cms.PSet(  pathName = cms.string( "DQMOutput" ),
        prescales = cms.vuint32( 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10 )
      )
    ),
    lvl1DefaultLabel = cms.string( "40kHz" ),
