# /cdaq/physics/Run2015HI/HeavyIon/216Bunches/v1.0/HLT/V1 (CMSSW_7_5_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2015HI/HeavyIon/216Bunches/v1.0/HLT/V1')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIPuAK4CaloJet40_Eta5p1_Cent30_100_v1" ),
        prescales = cms.vuint32( 3, 5, 1, 1, 1, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HISinglePhoton10_Eta3p1_Cent30_100_v1" ),
        prescales = cms.vuint32( 11, 21, 1, 1, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HISinglePhoton15_Eta3p1_Cent30_100_v1" ),
        prescales = cms.vuint32( 2, 3, 1, 1, 1, 1, 1 )
      ),
