# /cdaq/physics/firstCollisions15/v8.1/HLT/V4 (CMSSW_7_4_3)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions15/v8.1/HLT/V4')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_Physics_part0_v1" ),
        prescales = cms.vuint32( 24, 12, 16, 20, 24, 28, 32 )
      ),
