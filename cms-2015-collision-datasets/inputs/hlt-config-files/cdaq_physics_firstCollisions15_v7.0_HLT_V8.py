# /cdaq/physics/firstCollisions15/v7.0/HLT/V8 (CMSSW_7_4_1_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions15/v7.0/HLT/V8')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "AlCa_EcalPi0EBonly_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 2, 2, 4 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "RPCMONOutput" ),
        prescales = cms.vuint32( 1, 1, 1, 2, 3, 6 )
      )
    ),
