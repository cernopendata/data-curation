# /cdaq/physics/Run2015/25ns14e33_0T/v4.0/HLT/V5 (CMSSW_7_4_10_patch1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2015/25ns14e33_0T/v4.0/HLT/V5')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_Physics_v2" ),
        prescales = cms.vuint32( 6400, 6400, 6400, 6400, 6400, 6400, 6400, 4500, 3600, 3200, 3200, 3200, 3200 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_v2" ),
        prescales = cms.vuint32( 2200, 2200, 2200, 2200, 2200, 2200, 2200, 2200, 2200, 2200, 2200, 2200, 2200 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_v2" ),
        prescales = cms.vuint32( 45, 45, 45, 45, 45, 45, 45, 45, 45, 45, 45, 45, 45 )
      ),
