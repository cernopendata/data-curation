# /cdaq/physics/firstCollisions15/v7.0/HLT/V5 (CMSSW_7_4_1_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions15/v7.0/HLT/V5')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_L1SingleJet68_v1" ),
        prescales = cms.vuint32( 3, 6, 12, 18, 12, 24 )
      ),
