# /cdaq/special/VeryLowPileUpFill/2015/Totem/HLT/V2 (CMSSW_7_4_3)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/VeryLowPileUpFill/2015/Totem/HLT/V2')
)
...
process.datasets = cms.PSet( 
  ...
  Commissioning = cms.vstring( 'HLT_DiSC30_18_EIso_AND_HE_Mass70_v1',
    'HLT_IsoTrackHB_v1',
    'HLT_IsoTrackHE_v1',
  ...
  LookAreaPD = cms.vstring( 'HLT_AK4CaloJet100_v2',
    ...
    'HLT_L1Tech53_MinimumBiasTotem_v1',
    'HLT_L1Tech54_ZeroBiasTotem_v1',
    ...
    'HLT_Random_v1',
    'HLT_ZeroBias_v1' ),
  MinimumBiasTotem = cms.vstring( 'HLT_L1Tech53_MinimumBiasTotem_v1' ),
  ...
  OnlineMonitor = cms.vstring( 'HLT_AK4CaloJet100_v2',
    ...
    'HLT_Random_v1',
    'HLT_ZeroBias_v1' ),
  TOTEMMinBias = cms.vstring( 'HLT_L1TOTEM1_MinBias_v1',
    'HLT_L1TOTEM3_ZeroBias_v1' ),
  TOTEMRomanPots = cms.vstring( 'HLT_L1RomanPots_SinglePixelTrack02_v2',
    'HLT_L1RomanPots_SinglePixelTrack04_v2',
    'HLT_L1TOTEM0_RomanPotsAND_v1' ),
  ...
  ZeroBiasTotem = cms.vstring( 'HLT_L1Tech54_ZeroBiasTotem_v1' )
)
...
process.GlobalTag = cms.ESSource( "PoolDBESSource",
    globaltag = cms.string( "GR_H_V58B" ),
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_PixelTracks_Multiplicity60_v2" ),
        prescales = cms.vuint32( 35, 35, 35, 35, 35 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_DiPFJet15_FBEta3_NoCaloMatched_v2" ),
        prescales = cms.vuint32( 10000, 10000, 10000, 10000, 10000 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_DiPFJetAve15_Central_v2" ),
        prescales = cms.vuint32( 8, 8, 8, 8, 8 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_Random_v1" ),
        prescales = cms.vuint32( 300, 300, 300, 300, 300 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_AK4CaloJet30_v2" ),
        prescales = cms.vuint32( 13, 13, 13, 13, 13 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HISinglePhoton10_v2" ),
        prescales = cms.vuint32( 12, 12, 12, 12, 12 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_FullTrack12_v2" ),
        prescales = cms.vuint32( 6, 6, 6, 6, 6 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "DST_Physics_v4" ),
        prescales = cms.vuint32( 10, 10, 10, 10, 10 )
      ),
    ...
    lvl1DefaultLabel = cms.string( "Totem 5" ),
    lvl1Labels = cms.vstring( 'Totem 5',
      'Totem 7',
      'Totem 9',
      'Totem 11',
      'Totem 13' )
...
process.hltL1sETT15 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_ETT15" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
    L1UseAliasesForSeeding = cms.bool( True ),
...
process.hltL1sTech54 = cms.EDFilter( "HLTLevel1GTSeed",
...
process.hltL1sTech53 = cms.EDFilter( "HLTLevel1GTSeed",
...
process.hltPreL1Tech53MinimumBiasTotem = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltPreL1Tech54ZeroBiasTotem = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1TOTEM3ZeroBias = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreDiSC5JPsi = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltDiSC5JPsiEtFilter = cms.EDFilter( "HLTEgammaEtFilter",
    saveTags = cms.bool( True ),
    L1NonIsoCand = cms.InputTag( "" ),
    relaxed = cms.untracked.bool( False ),
    L1IsoCand = cms.InputTag( "hltEgammaCandidates" ),
...
process.hltDiSC5JPsiClusterShapeFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    doIsolated = cms.bool( True ),
    thrOverE2EE = cms.double( -1.0 ),
    L1NonIsoCand = cms.InputTag( "" ),
    saveTags = cms.bool( True ),
    ...
    ncandcut = cms.int32( 1 ),
    isoTag = cms.InputTag( 'hltEgammaClusterShape','sigmaIEtaIEta5x5' ),
    candTag = cms.InputTag( "hltDiSC5JPsiEtFilter" ),
    nonIsoTag = cms.InputTag( "" )
)
process.hltDiSC5JPsiHEFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    doIsolated = cms.bool( True ),
    thrOverE2EE = cms.double( -1.0 ),
    L1NonIsoCand = cms.InputTag( "" ),
    saveTags = cms.bool( True ),
    ...
    ncandcut = cms.int32( 1 ),
    isoTag = cms.InputTag( "hltEgammaHoverE" ),
    candTag = cms.InputTag( "hltDiSC5JPsiClusterShapeFilter" ),
    nonIsoTag = cms.InputTag( "" )
)
process.hltDiSC5JPsiEcalIsoFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    doIsolated = cms.bool( True ),
    thrOverE2EE = cms.double( -1.0 ),
    L1NonIsoCand = cms.InputTag( "" ),
    saveTags = cms.bool( True ),
    ...
    ncandcut = cms.int32( 1 ),
    isoTag = cms.InputTag( "hltEgammaEcalPFClusterIso" ),
    candTag = cms.InputTag( "hltDiSC5JPsiHEFilter" ),
    nonIsoTag = cms.InputTag( "" )
)
process.hltDiSC5JPsiHcalIsoFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    doIsolated = cms.bool( True ),
    thrOverE2EE = cms.double( -1.0 ),
    L1NonIsoCand = cms.InputTag( "" ),
    saveTags = cms.bool( True ),
    ...
    ncandcut = cms.int32( 1 ),
    isoTag = cms.InputTag( "hltEgammaHcalPFClusterIso" ),
    candTag = cms.InputTag( "hltDiSC5JPsiEcalIsoFilter" ),
    nonIsoTag = cms.InputTag( "" )
)
process.hltDiSC5JPsiEtUnseededFilter = cms.EDFilter( "HLTEgammaEtFilter",
    saveTags = cms.bool( True ),
    L1NonIsoCand = cms.InputTag( "" ),
    relaxed = cms.untracked.bool( False ),
    L1IsoCand = cms.InputTag( "hltEgammaCandidatesUnseeded" ),
...
process.hltDiSC5JPsiMass0to5Filter = cms.EDFilter( "HLTPMMassFilter",
    saveTags = cms.bool( True ),
    lowerMassCut = cms.double( 0.0 ),
    L1NonIsoCand = cms.InputTag( "" ),
    beamSpot = cms.InputTag( "hltOnlineBeamSpot" ),
    ...
    isElectron2 = cms.untracked.bool( False ),
    upperMassCut = cms.double( 5.0 ),
    candTag = cms.InputTag( "hltDiSC5JPsiEtUnseededFilter" ),
    reqOppCharge = cms.untracked.bool( False ),
    nZcandcut = cms.int32( 1 )
)
process.hltPreDiSC5Upsilon = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltDiSC5UpsilonMass8to12Filter = cms.EDFilter( "HLTPMMassFilter",
    saveTags = cms.bool( True ),
...
process.hltPreExpressOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1techIgnorePrescales = cms.bool( False ),
    hltResults = cms.InputTag( "TriggerResults" ),
    triggerConditions = cms.vstring( 'HLT_Physics_v1',
      'HLT_Random_v1',
      'HLT_ZeroBias_v1',
...
process.HLTDiSC5JPsiSequence = cms.Sequence( process.HLTDoFullUnpackingEgammaEcalSequence + process.HLTPFClusteringForEgamma + process.hltEgammaCandidates + process.hltEGL1SingleEG5Filter + process.hltDiSC5JPsiEtFilter + process.hltEgammaClusterShape + process.hltDiSC5JPsiClusterShapeFilter + process.HLTDoLocalHcalWithTowerSequence + process.HLTFastJetForEgamma + process.hltEgammaHoverE + process.hltDiSC5JPsiHEFilter + process.hltEgammaEcalPFClusterIso + process.hltDiSC5JPsiEcalIsoFilter + process.HLTPFHcalClusteringForEgamma + process.hltEgammaHcalPFClusterIso + process.hltDiSC5JPsiHcalIsoFilter + process.HLTPFClusteringForEgammaUnseeded + process.hltEgammaCandidatesUnseeded + process.hltEgammaCandidatesWrapperUnseeded + process.hltDiSC5JPsiEtUnseededFilter )
...
process.HLT_PixelTracks_Multiplicity60_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sETT15 + process.hltPrePixelTracksMultiplicity60 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hlt1HighMult60 + process.HLTEndSequence )
process.HLT_PixelTracks_Multiplicity85_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sETT15 + process.hltPrePixelTracksMultiplicity85 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hlt1HighMult85 + process.HLTEndSequence )
process.HLT_PixelTracks_Multiplicity110_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sETT15 + process.hltPrePixelTracksMultiplicity110 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hlt1HighMult110 + process.HLTEndSequence )
...
process.HLT_ZeroBias_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sTech54 + process.hltPreZeroBias + process.HLTEndSequence )
...
process.HLT_L1Tech53_MinimumBiasTotem_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sTech53 + process.hltPreL1Tech53MinimumBiasTotem + process.HLTEndSequence )
process.HLT_L1Tech54_ZeroBiasTotem_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sTech54 + process.hltPreL1Tech54ZeroBiasTotem + process.HLTEndSequence )
...
process.HLT_L1TOTEM3_ZeroBias_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1TOTEM3 + process.hltPreL1TOTEM3ZeroBias + process.HLTEndSequence )
...
process.HLT_DiSC5_JPsi_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleEG5 + process.hltPreDiSC5JPsi + process.HLTDiSC5JPsiSequence + process.hltDiSC5JPsiMass0to5Filter + process.HLTEndSequence )
process.HLT_DiSC5_Upsilon_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleEG5 + process.hltPreDiSC5Upsilon + process.HLTDiSC5JPsiSequence + process.hltDiSC5UpsilonMass8to12Filter + process.HLTEndSequence )
...
process.DQMEventDisplayOutput = cms.EndPath( process.hltGtDigis + process.hltPreDQMEventDisplayOutput + process.hltOutputDQMEventDisplay )
process.LookAreaOutput = cms.EndPath( process.hltGtDigis + process.hltPreLookAreaOutput + process.hltOutputLookArea )
