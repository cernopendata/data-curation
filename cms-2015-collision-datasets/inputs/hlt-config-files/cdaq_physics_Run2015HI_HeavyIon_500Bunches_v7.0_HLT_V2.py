# /cdaq/physics/Run2015HI/HeavyIon/500Bunches/v7.0/HLT/V2 (CMSSW_7_5_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2015HI/HeavyIon/500Bunches/v7.0/HLT/V2')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_HICentralityVeto_v2" ),
        prescales = cms.vuint32( 4, 4, 4, 13, 13, 13, 28, 27, 18, 23, 14, 14 )
      ),
