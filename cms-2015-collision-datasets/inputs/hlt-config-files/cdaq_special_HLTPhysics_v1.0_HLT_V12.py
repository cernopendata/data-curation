# /cdaq/special/HLTPhysics/v1.0/HLT/V12 (CMSSW_7_4_6)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/HLTPhysics/v1.0/HLT/V12')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_Physics_v4" ),
        prescales = cms.vuint32( 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_part0_v1" ),
        prescales = cms.vuint32( 32, 25, 400, 500, 1000, 5000, 64, 64, 64, 64, 10000 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_part0_v1" ),
        prescales = cms.vuint32( 24, 24, 1440, 1440, 1440, 1440, 1440, 1440, 1440, 1440, 1440 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_Random_v2" ),
        prescales = cms.vuint32( 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_Random_v1" ),
        prescales = cms.vuint32( 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_v1" ),
        prescales = cms.vuint32( 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44 )
      )
    ),
...
process.hltPreDQMOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring( 'HLT_Physics_part2_v1',
...
process.hltPreDQMEventDisplayOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1techIgnorePrescales = cms.bool( False ),
    hltResults = cms.InputTag( "TriggerResults" ),
    triggerConditions = cms.vstring( 'HLT_DiSC30_18_EIso_AND_HE_Mass70_v1' ),
    throw = cms.bool( True ),
    daqPartitions = cms.uint32( 1 )
)
...
process.HLT_Physics_part0_v1 = cms.Path( process.HLTBeginSequence + process.hltPrePhysicspart0 + process.HLTEndSequence )
process.HLT_Physics_part1_v1 = cms.Path( process.HLTBeginSequence + process.hltPrePhysicspart1 + process.HLTEndSequence )
process.HLT_Physics_part2_v1 = cms.Path( process.HLTBeginSequence + process.hltPrePhysicspart2 + process.HLTEndSequence )
process.HLT_Physics_part3_v1 = cms.Path( process.HLTBeginSequence + process.hltPrePhysicspart3 + process.HLTEndSequence )
process.HLT_Physics_part4_v1 = cms.Path( process.HLTBeginSequence + process.hltPrePhysicspart4 + process.HLTEndSequence )
process.HLT_Physics_part5_v1 = cms.Path( process.HLTBeginSequence + process.hltPrePhysicspart5 + process.HLTEndSequence )
process.HLT_Physics_part6_v1 = cms.Path( process.HLTBeginSequence + process.hltPrePhysicspart6 + process.HLTEndSequence )
process.HLT_Physics_part7_v1 = cms.Path( process.HLTBeginSequence + process.hltPrePhysicspart7 + process.HLTEndSequence )
