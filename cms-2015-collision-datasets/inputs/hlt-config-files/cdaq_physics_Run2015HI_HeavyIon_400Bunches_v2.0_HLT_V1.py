# /cdaq/physics/Run2015HI/HeavyIon/400Bunches/v2.0/HLT/V1 (CMSSW_7_5_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2015HI/HeavyIon/400Bunches/v2.0/HLT/V1')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIQ2Bottom005_Centrality1030_v2" ),
        prescales = cms.vuint32( 1, 2, 11, 15, 13, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIQ2Top005_Centrality1030_v2" ),
        prescales = cms.vuint32( 1, 2, 11, 15, 13, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIQ2Bottom005_Centrality3050_v2" ),
        prescales = cms.vuint32( 1, 2, 11, 15, 13, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIQ2Top005_Centrality3050_v2" ),
        prescales = cms.vuint32( 1, 2, 11, 15, 13, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIQ2Bottom005_Centrality5070_v2" ),
        prescales = cms.vuint32( 1, 2, 11, 15, 13, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIQ2Top005_Centrality5070_v2" ),
        prescales = cms.vuint32( 1, 2, 11, 15, 13, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HICentralityVeto_v1" ),
        prescales = cms.vuint32( 10, 10, 150, 133, 149, 199, 199 )
      ),
