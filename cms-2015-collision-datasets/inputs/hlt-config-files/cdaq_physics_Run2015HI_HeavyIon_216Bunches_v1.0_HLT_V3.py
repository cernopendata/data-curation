# /cdaq/physics/Run2015HI/HeavyIon/216Bunches/v1.0/HLT/V3 (CMSSW_7_5_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2015HI/HeavyIon/216Bunches/v1.0/HLT/V3')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_HICentralityVeto_v1" ),
        prescales = cms.vuint32( 150, 133, 199, 99, 65, 39, 39 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1Centralityext010MinimumumBiasHF1ANDForZS_v1" ),
        prescales = cms.vuint32( 300, 800, 400, 200, 130, 80, 80 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIPhysics_v1" ),
        prescales = cms.vuint32( 1200, 1200, 800, 400, 260, 160, 1000 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_EcalPhiSymForHI_v1" ),
        prescales = cms.vuint32( 6, 4, 8, 4, 3, 2, 2 )
      ),
    ...
    lvl1DefaultLabel = cms.string( "12kHz" ),
    lvl1Labels = cms.vstring( '12kHz',
      '8kHz',
      '4kHz',
      '2kHz',
      '1p3kHz',
...
process.hltPreHIExpressOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1techIgnorePrescales = cms.bool( False ),
    hltResults = cms.InputTag( "TriggerResults" ),
    triggerConditions = cms.vstring( 'HLT_HIPuAK4CaloJet100_Eta5p1_v1 / 10',
      'HLT_HIPuAK4CaloJet120_Eta5p1_v1 / 10',
      'HLT_HIPuAK4CaloBJetCSV80_Eta2p1_v1 / 4',
      'HLT_HIDmesonHITrackingGlobal_Dpt20_v1 / 6',
      'HLT_HIDmesonHITrackingGlobal_Dpt60_v1',
      'HLT_HISinglePhoton60_Eta1p5_v1 / 2',
      'HLT_HISinglePhoton60_Eta3p1_v1 / 7',
      'HLT_HIDoublePhoton15_Eta1p5_Mass50_1000_R9HECut_v1 / 16',
      'HLT_HIUCC020_v2 / 20',
      'HLT_HIFullTrack34_v1 / 3',
      'HLT_HIL1DoubleMu10_v1',
      'HLT_HIL2Mu15_2HF_v1',
      'HLT_HIL2Mu20_2HF_v1',
