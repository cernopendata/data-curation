# /cdaq/special/VeryLowPileUpFill/2015/ZeroTesla/v1.1/HLT/V2 (CMSSW_7_4_3)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/VeryLowPileUpFill/2015/ZeroTesla/v1.1/HLT/V2')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_JetE30_NoBPTX3BX_NoHalo_v2" ),
        prescales = cms.vuint32( 20, 20, 20 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_L1SingleMuOpen_v1" ),
        prescales = cms.vuint32( 100, 100, 100 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_DiPFJet15_FBEta3_NoCaloMatched_v2" ),
        prescales = cms.vuint32( 10000, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_part0_v1" ),
        prescales = cms.vuint32( 80, 12, 12 )
      ),
    ...
    lvl1DefaultLabel = cms.string( "PU=0.4" ),
    lvl1Labels = cms.vstring( 'PU=0.4',
      'PU=0.03',
      'PU=0.01' )
)
