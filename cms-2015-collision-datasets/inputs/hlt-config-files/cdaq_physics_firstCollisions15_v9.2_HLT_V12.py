# /cdaq/physics/firstCollisions15/v9.2/HLT/V12 (CMSSW_7_4_6)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions15/v9.2/HLT/V12')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG5_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 2, 100, 50, 2, 100, 50 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG20_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 6, 2, 1, 4, 2 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleJet36_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 45, 15, 1, 30, 15 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleJet68_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 6, 2, 1, 4, 2 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_v4" ),
        prescales = cms.vuint32( 50, 50, 50, 50, 50, 100, 2000, 2000, 100, 2000, 200 )
      ),
    ...
    lvl1DefaultLabel = cms.string( "110b" ),
...
process.HLT_L1SingleMu5 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleMu5 + process.hltPreL1SingleMu5 + process.HLTEndSequence )
