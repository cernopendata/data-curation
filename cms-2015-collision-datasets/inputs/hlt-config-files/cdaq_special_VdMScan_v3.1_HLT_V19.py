# /cdaq/special/VdMScan/v3.1/HLT/V19 (CMSSW_7_4_8_patch1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/VdMScan/v3.1/HLT/V19')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_L1AlwaysTrue_part1_v1" ),
        prescales = cms.vuint32( 8, 14, 29, 72, 144, 0, 0, 0, 0, 0 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_part1_v2" ),
        prescales = cms.vuint32( 0, 0, 0, 0, 0, 8, 16, 32, 80, 160 )
      ),
    ...
    lvl1DefaultLabel = cms.string( "1kHz" ),
    lvl1Labels = cms.vstring( '20kHz',
      '10kHz',
      '5kHz',
      '2kHz',
      '1kHz',
