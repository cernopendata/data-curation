# /cdaq/special/VeryLowPileUpFill/2015/dNdeta/v1.0/HLT/V8 (CMSSW_7_4_1_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/VeryLowPileUpFill/2015/dNdeta/v1.0/HLT/V8')
)
...
process.datasets = cms.PSet( 
  ...
  EventDisplay = cms.vstring( 'HLT_ZeroBias_part0_v1' ),
  ExpressPhysics = cms.vstring( 'HLT_L1Tech5_BPTX_PlusOnly_v1',
  ...
  L1TechBPTXMinusOnly = cms.vstring( 'HLT_L1Tech6_BPTX_MinusOnly_v1' ),
  L1TechBPTXPlusOnly = cms.vstring( 'HLT_L1Tech5_BPTX_PlusOnly_v1' ),
  L1TechBPTXQuiet = cms.vstring( 'HLT_L1Tech7_NoBPTX_v1' ),
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_part0_v1" ),
        prescales = cms.vuint32( 120, 180, 240, 360, 200, 200 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_EcalPi0EBonly_v1" ),
        prescales = cms.vuint32( 2, 2, 2, 2, 2, 4 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "RPCMONOutput" ),
        prescales = cms.vuint32( 2, 2, 2, 2, 4, 2 )
      ),
...
process.hltPreDQMOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring( 'HLT_ZeroBias_part0_v1 / 4',
      'HLT_HcalNZS_v9 / 10',
...
process.hltPreLookAreaOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1techIgnorePrescales = cms.bool( False ),
    hltResults = cms.InputTag( "TriggerResults" ),
    triggerConditions = cms.vstring( 'HLT_ZeroBias_part0_v1 / 20',
      'HLT_HcalNZS_v9 / 50',
...
process.hltPreExpressOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1techIgnorePrescales = cms.bool( False ),
    hltResults = cms.InputTag( "TriggerResults" ),
    triggerConditions = cms.vstring( 'HLT_ZeroBias_part0_v1 / 8',
      'HLT_L1Tech5_BPTX_PlusOnly_v1 / 40',
      'HLT_L1Tech6_BPTX_MinusOnly_v1 / 40',
      'HLT_L1Tech7_NoBPTX_v1 / 40',
      'HLT_Random_v2' ),
    throw = cms.bool( True ),
    daqPartitions = cms.uint32( 1 )
)
...
process.hltOutputExpress = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_L1Tech5_BPTX_PlusOnly_v1',
  'HLT_L1Tech6_BPTX_MinusOnly_v1',
  'HLT_L1Tech7_NoBPTX_v1',
  'HLT_Random_v2',
  'HLT_ZeroBias_part0_v1' ) ),
