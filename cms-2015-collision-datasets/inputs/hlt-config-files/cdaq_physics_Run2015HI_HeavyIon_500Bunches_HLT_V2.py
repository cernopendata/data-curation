# /cdaq/physics/Run2015HI/HeavyIon/500Bunches/HLT/V2 (CMSSW_7_5_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2015HI/HeavyIon/500Bunches/HLT/V2')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1DoubleMu0_v1" ),
        prescales = cms.vuint32( 7, 5, 4, 3, 2, 2, 2, 1, 1, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1DoubleMu0_2HF_v1" ),
        prescales = cms.vuint32( 150, 100, 40, 5, 2, 2, 2, 1, 1, 1, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL3Mu3_NHitQ15_2HF_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 3, 2, 1, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL3Mu3_NHitQ15_2HF0_v1" ),
        prescales = cms.vuint32( 10, 10, 10, 10, 10, 1, 3, 2, 1, 1, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL3Mu5_NHitQ15_2HF_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 2, 1, 1, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL3Mu5_NHitQ15_2HF0_v1" ),
        prescales = cms.vuint32( 10, 10, 10, 1, 1, 1, 2, 1, 1, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL2Mu7_NHitQ10_2HF_v1" ),
        prescales = cms.vuint32( 10, 10, 10, 5, 1, 1, 1, 1, 1, 1, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1MinimumBiasHF1AND_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 15, 13, 15, 21, 15, 11, 7, 5, 5 )
      ),
