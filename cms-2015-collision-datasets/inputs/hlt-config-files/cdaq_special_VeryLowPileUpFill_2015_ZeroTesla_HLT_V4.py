# /cdaq/special/VeryLowPileUpFill/2015/ZeroTesla/HLT/V4 (CMSSW_7_4_3)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/VeryLowPileUpFill/2015/ZeroTesla/HLT/V4')
)
