# /cdaq/physics/Run2015HI/HeavyIon/32Bunches/v3.0/HLT/V1 (CMSSW_7_5_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2015HI/HeavyIon/32Bunches/v3.0/HLT/V1')
)
...
process.datasets = cms.PSet( 
  ...
  HIFlowCorr = cms.vstring( 'HLT_HIQ2Bottom005_Centrality1030_v1',
  ...
  HIHardProbesPeripheral = cms.vstring( 'HLT_HIDmesonHITrackingGlobal_Dpt20_Cent50_100_v1',
  ...
  HIPhoton40AndZ = cms.vstring( 'HLT_HIDoublePhoton15_Eta1p5_Mass50_1000_R9HECut_v1',
    ...
    'HLT_HISinglePhoton60_Eta1p5_v1',
    'HLT_HISinglePhoton60_Eta3p1_v1' ),
  HITrackerVirginRaw = cms.vstring( 'HLT_HIL1Centralityext010HFplusANDminusTH0ForZS_v1',
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL2Mu3Eta2p5_PuAK4CaloJet40Eta2p1_v1" ),
        prescales = cms.vuint32( 9, 5, 3, 2, 1, 1, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL2Mu3Eta2p5_HIPhoton10Eta1p5_v1" ),
        prescales = cms.vuint32( 5, 5, 3, 1, 1, 1, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUCC100_v1" ),
        prescales = cms.vuint32( 5, 3, 2, 2, 1, 1, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUCC020_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 2 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1DoubleMu0_v1" ),
        prescales = cms.vuint32( 5, 1, 1, 1, 1, 1, 15 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1DoubleMu0_2HF_v1" ),
        prescales = cms.vuint32( 2, 1, 1, 1, 1, 1, 3 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL2DoubleMu0_Cent30_NHitQ_v1" ),
        prescales = cms.vuint32( 0, 1, 1, 1, 1, 1, 0 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL3DoubleMu0_Cent30_v1" ),
        prescales = cms.vuint32( 0, 1, 1, 1, 1, 1, 0 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL3DoubleMu0_OS_m2p5to4p5_v1" ),
        prescales = cms.vuint32( 5, 1, 1, 1, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL3DoubleMu0_OS_m7to14_v1" ),
        prescales = cms.vuint32( 5, 1, 1, 1, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUPCL1SingleMuOpenNotHF2_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUPCL1DoubleMuOpenNotHF2_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUPCL1SingleEG2NotHF2_v1" ),
        prescales = cms.vuint32( 10, 10, 10, 10, 10, 10, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUPCL1DoubleEG2NotHF2_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUPCL1SingleEG5NotHF2_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUPCL1DoubleMuOpenNotHF1_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUPCL1DoubleEG2NotZDCAND_v1" ),
        prescales = cms.vuint32( 10, 10, 10, 10, 10, 10, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUPCL1DoubleMuOpenNotZDCAND_v1" ),
        prescales = cms.vuint32( 10, 10, 10, 10, 10, 10, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUPCL1EG2NotZDCAND_v1" ),
        prescales = cms.vuint32( 10, 10, 10, 10, 10, 10, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUPCL1MuOpenNotZDCAND_v1" ),
        prescales = cms.vuint32( 10, 10, 10, 10, 10, 10, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUPCL1NotHFplusANDminusTH0BptxAND_v1" ),
        prescales = cms.vuint32( 10, 10, 10, 10, 10, 10, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUPCL1NotHFMinimumbiasHFplusANDminustTH0_v1" ),
        prescales = cms.vuint32( 10, 10, 10, 10, 10, 10, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUPCL1DoubleMuOpenNotHFMinimumbiasHFplusANDminustTH0_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 1, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIZeroBias_v1" ),
        prescales = cms.vuint32( 15, 15, 15, 15, 15, 15, 100 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HICentralityVeto_v1" ),
        prescales = cms.vuint32( 59, 39, 25, 15, 7, 3, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1Tech7_NoBPTX_v1" ),
        prescales = cms.vuint32( 68, 68, 68, 68, 68, 68, 68 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1MinimumBiasHF1AND_v1" ),
        prescales = cms.vuint32( 15, 10, 7, 4, 2, 1, 3 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1MinimumBiasHF1ANDExpress_v1" ),
        prescales = cms.vuint32( 750, 500, 325, 200, 84, 50, 40 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1MinimumBiasHF1ANDPixel_SingleTrack_v1" ),
        prescales = cms.vuint32( 600, 400, 260, 160, 20, 1, 50 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1Centralityext30100HFplusANDminusTH0_v1" ),
        prescales = cms.vuint32( 2, 2, 2, 2, 2, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1Centralityext50100HFplusANDminusTH0_v1" ),
        prescales = cms.vuint32( 2, 2, 2, 2, 2, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1Centralityext70100HFplusANDminusTH0_v1" ),
        prescales = cms.vuint32( 2, 2, 2, 2, 2, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1Centralityext010HFplusANDminusTH0ForZS_v1" ),
        prescales = cms.vuint32( 1200, 800, 520, 320, 160, 32, 32 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIPhysics_v1" ),
        prescales = cms.vuint32( 700, 500, 360, 260, 180, 120, 1000 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIPhysicsNoZS_v1" ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_EcalPhiSymForHI_v1" ),
        prescales = cms.vuint32( 6, 4, 3, 2, 1, 1, 2 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_Random_v1" ),
        prescales = cms.vuint32( 60, 60, 60, 60, 60, 60, 12 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_v2" ),
        prescales = cms.vuint32( 5, 5, 5, 5, 5, 5, 2 )
      ),
      cms.PSet(  pathName = cms.string( "DQMOutput" ),
        prescales = cms.vuint32( 10, 10, 10, 10, 10, 10, 10 )
      )
    ),
    lvl1DefaultLabel = cms.string( "3kHz" ),
    lvl1Labels = cms.vstring( '3kHz',
      '2kHz',
      '1p3kHz',
      '800Hz',
      '400Hz',
...
process.hltL1sL1Centralityext010HFplusANDminusTH0 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Centrality_ext0_10_HFplusANDminusTH0" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
    L1UseAliasesForSeeding = cms.bool( True ),
...
process.hltL1sL1Centralityext30100HFplusANDminusTH0 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Centrality_ext30_100_HFplusANDminusTH0" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
    L1UseAliasesForSeeding = cms.bool( True ),
...
process.hltL1sL1Centralityext50100HFplusANDminusTH0 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Centrality_ext50_100_HFplusANDminusTH0" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
    L1UseAliasesForSeeding = cms.bool( True ),
...
process.hltGlobalSumETHfFilter1030 = cms.EDFilter( "HLTGlobalSumsCaloMET",
    ...
    observable = cms.string( "sumEt" ),
    MinN = cms.int32( 1 ),
    Min = cms.double( 1350.0 ),
    Max = cms.double( 3100.0 ),
    inputTag = cms.InputTag( "hltMetForHf" ),
    triggerType = cms.int32( 88 )
)
...
process.hltPreHIL1Centralityext30100HFplusANDminusTH0 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltPreHIL1Centralityext50100HFplusANDminusTH0 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sL1Centralityext70100HFplusANDminusTH0 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_Centrality_ext70_100_HFplusANDminusTH0" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
    L1UseAliasesForSeeding = cms.bool( True ),
...
process.hltPreHIL1Centralityext70100HFplusANDminusTH0 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltPreHIL1Centralityext010HFplusANDminusTH0ForZS = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreHIPhysicsNoZS = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreHIExpressOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1techIgnorePrescales = cms.bool( False ),
    hltResults = cms.InputTag( "TriggerResults" ),
    triggerConditions = cms.vstring( 'HLT_HIPuAK4CaloJet100_Eta5p1_v1 / 2',
      'HLT_HIPuAK4CaloJet120_Eta5p1_v1',
      'HLT_HIPuAK4CaloBJetCSV80_Eta2p1_v1',
      'HLT_HIDmesonHITrackingGlobal_Dpt20_v1 / 2',
      'HLT_HIDmesonHITrackingGlobal_Dpt60_v1',
      'HLT_HISinglePhoton60_Eta1p5_v1',
      'HLT_HISinglePhoton60_Eta3p1_v1 / 2',
      'HLT_HIDoublePhoton15_Eta1p5_Mass50_1000_R9HECut_v1 / 2',
      'HLT_HIUCC020_v1 / 10',
      'HLT_HIFullTrack34_v1',
      'HLT_HIL1DoubleMu10_v1',
      'HLT_HIL2Mu15_2HF_v1',
      'HLT_HIL2Mu20_2HF_v1',
      'HLT_HIL2DoubleMu0_Cent30_OS_NHitQ_v1 / 2',
      'HLT_HIL3DoubleMu0_OS_m2p5to4p5_v1',
      'HLT_HIUPCDoubleMuNotHF2Pixel_SingleTrack_v1',
      'HLT_HICentralityVeto_v1',
      'HLT_HIL1MinimumBiasHF1ANDExpress_v1',
...
process.hltOutputHIPhysicsUCCQ2 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_HIQ2Bottom005_Centrality1030_v1',
  'HLT_HIQ2Bottom005_Centrality3050_v1',
  'HLT_HIQ2Bottom005_Centrality5070_v1',
  'HLT_HIQ2Top005_Centrality1030_v1',
  'HLT_HIQ2Top005_Centrality3050_v1',
...
process.hltOutputHIPhysicsVirginRaw = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_HIL1Centralityext010HFplusANDminusTH0ForZS_v1',
  'HLT_HIPhysicsNoZS_v1',
  'HLT_HIPuAK4CaloJet80_Eta5p1ForZS_v1' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep *_hltL1GtObjectMap_*_*',
...
process.HLT_HIDmesonHITrackingGlobal_Dpt20_Cent0_10_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1Centralityext010HFplusANDminusTH0 + process.hltPreHIDmesonHITrackingGlobalDpt20Cent010 + process.HLTHIPixelClusterSplitting + process.HLTDoHITrackingLocalStripSequenceZeroSuppression + process.HLTHIIterativeTrackingForGlobalPt8 + process.hltHIFullTrackCandsForDmesonGlobalPt8 + process.hltHIFullTrackFilterForDmesonGlobalPt8 + process.HLTtktkVtxForDmesonGlobal8Dpt20 + process.HLTtktkFilterForDmesonGlobal8Dp20 + process.HLTDoHIStripZeroSuppressionRepacker + process.HLTEndSequence )
process.HLT_HIDmesonHITrackingGlobal_Dpt20_Cent30_100_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1Centralityext30100HFplusANDminusTH0 + process.hltPreHIDmesonHITrackingGlobalDpt20Cent30100 + process.HLTHIPixelClusterSplitting + process.HLTDoHITrackingLocalStripSequenceZeroSuppression + process.HLTHIIterativeTrackingForGlobalPt8 + process.hltHIFullTrackCandsForDmesonGlobalPt8 + process.hltHIFullTrackFilterForDmesonGlobalPt8 + process.HLTtktkVtxForDmesonGlobal8Dpt20 + process.HLTtktkFilterForDmesonGlobal8Dp20 + process.HLTDoHIStripZeroSuppressionRepacker + process.HLTEndSequence )
process.HLT_HIDmesonHITrackingGlobal_Dpt20_Cent50_100_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1Centralityext50100HFplusANDminusTH0 + process.hltPreHIDmesonHITrackingGlobalDpt20Cent50100 + process.HLTHIPixelClusterSplitting + process.HLTDoHITrackingLocalStripSequenceZeroSuppression + process.HLTHIIterativeTrackingForGlobalPt8 + process.hltHIFullTrackCandsForDmesonGlobalPt8 + process.hltHIFullTrackFilterForDmesonGlobalPt8 + process.HLTtktkVtxForDmesonGlobal8Dpt20 + process.HLTtktkFilterForDmesonGlobal8Dp20 + process.HLTDoHIStripZeroSuppressionRepacker + process.HLTEndSequence )
...
process.HLT_HIUCC020_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1Centralityext010HFplusANDminusTH0 + process.hltPreHIUCC020 + process.HLTRecoMETHfSequence + process.hltGlobalSumETHfFilter4580 + process.HLTDoHILocalPixelClustersSequence + process.hltPixelActivityFilter59000 + process.HLTDoHIStripZeroSuppression + process.HLTEndSequence )
process.HLT_HIQ2Bottom005_Centrality1030_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sMinimumBiasHF1AND + process.hltPreHIQ2Bottom005Centrality1030 + process.HLTRecoMETHfSequence + process.hltGlobalSumETHfFilter1030 + process.HLTDoCaloHcalMethod0Sequence + process.hltEvtPlaneProducer + process.hltEvtPlaneFilterB005Cent1030 + process.HLTDoHIStripZeroSuppression + process.HLTEndSequence )
process.HLT_HIQ2Top005_Centrality1030_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sMinimumBiasHF1AND + process.hltPreHIQ2Top005Centrality1030 + process.HLTRecoMETHfSequence + process.hltGlobalSumETHfFilter1030 + process.HLTDoCaloHcalMethod0Sequence + process.hltEvtPlaneProducer + process.hltEvtPlaneFilterT005Cent1030 + process.HLTDoHIStripZeroSuppression + process.HLTEndSequence )
process.HLT_HIQ2Bottom005_Centrality3050_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sMinimumBiasHF1AND + process.hltPreHIQ2Bottom005Centrality3050 + process.HLTRecoMETHfSequence + process.hltGlobalSumETHfFilter3050 + process.HLTDoCaloHcalMethod0Sequence + process.hltEvtPlaneProducer + process.hltEvtPlaneFilterB005Cent3050 + process.HLTDoHIStripZeroSuppression + process.HLTEndSequence )
process.HLT_HIQ2Top005_Centrality3050_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sMinimumBiasHF1AND + process.hltPreHIQ2Top005Centrality3050 + process.HLTRecoMETHfSequence + process.hltGlobalSumETHfFilter3050 + process.HLTDoCaloHcalMethod0Sequence + process.hltEvtPlaneProducer + process.hltEvtPlaneFilterT005Cent3050 + process.HLTDoHIStripZeroSuppression + process.HLTEndSequence )
...
process.HLT_HIFullTrack18_L1Centrality010_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1Centralityext010HFplusANDminusTH0 + process.hltPreHIFullTrack18L1Centrality010 + process.HLTHIPixelClusterSplitting + process.HLTDoHITrackingLocalStripSequenceZeroSuppression + process.HLTHIIterativeTrackingForGlobalPt8 + process.hltHIFullTrackSelectedTracks + process.hltHIFullTrackCandsForHITrackTrigger + process.hltHIFullTrackFilter18 + process.HLTDoHIStripZeroSuppressionRepacker + process.HLTEndSequence )
...
process.HLT_HIL3Mu3_NHitQ15_2HF_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1MinimumBiasHF1AND + process.hltPreHIL3Mu3NHitQ152HF + process.hltHIL1SingleMu3MinBiasFiltered + process.HLTL2muonrecoSequence + process.hltHIL2Mu3N10HitQ2HFL2Filtered + process.HLTHIL3muonrecoSequence + process.hltHISingleMu3NHit152HFL3Filtered + process.HLTDoHIStripZeroSuppression + process.HLTEndSequence )
...
process.HLT_HIL3Mu15_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1MinimumBiasHF1AND + process.hltPreHIL3Mu15 + process.hltHIL1SingleMu12Filtered + process.HLTL2muonrecoSequence + process.hltHIL3Mu15L2Filtered + process.HLTHIL3muonrecoSequence + process.hltHISingleMu15L3Filtered + process.HLTDoHIStripZeroSuppression + process.HLTEndSequence )
...
process.HLT_HIUPCL1NotHFMinimumbiasHFplusANDminustTH0_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sHLTHIUPCL1NotHFMinimumbiasHFplusANDminustTH0 + process.hltPreHIUPCL1NotHFMinimumbiasHFplusANDminustTH0 + process.HLTEndSequence )
process.HLT_HIUPCL1NotHFMinimumbiasHFplusANDminustTH0Pixel_SingleTrack_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sHLTHIUPCL1NotHFMinimumbiasHFplusANDminustTH0 + process.hltPreHIUPCL1NotHFMinimumbiasHFplusANDminustTH0PixelSingleTrack + process.HLTDoHILocalPixelSequence + process.HLTRecopixelvertexingSequenceForUPC + process.hltPixelCandsForUPC + process.hltSinglePixelTrackForUPC + process.HLTEndSequence )
process.HLT_HIUPCL1DoubleMuOpenNotHFMinimumbiasHFplusANDminustTH0_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sHLTHIUPCL1DoubleMuOpenNotHFplusANDminustTH0BptxAND + process.hltPreHIUPCL1DoubleMuOpenNotHFMinimumbiasHFplusANDminustTH0 + process.hltL1DoubleMuOpenTH0L1Filtered + process.HLTEndSequence )
process.HLT_HIUPCL1DoubleMuOpenNotHFMinimumbiasHFplusANDminustTH0Pixel_SingleTrack_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sHLTHIUPCL1DoubleMuOpenNotHFplusANDminustTH0BptxAND + process.hltPreHIUPCL1DoubleMuOpenNotHFMinimumbiasHFplusANDminustTH0PixelSingleTrack + process.hltL1DoubleMuOpenTH0L1Filtered + process.HLTDoHILocalPixelSequence + process.HLTRecopixelvertexingSequenceForUPC + process.hltPixelCandsForUPC + process.hltSinglePixelTrackForUPC + process.HLTEndSequence )
...
process.HLT_HIL1Centralityext30100HFplusANDminusTH0_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1Centralityext30100HFplusANDminusTH0 + process.hltPreHIL1Centralityext30100HFplusANDminusTH0 + process.HLTDoHIStripZeroSuppression + process.HLTEndSequence )
process.HLT_HIL1Centralityext50100HFplusANDminusTH0_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1Centralityext50100HFplusANDminusTH0 + process.hltPreHIL1Centralityext50100HFplusANDminusTH0 + process.HLTDoHIStripZeroSuppression + process.HLTEndSequence )
process.HLT_HIL1Centralityext70100HFplusANDminusTH0_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1Centralityext70100HFplusANDminusTH0 + process.hltPreHIL1Centralityext70100HFplusANDminusTH0 + process.HLTDoHIStripZeroSuppression + process.HLTEndSequence )
process.HLT_HIL1Centralityext010HFplusANDminusTH0ForZS_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1Centralityext010HFplusANDminusTH0 + process.hltPreHIL1Centralityext010HFplusANDminusTH0ForZS + process.HLTDoHIStripZeroSuppression + process.HLTEndSequence )
...
process.HLT_HIPhysicsNoZS_v1 = cms.Path( process.HLTBeginSequence + process.hltPreHIPhysicsNoZS + process.HLTEndSequence )
