# /cdaq/physics/Run2015HI/HeavyIon/216Bunches/v2.0/HLT/V1 (CMSSW_7_5_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2015HI/HeavyIon/216Bunches/v2.0/HLT/V1')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIUCC100_v2" ),
        prescales = cms.vuint32( 10, 22, 14, 6, 4, 4, 4 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUCC020_v2" ),
        prescales = cms.vuint32( 2, 2, 4, 2, 2, 2, 2 )
      ),
