# /cdaq/physics/Run2015HI/HeavyIon/5Bunches/v2.0/HLT/V1 (CMSSW_7_5_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2015HI/HeavyIon/5Bunches/v2.0/HLT/V1')
)
...
process.datasets = cms.PSet( 
  ...
  HIHardProbes = cms.vstring( 'HLT_HIDmesonHITrackingGlobal_Dpt20_Cent30_100_v1',
    'HLT_HIDmesonHITrackingGlobal_Dpt20_v1',
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIUCC100_v1" ),
        prescales = cms.vuint32( 8, 6, 4, 1, 1, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIUCC020_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 1, 2 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIFullTrack12_L1Centrality010_v1" ),
        prescales = cms.vuint32( 2, 2, 2, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIFullTrack12_L1Centrality30100_v1" ),
        prescales = cms.vuint32( 2, 2, 2, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1DoubleMu0_v1" ),
        prescales = cms.vuint32( 100, 66, 40, 1, 1, 15 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1DoubleMu0_2HF_v1" ),
        prescales = cms.vuint32( 12, 8, 5, 1, 1, 3 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIZeroBias_v1" ),
        prescales = cms.vuint32( 100, 100, 100, 29, 29, 100 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIPhysics_v1" ),
        prescales = cms.vuint32( 1000, 1000, 1000, 400, 400, 1000 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIPhysicsNoZS_v1" ),
        prescales = cms.vuint32( 5000, 5000, 5000, 4001, 4001, 5000 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_Random_v1" ),
        prescales = cms.vuint32( 60, 60, 60, 60, 60, 12 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_v2" ),
        prescales = cms.vuint32( 10, 10, 10, 10, 10, 2 )
      ),
      cms.PSet(  pathName = cms.string( "DQMOutput" ),
        prescales = cms.vuint32( 10, 10, 10, 10, 10, 10 )
      )
    ),
    lvl1DefaultLabel = cms.string( "2bunchsafety" ),
    lvl1Labels = cms.vstring( 'HI30kHz',
      'HI20kHz',
      'HI12kHz',
      '2bunchsafety',
      '2bunch',
...
process.hltPreHIExpressOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1techIgnorePrescales = cms.bool( False ),
    hltResults = cms.InputTag( "TriggerResults" ),
    triggerConditions = cms.vstring( 'HLT_HIPuAK4CaloJet100_Eta5p1_v1',
      'HLT_HIPuAK4CaloJet120_Eta5p1_v1',
      'HLT_HIPuAK4CaloBJetCSV80_Eta2p1_v1',
      'HLT_HIDmesonHITrackingGlobal_Dpt20_v1 / 4',
      'HLT_HIDmesonHITrackingGlobal_Dpt60_v1',
      'HLT_HISinglePhoton60_Eta1p5_v1',
      'HLT_HISinglePhoton60_Eta3p1_v1',
      'HLT_HIDoublePhoton15_Eta1p5_Mass50_1000_R9HECut_v1',
      ...
      'HLT_HIL1DoubleMu10_v1',
      'HLT_HIL2Mu20_2HF_v1',
      'HLT_HIL2DoubleMu0_Cent30_OS_NHitQ_v1 / 4',
      'HLT_HIL3DoubleMu0_OS_m2p5to4p5_v1',
      'HLT_HICentralityVeto_v1',
      'HLT_HIL1MinimumBiasHF1ANDExpress_v1',
      'HLT_HIRandom_v1' ),
...
process.hltOutputHIPhysicsHardProbes = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_HIDmesonHITrackingGlobal_Dpt20_Cent30_100_v1',
  'HLT_HIDmesonHITrackingGlobal_Dpt20_Cent50_100_v1',
  'HLT_HIDmesonHITrackingGlobal_Dpt20_v1',
  'HLT_HIDmesonHITrackingGlobal_Dpt30_Cent30_100_v1',
  'HLT_HIDmesonHITrackingGlobal_Dpt30_Cent50_100_v1',
...
process.hltOutputHIPhysicsVirginRaw = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_HIPhysicsNoZS_v1' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep *_hltL1GtObjectMap_*_*',
