# /cdaq/special/VirginRaw/2015HITests/ForHITestNov28/HLT/V1 (CMSSW_7_5_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/VirginRaw/2015HITests/ForHITestNov28/HLT/V1')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIUPCL1SingleMuOpenNotHF2_v1" ),
        prescales = cms.vuint32( 7, 6, 4, 4, 3, 2, 2 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIZeroBias_v1" ),
        prescales = cms.vuint32( 70, 70, 70, 70, 70, 70, 70 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HICentralityVeto_v1" ),
        prescales = cms.vuint32( 5, 5, 75, 67, 75, 100, 100 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1MinimumBiasHF1AND_v1" ),
        prescales = cms.vuint32( 1, 1, 15, 13, 15, 21, 21 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1MinimumBiasHF1ANDExpress_v1" ),
        prescales = cms.vuint32( 50, 51, 750, 666, 750, 1000, 1000 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1MinimumBiasHF1ANDPixel_SingleTrack_v1" ),
        prescales = cms.vuint32( 40, 40, 599, 534, 599, 799, 799 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1Centralityext010MinimumumBiasHF1ANDForZS_v1" ),
        prescales = cms.vuint32( 188, 715, 750, 2000, 1500, 1000, 1000 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIPhysics_v1" ),
        prescales = cms.vuint32( 1300, 1300, 1300, 1300, 1300, 800, 800 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_EcalPhiSymForHI_v1" ),
        prescales = cms.vuint32( 1, 1, 6, 6, 6, 8, 8 )
      ),
...
process.hltPreHIExpressOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring( 'HLT_HIPuAK4CaloJet100_Eta5p1_v1 / 30',
      ...
      'HLT_HISinglePhoton60_Eta3p1_v1 / 15',
      'HLT_HIDoublePhoton15_Eta1p5_Mass50_1000_R9HECut_v1 / 70',
      'HLT_HIFullTrack34_v1 / 10',
      'HLT_HIL1DoubleMu10_v1',
      'HLT_HIL2Mu15_2HF_v1',
      'HLT_HIL2Mu20_2HF_v1',
      'HLT_HIL2DoubleMu0_Cent30_OS_NHitQ_v1 / 90',
      'HLT_HIL3DoubleMu0_OS_m2p5to4p5_v1',
