# /cdaq/physics/Run2015/25ns14e33_0T/v4.0/HLT/V6 (CMSSW_7_4_10_patch1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2015/25ns14e33_0T/v4.0/HLT/V6')
)
...
process.datasets = cms.PSet( 
  ...
  DoubleEG_0T = cms.vstring( 'HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_MW_v2',
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_HT575_v1" ),
        prescales = cms.vuint32( 500, 500, 250, 170, 120, 70, 35, 25, 20, 12, 10, 3, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_Photon120_v2" ),
        prescales = cms.vuint32( 200, 150, 75, 50, 30, 15, 10, 5, 4, 3, 2, 1, 1 )
      ),
