# /cdaq/physics/firstCollisions15/v8.0/HLT/V3 (CMSSW_7_4_3)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions15/v8.0/HLT/V3')
)
...
process.datasets = cms.PSet( 
  ...
  SingleMu = cms.vstring( 'HLT_L1SingleMuOpen_v1' ),
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_Random_v2" ),
        prescales = cms.vuint32( 60, 60, 60 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_v1" ),
        prescales = cms.vuint32( 44, 44, 88 )
      )
    ),
    lvl1DefaultLabel = cms.string( "40 Colliding" ),
    lvl1Labels = cms.vstring( '40 Colliding',
      'Emergency',
      'Circulating' )
)
