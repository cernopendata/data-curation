# /cdaq/special/Stage1Test/v1.1/HLT/V3 (CMSSW_7_4_6)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/Stage1Test/v1.1/HLT/V3')
)
...
process.datasets = cms.PSet( 
  EventDisplay = cms.vstring( 'HLT_Physics_part2_v1' ),
  ...
  LookAreaPD = cms.vstring( 'HLT_Physics_part2_v1',
    'HLT_Physics_v4' ),
  OnlineMonitor = cms.vstring( 'HLT_Physics_part2_v1',
    'HLT_Physics_v4' ),
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_Physics_part0_v1" ),
        prescales = cms.vuint32( 10000, 360, 320, 280, 240, 200, 160, 120, 80, 40, 10000 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_v1" ),
        prescales = cms.vuint32( 10000, 400, 400, 400, 400, 400, 400, 400, 400, 400, 400 )
      )
    ),
    lvl1DefaultLabel = cms.string( "10kHzL1" ),
...
process.hltPreDQMEventDisplayOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1techIgnorePrescales = cms.bool( False ),
    hltResults = cms.InputTag( "TriggerResults" ),
    triggerConditions = cms.vstring( 'HLT_Physics_part2_v1 / 100' ),
    throw = cms.bool( True ),
    daqPartitions = cms.uint32( 1 )
)
...
process.hltOutputPhysics = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_Physics_part0_v1',
...
process.hltOutputDQM = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_Physics_part2_v1',
  'HLT_Physics_v4' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep *_hltL1GtObjectMap_*_*',
      'keep FEDRawDataCollection_rawDataCollector_*_*',
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_Physics_v4, process.HLT_Physics_part0_v1, process.HLT_Physics_part1_v1, process.HLT_Physics_part2_v1, process.HLT_Physics_part3_v1, process.HLT_Physics_part4_v1, process.HLT_Physics_part5_v1, process.HLT_Physics_part6_v1, process.HLT_Physics_part7_v1, process.DST_Physics_v4, process.HLT_Random_v2, process.HLT_ZeroBias_v1, process.HLTriggerFinalPath, process.RatesMonitoring, process.PhysicsOutput, process.DQMOutput, process.LookAreaOutput, process.DQMEventDisplayOutput, process.ExpressOutput, process.NanoDSTOutput ))
