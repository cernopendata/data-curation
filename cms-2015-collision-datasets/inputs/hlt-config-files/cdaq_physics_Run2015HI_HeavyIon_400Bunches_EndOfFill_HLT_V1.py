# /cdaq/physics/Run2015HI/HeavyIon/400Bunches/EndOfFill/HLT/V1 (CMSSW_7_5_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2015HI/HeavyIon/400Bunches/EndOfFill/HLT/V1')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1DoubleMu0_Cent30_v1" ),
        prescales = cms.vuint32( 0, 2, 1, 1, 1, 1, 2 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1MinimumBiasHF1AND_v1" ),
        prescales = cms.vuint32( 1, 21, 15, 11, 7, 5, 21 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIL1MinimumBiasHF1ANDExpress_v1" ),
        prescales = cms.vuint32( 50, 1000, 750, 499, 324, 199, 1000 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1MinimumBiasHF1ANDPixel_SingleTrack_v1" ),
        prescales = cms.vuint32( 40, 799, 600, 399, 259, 159, 799 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1Centralityext50100MinimumumBiasHF1AND_v1" ),
        prescales = cms.vuint32( 1, 1, 2, 1, 1, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HIL1Centralityext010MinimumumBiasHF1ANDForZS_v1" ),
        prescales = cms.vuint32( 188, 1000, 1200, 200, 130, 80, 1000 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HIPhysics_v1" ),
        prescales = cms.vuint32( 1300, 800, 700, 400, 260, 160, 800 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_EcalPhiSymForHI_v1" ),
        prescales = cms.vuint32( 1, 8, 4, 4, 3, 2, 8 )
      ),
