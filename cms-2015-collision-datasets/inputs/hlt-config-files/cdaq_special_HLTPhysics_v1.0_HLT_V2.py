# /cdaq/special/HLTPhysics/v1.0/HLT/V2 (CMSSW_7_4_6)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/HLTPhysics/v1.0/HLT/V2')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_Physics_part0_v1" ),
        prescales = cms.vuint32( 250, 300, 400, 500, 1000, 5000, 64, 64, 64, 64, 10000 )
      ),
