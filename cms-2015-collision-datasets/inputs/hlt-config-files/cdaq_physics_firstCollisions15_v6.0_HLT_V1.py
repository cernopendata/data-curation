# /cdaq/physics/firstCollisions15/v6.0/HLT/V1 (CMSSW_7_4_1_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions15/v6.0/HLT/V1')
)
...
process.datasets = cms.PSet( 
  ...
  Commissioning = cms.vstring( 'HLT_L1SingleEG20_WideWindow_v1',
    'HLT_L1SingleEG20_v1',
    'HLT_L1SingleEG5_WideWindow_v1',
    'HLT_L1SingleEG5_v1',
    'HLT_L1SingleJet36_WideWindow_v1',
    'HLT_L1SingleJet36_v1',
    'HLT_L1SingleJet68_WideWindow_v1',
    'HLT_L1SingleJet68_v1',
    'HLT_L1SingleMu3p5_WideWindow_v1',
    'HLT_L1SingleMu3p5_v1',
    'HLT_L1SingleMuOpen_WideWindow_v1',
  ...
  EventDisplay = cms.vstring( 'HLT_L1SingleEG20_WideWindow_v1',
    'HLT_L1SingleJet68_WideWindow_v1',
    'HLT_L1SingleMu3p5_WideWindow_v1' ),
  ExpressPhysics = cms.vstring( 'HLT_L1SingleEG20_WideWindow_v1',
    'HLT_L1SingleEG5_WideWindow_v1',
    'HLT_L1SingleJet36_WideWindow_v1',
    'HLT_L1SingleJet68_WideWindow_v1',
    'HLT_L1SingleMu3p5_WideWindow_v1',
  ...
  LookAreaPD = cms.vstring( 'HLT_HcalNZS_v9',
    'HLT_HcalPhiSym_v10',
    'HLT_HcalUTCA_v1',
    'HLT_L1SingleEG20_WideWindow_v1',
    'HLT_L1SingleEG5_WideWindow_v1',
    'HLT_L1SingleJet36_WideWindow_v1',
    'HLT_L1SingleJet68_WideWindow_v1',
    'HLT_L1SingleMu3p5_WideWindow_v1',
  ...
  SingleMu = cms.vstring( 'HLT_L1SingleMu3p5_WideWindow_v1',
    'HLT_L1SingleMu3p5_v1',
    'HLT_L1SingleMuOpen_WideWindow_v1',
    'HLT_L1SingleMuOpen_v1' ),
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG5_v1" ),
        prescales = cms.vuint32( 20, 40, 80, 120, 80, 160 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG5_WideWindow_v1" ),
        prescales = cms.vuint32( 20, 40, 80, 120, 80, 160 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG20_v1" ),
        prescales = cms.vuint32( 1, 2, 4, 6, 4, 8 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG20_WideWindow_v1" ),
        prescales = cms.vuint32( 1, 2, 4, 6, 4, 8 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleJet36_v1" ),
        prescales = cms.vuint32( 1, 2, 4, 6, 4, 8 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleJet36_WideWindow_v1" ),
        prescales = cms.vuint32( 1, 2, 4, 6, 4, 8 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleMuOpen_v1" ),
        prescales = cms.vuint32( 200, 400, 800, 1200, 800, 1600 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleMuOpen_WideWindow_v1" ),
        prescales = cms.vuint32( 200, 400, 800, 1200, 800, 1600 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleMu3p5_v1" ),
        prescales = cms.vuint32( 5, 10, 20, 30, 20, 40 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleMu3p5_WideWindow_v1" ),
        prescales = cms.vuint32( 5, 10, 20, 30, 20, 40 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_v4" ),
        prescales = cms.vuint32( 900, 1800, 1800, 5400, 3600, 3600 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_part0_v1" ),
        prescales = cms.vuint32( 88, 176, 176, 528, 352, 352 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_EcalPhiSym_v1" ),
        prescales = cms.vuint32( 3, 6, 6, 18, 12, 12 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "NanoDSTOutput" ),
        prescales = cms.vuint32( 1, 1, 1, 3, 2, 2 )
      ),
      cms.PSet(  pathName = cms.string( "RPCMONOutput" ),
        prescales = cms.vuint32( 1, 1, 1, 2, 2, 3 )
      )
    ),
...
process.hltL1SingleEG5WideWindow = cms.EDFilter( "HLTLevel1Activity",
    technicalBits = cms.uint64( 0x0 ),
    ignoreL1Mask = cms.bool( True ),
    invert = cms.bool( False ),
    physicsLoBits = cms.uint64( 2147483648 ),
    physicsHiBits = cms.uint64( 0 ),
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    daqPartitions = cms.uint32( 1 ),
    bunchCrossings = cms.vint32( 0, -1, 1, -2, 2 )
)
process.hltPreL1SingleEG5WideWindow = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltL1SingleEG20WideWindow = cms.EDFilter( "HLTLevel1Activity",
    technicalBits = cms.uint64( 0x0 ),
    ignoreL1Mask = cms.bool( True ),
    invert = cms.bool( False ),
    physicsLoBits = cms.uint64( 4294967296 ),
    physicsHiBits = cms.uint64( 0 ),
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    daqPartitions = cms.uint32( 1 ),
    bunchCrossings = cms.vint32( 0, -1, 1, -2, 2 )
)
process.hltPreL1SingleEG20WideWindow = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltL1SingleJet36WideWindow = cms.EDFilter( "HLTLevel1Activity",
    technicalBits = cms.uint64( 0x0 ),
    ignoreL1Mask = cms.bool( True ),
    invert = cms.bool( False ),
    physicsLoBits = cms.uint64( 16384 ),
    physicsHiBits = cms.uint64( 0 ),
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    daqPartitions = cms.uint32( 1 ),
    bunchCrossings = cms.vint32( 0, -1, 1, -2, 2 )
)
process.hltPreL1SingleJet36WideWindow = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreL1SingleJet68 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltL1SingleJet68WideWindow = cms.EDFilter( "HLTLevel1Activity",
    technicalBits = cms.uint64( 0x0 ),
    ignoreL1Mask = cms.bool( True ),
    invert = cms.bool( False ),
    physicsLoBits = cms.uint64( 32768 ),
    physicsHiBits = cms.uint64( 0 ),
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    daqPartitions = cms.uint32( 1 ),
    bunchCrossings = cms.vint32( 0, -1, 1, -2, 2 )
)
process.hltPreL1SingleJet68WideWindow = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltL1SingleMuOpenWideWindow = cms.EDFilter( "HLTLevel1Activity",
    technicalBits = cms.uint64( 0x0 ),
    ignoreL1Mask = cms.bool( True ),
    invert = cms.bool( False ),
    physicsLoBits = cms.uint64( 0 ),
    physicsHiBits = cms.uint64( 17179869184 ),
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    daqPartitions = cms.uint32( 1 ),
    bunchCrossings = cms.vint32( 0, -1, 1, -2, 2 )
)
process.hltPreL1SingleMuOpenWideWindow = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sL1SingleMu3p5 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleMu3p5" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
    L1UseAliasesForSeeding = cms.bool( True ),
...
process.hltPreL1SingleMu3p5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
process.hltL1SingleMu5WideWindow = cms.EDFilter( "HLTLevel1Activity",
    technicalBits = cms.uint64( 0x0 ),
    ignoreL1Mask = cms.bool( True ),
    invert = cms.bool( False ),
    physicsLoBits = cms.uint64( 2251799813685248 ),
    physicsHiBits = cms.uint64( 0 ),
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    daqPartitions = cms.uint32( 1 ),
    bunchCrossings = cms.vint32( 0, -1, 1, -2, 2 )
)
process.hltPreL1SingleMu3p5WideWindow = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltL1sAlCaRPC = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleMuOpen OR L1_SingleMu3p5" ),
    saveTags = cms.bool( True ),
    L1MuonCollectionTag = cms.InputTag( "hltL1extraParticles" ),
    L1UseL1TriggerObjectMaps = cms.bool( True ),
    L1UseAliasesForSeeding = cms.bool( True ),
...
process.hltPreDQMOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring( 'HLT_L1SingleEG5_WideWindow_v1 / 10',
      'HLT_L1SingleEG20_WideWindow_v1 / 3',
      'HLT_L1SingleJet36_WideWindow_v1 / 2',
      'HLT_L1SingleJet68_WideWindow_v1',
      'HLT_L1SingleMuOpen_WideWindow_v1',
      'HLT_L1SingleMu3p5_WideWindow_v1 / 4',
      'HLT_ZeroBias_part0_v1 / 250',
      'HLT_HcalNZS_v9 / 10',
...
process.hltPreLookAreaOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1techIgnorePrescales = cms.bool( False ),
    hltResults = cms.InputTag( "TriggerResults" ),
    triggerConditions = cms.vstring( 'HLT_L1SingleEG5_WideWindow_v1 / 50',
      'HLT_L1SingleEG20_WideWindow_v1 / 15',
      'HLT_L1SingleJet36_WideWindow_v1 / 10',
      'HLT_L1SingleJet68_WideWindow_v1 / 5',
      'HLT_L1SingleMuOpen_WideWindow_v1 / 5',
      'HLT_L1SingleMu3p5_WideWindow_v1 / 20',
      'HLT_ZeroBias_part0_v1 / 1250',
      'HLT_HcalNZS_v9 / 50',
...
process.hltPreDQMEventDisplayOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1techIgnorePrescales = cms.bool( False ),
    hltResults = cms.InputTag( "TriggerResults" ),
    triggerConditions = cms.vstring( 'HLT_L1SingleEG20_WideWindow_v1 / 15',
      'HLT_L1SingleJet68_WideWindow_v1',
      'HLT_L1SingleMu3p5_WideWindow_v1 / 10' ),
    throw = cms.bool( True ),
    daqPartitions = cms.uint32( 1 )
)
...
process.hltPreExpressOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1techIgnorePrescales = cms.bool( False ),
    hltResults = cms.InputTag( "TriggerResults" ),
    triggerConditions = cms.vstring( 'HLT_L1SingleEG5_WideWindow_v1 / 8',
      'HLT_L1SingleEG20_WideWindow_v1 / 3',
      'HLT_L1SingleJet36_WideWindow_v1 / 4',
      'HLT_L1SingleJet68_WideWindow_v1',
      'HLT_L1SingleMuOpen_WideWindow_v1',
      'HLT_L1SingleMu3p5_WideWindow_v1 / 5',
...
process.hltOutputDQMEventDisplay = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_L1SingleEG20_WideWindow_v1',
  'HLT_L1SingleJet68_WideWindow_v1',
  'HLT_L1SingleMu3p5_WideWindow_v1' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep FEDRawDataCollection_rawDataCollector_*_*',
...
process.HLT_L1SingleEG5_WideWindow_v1 = cms.Path( process.HLTBeginSequence + process.hltL1SingleEG5WideWindow + process.hltPreL1SingleEG5WideWindow + process.HLTEndSequence )
...
process.HLT_L1SingleEG20_WideWindow_v1 = cms.Path( process.HLTBeginSequence + process.hltL1SingleEG20WideWindow + process.hltPreL1SingleEG20WideWindow + process.HLTEndSequence )
...
process.HLT_L1SingleJet36_WideWindow_v1 = cms.Path( process.HLTBeginSequence + process.hltL1SingleJet36WideWindow + process.hltPreL1SingleJet36WideWindow + process.HLTEndSequence )
process.HLT_L1SingleJet68_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleJet68 + process.hltPreL1SingleJet68 + process.HLTEndSequence )
process.HLT_L1SingleJet68_WideWindow_v1 = cms.Path( process.HLTBeginSequence + process.hltL1SingleJet68WideWindow + process.hltPreL1SingleJet68WideWindow + process.HLTEndSequence )
process.HLT_L1SingleMuOpen_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleMuOpen + process.hltPreL1SingleMuOpen + process.HLTEndSequence )
process.HLT_L1SingleMuOpen_WideWindow_v1 = cms.Path( process.HLTBeginSequence + process.hltL1SingleMuOpenWideWindow + process.hltPreL1SingleMuOpenWideWindow + process.HLTEndSequence )
process.HLT_L1SingleMu3p5_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleMu3p5 + process.hltPreL1SingleMu3p5 + process.HLTEndSequence )
process.HLT_L1SingleMu3p5_WideWindow_v1 = cms.Path( process.HLTBeginSequence + process.hltL1SingleMu5WideWindow + process.hltPreL1SingleMu3p5WideWindow + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_L1SingleEG5_v1, process.HLT_L1SingleEG5_WideWindow_v1, process.HLT_L1SingleEG20_v1, process.HLT_L1SingleEG20_WideWindow_v1, process.HLT_L1SingleJet36_v1, process.HLT_L1SingleJet36_WideWindow_v1, process.HLT_L1SingleJet68_v1, process.HLT_L1SingleJet68_WideWindow_v1, process.HLT_L1SingleMuOpen_v1, process.HLT_L1SingleMuOpen_WideWindow_v1, process.HLT_L1SingleMu3p5_v1, process.HLT_L1SingleMu3p5_WideWindow_v1, process.HLT_Physics_v4, process.HLT_ZeroBias_part0_v1, process.HLT_ZeroBias_part1_v1, process.HLT_ZeroBias_part2_v1, process.HLT_ZeroBias_part3_v1, process.HLT_ZeroBias_part4_v1, process.HLT_ZeroBias_part5_v1, process.HLT_ZeroBias_part6_v1, process.HLT_ZeroBias_part7_v1, process.HLT_L1Tech5_BPTX_PlusOnly_v1, process.HLT_L1Tech6_BPTX_MinusOnly_v1, process.HLT_L1Tech7_NoBPTX_v1, process.DST_Physics_v4, process.HLT_EcalCalibration_v3, process.HLT_HcalCalibration_v3, process.AlCa_EcalPhiSym_v1, process.AlCa_EcalPi0EBonly_v1, process.AlCa_EcalPi0EEonly_v1, process.AlCa_EcalEtaEBonly_v1, process.AlCa_EcalEtaEEonly_v1, process.AlCa_RPCMuonNormalisation_v9, process.AlCa_RPCMuonNoHits_v9, process.AlCa_RPCMuonNoTriggers_v9, process.HLT_HcalNZS_v9, process.HLT_HcalPhiSym_v10, process.HLT_HcalUTCA_v1, process.HLT_Random_v2, process.HLTriggerFinalPath, process.RatesMonitoring, process.AOutput, process.DQMOutput, process.LookAreaOutput, process.DQMEventDisplayOutput, process.ExpressOutput, process.NanoDSTOutput, process.CalibrationOutput, process.ALCAPHISYMOutput, process.ALCAP0Output, process.EcalCalibrationOutput, process.DQMCalibrationOutput, process.RPCMONOutput ))
