# /cdaq/physics/firstCollisions15/v7.0/HLT/V10 (CMSSW_7_4_1_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions15/v7.0/HLT/V10')
)
...
process.datasets = cms.PSet( 
  ...
  Commissioning = cms.vstring( 'HLT_L1Tech5_BPTX_PlusOnly_v1',
  ...
  ExpressPhysics = cms.vstring( 'HLT_L1SingleEG20_v1',
    'HLT_L1SingleEG5_v1',
  ...
  HcalNZS = cms.vstring( 'HLT_HcalNZS_v9',
    'HLT_HcalPhiSym_v10',
    'HLT_HcalUTCA_v1' ),
  Jet = cms.vstring( 'HLT_L1SingleJet16_v1',
    'HLT_L1SingleJet36_v1',
    'HLT_L1SingleJet68_v1' ),
  ...
  SingleMu = cms.vstring( 'HLT_L1SingleMu3p5_v1',
    'HLT_L1SingleMuOpen_v1' ),
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_L1SingleMu3p5_v1" ),
        prescales = cms.vuint32( 8, 16, 32, 48, 32, 64 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_EcalPhiSym_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 3, 1, 2 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_EcalPi0EBonly_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 2, 1, 2 )
      ),
...
process.hltPreDQMOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring( 'HLT_L1SingleEG5_v1 / 10',
      'HLT_L1SingleEG20_v1 / 3',
      'HLT_L1SingleJet16_v1 / 2',
      'HLT_L1SingleJet36_v1 / 2',
      'HLT_L1SingleJet68_v1',
      'HLT_L1SingleMuOpen_v1',
      'HLT_L1SingleMu3p5_v1 / 2',
...
process.hltPreLookAreaOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1techIgnorePrescales = cms.bool( False ),
    hltResults = cms.InputTag( "TriggerResults" ),
    triggerConditions = cms.vstring( 'HLT_L1SingleEG5_v1 / 50',
      'HLT_L1SingleEG20_v1 / 15',
      'HLT_L1SingleJet16_v1 / 10',
      'HLT_L1SingleJet36_v1 / 10',
      'HLT_L1SingleJet68_v1 / 5',
      'HLT_L1SingleMuOpen_v1 / 5',
      'HLT_L1SingleMu3p5_v1 / 10',
...
process.hltPreDQMEventDisplayOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1techIgnorePrescales = cms.bool( False ),
    hltResults = cms.InputTag( "TriggerResults" ),
    triggerConditions = cms.vstring( 'HLT_L1SingleEG20_v1 / 15',
      'HLT_L1SingleJet68_v1',
      'HLT_L1SingleMu3p5_v1 / 10' ),
    throw = cms.bool( True ),
    daqPartitions = cms.uint32( 1 )
...
process.hltPreExpressOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    l1techIgnorePrescales = cms.bool( False ),
    hltResults = cms.InputTag( "TriggerResults" ),
    triggerConditions = cms.vstring( 'HLT_L1SingleEG5_v1 / 8',
      'HLT_L1SingleEG20_v1 / 3',
      'HLT_L1SingleJet16_v1 / 4',
      'HLT_L1SingleJet36_v1 / 3',
      'HLT_L1SingleJet68_v1',
      'HLT_L1SingleMuOpen_v1',
      'HLT_L1SingleMu3p5_v1 / 4',
      'HLT_Physics_v4',
