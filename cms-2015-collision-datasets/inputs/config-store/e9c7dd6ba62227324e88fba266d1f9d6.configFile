...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO,ALCA:EcalCalWElectron+EcalUncalWElectron+EcalCalZElectron+EcalUncalZElectron+HcalCalIterativePhiSym,EI,PAT,DQM:@standardDQM+@miniAODDQM --runUnscheduled --nThreads 4 --data --scenario pp --conditions 76X_dataRun2_v15 --eventcontent RECO,AOD,MINIAOD,DQM --datatier RECO,AOD,MINIAOD,DQMIO --customise Configuration/DataProcessing/RecoTLR.customiseDataRun2Common_25ns --filein blah.root -n 100 --no_exec --python_filename=reco_Run2015D_SingleElectron.py --no_exec
...
process.ALCARECOStreamEcalCalWElectron = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('pathALCARECOEcalCalWElectron')
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('ALCARECO'),
        filterName = cms.untracked.string('EcalCalWElectron')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('EcalCalWElectron.root'),
...
# Other statements
process.ALCARECOEventContent.outputCommands.extend(process.OutALCARECOEcalCalWElectron_noDrop.outputCommands)
...
process.ALCARECOStreamEcalCalWElectronOutPath = cms.EndPath(process.ALCARECOStreamEcalCalWElectron)
