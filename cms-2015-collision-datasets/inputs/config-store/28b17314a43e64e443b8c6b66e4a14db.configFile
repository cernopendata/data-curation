...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO,ALCA:HcalCalGammaJet,EI,PAT,DQM:@standardDQM+@miniAODDQM --runUnscheduled --nThreads 4 --data --scenario pp --conditions 76X_dataRun2_v15 --eventcontent RECO,AOD,MINIAOD,DQM --datatier RECO,AOD,MINIAOD,DQMIO --customise Configuration/DataProcessing/RecoTLR.customiseDataRun2Common_25ns --filein blah.root -n 100 --no_exec --python_filename=reco_Run2015D_SinglePhoton.py --no_exec
...
process.ALCARECOStreamHcalCalGammaJet = cms.OutputModule("PoolOutputModule",
    ...
    dataset = cms.untracked.PSet(
        ...
        filterName = cms.untracked.string('HcalCalGammaJet')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('HcalCalGammaJet.root'),
...
# Other statements
process.ALCARECOEventContent.outputCommands.extend(process.OutALCARECOHcalCalGammaJet_noDrop.outputCommands)
