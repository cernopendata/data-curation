...
def get_dataset_year(dataset):
    ...
    return {
           ...
           'Summer12' : 2012,
           'HiFall13DR53X-NoPileUp': 2013,
           'HiWinter13DR53X-EPOS': 2013,
           'HiWinter13DR53X-nomix': 2013,
           'HiWinter13DR53X-QGSJETII': 2013,
           'HiWinter13-pa': 2013,
           'HiWinter13-pp': 2013,
           'HiWinter13-STARTHI53': 2013,
           'pAWinter13DR53X-pa': 2013,
...
def get_recommended_global_tag_for_analysis(dataset):
    ...
    if 'STARTHI53_LV1' in dataset:
        return 'STARTHI53_LV1::All'
    if 'STARTHI53_V26' in dataset or 'STARTHI53_V28' in dataset:
        return 'STARTHI53_V28::All'
    if 'STARTHI53_V25' in dataset or 'STARTHI53_V27' in dataset:
        return 'STARTHI53_V27::All'
    return 'FIXME'
    year = get_dataset_year(dataset)
    return {
