...
def get_dataset_collision_energy(dataset, mcm_dir):
    "Return collision energy of the dataset"
    # Special treatment for HI MC
...
def get_dataset_collision_type(dataset, mcm_dir):
    "Return collision type of the dataset"
    if 'STARTHI53_LV1' in dataset:
        return 'PbPb'
    if 'STARTHI53_V26' in dataset or 'STARTHI53_V28' in dataset:
        return 'pp'
