...
# Dump actual test code to a B2G-RunIISummer20UL17HLT-03866_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > B2G-RunIISummer20UL17HLT-03866_test.sh
#!/bin/bash
...
# cmsDriver command
cmsDriver.py  --python_filename B2G-RunIISummer20UL17HLT-03866_1_cfg.py --eventcontent RAWSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --fileout file:B2G-RunIISummer20UL17HLT-03866.root --conditions 94X_mc2017_realistic_v15 --customise_commands 'process.source.bypassVersionCheck = cms.untracked.bool(True)' --step HLT:2e34v40 --geometry DB:Extended --filein file:B2G-RunIISummer20UL17DIGIPremix-03866.root --era Run2_2017 --no_exec --mc -n $EVENTS || exit $? ;

# Run generated config
REPORT_NAME=B2G-RunIISummer20UL17HLT-03866_report.xml
# Run the cmsRun
cmsRun -e -j $REPORT_NAME B2G-RunIISummer20UL17HLT-03866_1_cfg.py || exit $? ;

# Parse values from B2G-RunIISummer20UL17HLT-03866_report.xml report
...
echo "Validation report of B2G-RunIISummer20UL17HLT-03866 sequence 1/1"
...
# End of B2G-RunIISummer20UL17HLT-03866_test.sh file
EndOfTestFile

# Make file executable
chmod +x B2G-RunIISummer20UL17HLT-03866_test.sh
...
singularity run -B /afs -B /eos -B /cvmfs -B /etc/grid-security -B /etc/pki/ca-trust --home $PWD:$PWD /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/B2G-RunIISummer20UL17HLT-03866_test.sh)
