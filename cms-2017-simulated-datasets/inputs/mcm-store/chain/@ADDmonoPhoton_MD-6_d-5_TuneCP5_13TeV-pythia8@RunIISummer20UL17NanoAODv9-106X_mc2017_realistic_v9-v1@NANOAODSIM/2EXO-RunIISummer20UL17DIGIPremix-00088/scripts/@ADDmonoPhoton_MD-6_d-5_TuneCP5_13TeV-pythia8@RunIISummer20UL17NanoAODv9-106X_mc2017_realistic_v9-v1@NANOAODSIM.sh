...
# Dump actual test code to a EXO-RunIISummer20UL17DIGIPremix-00088_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > EXO-RunIISummer20UL17DIGIPremix-00088_test.sh
#!/bin/bash
...
# cmsDriver command
cmsDriver.py  --python_filename EXO-RunIISummer20UL17DIGIPremix-00088_1_cfg.py --eventcontent PREMIXRAW --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-DIGI --fileout file:EXO-RunIISummer20UL17DIGIPremix-00088.root --pileup_input "dbs:/Neutrino_E-10_gun/RunIISummer20ULPrePremix-UL17_106X_mc2017_realistic_v6-v3/PREMIX" --conditions 106X_mc2017_realistic_v6 --step DIGI,DATAMIX,L1,DIGI2RAW --procModifiers premix_stage2 --geometry DB:Extended --filein file:EXO-RunIISummer20UL17SIM-00088.root --datamix PreMix --era Run2_2017 --runUnscheduled --no_exec --mc -n $EVENTS || exit $? ;

# Run generated config
REPORT_NAME=EXO-RunIISummer20UL17DIGIPremix-00088_report.xml
# Run the cmsRun
cmsRun -e -j $REPORT_NAME EXO-RunIISummer20UL17DIGIPremix-00088_1_cfg.py || exit $? ;

# Parse values from EXO-RunIISummer20UL17DIGIPremix-00088_report.xml report
...
echo "Validation report of EXO-RunIISummer20UL17DIGIPremix-00088 sequence 1/1"
...
# End of EXO-RunIISummer20UL17DIGIPremix-00088_test.sh file
EndOfTestFile

# Make file executable
chmod +x EXO-RunIISummer20UL17DIGIPremix-00088_test.sh
...
singularity run -B /afs -B /eos -B /cvmfs -B /etc/grid-security -B /etc/pki/ca-trust --home $PWD:$PWD /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/EXO-RunIISummer20UL17DIGIPremix-00088_test.sh)
