...
pdfsets="325300,316200,306000,322500@0,322700@0,322900@0,323100@0,323300@0,323500@0,323700@0,323900@0,305800,13000,13065@0,13069@0,13100,13163@0,13167@0,13200@0,25200,25300,25000@0,42780,90200,91200,90400,91400,61100,61130,61200,61230,13400,82200,292200,292600@0,315000@0,315200@0,262000@0,263000@0"
...
echo "setting color tags: BSM-like scenario"


# set color flows for the hard scattering process: ordering important!
sed -i "s|21 -1    0    0    0    0 +|21 -1    0    0  503  502 +|g" ${LHEWORKDIR}/cmsgrid_final.lhe # incoming gluon1
sed -i "s|21 -1    0    0    0    0 -|21 -1    0    0  502  503 -|g" ${LHEWORKDIR}/cmsgrid_final.lhe # incoming gluon2
sed -i "s|-6  1    1    2    0    0|-6  1    1    2    0  501|g" ${LHEWORKDIR}/cmsgrid_final.lhe     # outgoing antitop
sed -i "s|6  1    1    2    0    0|6  1    1    2  501    0|g" ${LHEWORKDIR}/cmsgrid_final.lhe       # outgoing top
