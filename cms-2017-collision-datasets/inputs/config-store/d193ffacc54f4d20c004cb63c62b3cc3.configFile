...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO,SKIM:TopMuEG,EI,PAT,DQM:@rerecoCommon --runUnscheduled --nThreads 8 --data --era Run2_2017 --scenario pp --conditions 106X_dataRun2_v20 --eventcontent AOD,MINIAOD,DQM --datatier AOD,MINIAOD,DQMIO --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2017 --filein file:pippo.root -n 100 --python_filename=recoskim_Run2017C_MuonEG.py --no_exec
...
process.AODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('RECO_RAW2DIGI_L1Reco_RECO_SKIM_EI_PAT_DQM.root'),
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('RECO_RAW2DIGI_L1Reco_RECO_SKIM_EI_PAT_DQM_inMINIAOD.root'),
...
process.DQMoutput = cms.OutputModule("DQMRootOutputModule",
    ...
    fileName = cms.untracked.string('RECO_RAW2DIGI_L1Reco_RECO_SKIM_EI_PAT_DQM_inDQM.root'),
