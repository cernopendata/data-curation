...
# with command line options: RECO --conditions 106X_dataRun2_v37 --customise Configuration/DataProcessing/Utils.addMonitoring,Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2017 --datatier MINIAOD --era Run2_2017,bParking --eventcontent MINIAOD --filein _placeholder_.root --fileout file:ReReco-Run2017C-DoubleMuon-UL2017_MiniAODv2_BParking-00001.root --nThreads 2 --no_exec --python_filename ReReco-Run2017C-DoubleMuon-UL2017_MiniAODv2_BParking-00001_0_cfg.py --scenario pp --step PAT --runUnscheduled --data --procModifiers run2_miniAOD_UL_preSummer20
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ReReco-Run2017C-DoubleMuon-UL2017_MiniAODv2_BParking-00001.root'),
