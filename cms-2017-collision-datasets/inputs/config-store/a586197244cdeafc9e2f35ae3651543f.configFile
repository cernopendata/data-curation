...
# with command line options: RECO --conditions 106X_dataRun2_v35 --customise Configuration/DataProcessing/Utils.addMonitoring --datatier NANOAOD --era Run2_2017,run2_nanoAOD_106Xv2 --eventcontent NANOEDMAOD --filein _placeholder_.root --fileout file:ReReco-Run2017C-SingleElectron-UL2017_MiniAODv2_NanoAODv9-00001.root --nThreads 2 --no_exec --python_filename ReReco-Run2017C-SingleElectron-UL2017_MiniAODv2_NanoAODv9-00001_0_cfg.py --scenario pp --step NANO --data
...
process.NANOEDMAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ReReco-Run2017C-SingleElectron-UL2017_MiniAODv2_NanoAODv9-00001.root'),
