# /cdaq/physics/firstCollisions17/v3.0/HLT/V29 (CMSSW_9_0_0)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions17/v3.0/HLT/V29')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_L1SingleMu7_v1" ),
        prescales = cms.vuint32( 0, 35, 35, 45, 45, 35, 45, 45, 45, 45, 45, 45, 45 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG10_v1" ),
        prescales = cms.vuint32( 0, 12, 12, 35, 35, 25, 35, 35, 35, 35, 35, 35, 35 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG18_v1" ),
        prescales = cms.vuint32( 0, 125, 125, 35, 35, 25, 35, 35, 35, 35, 35, 35, 35 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleJet35_v1" ),
        prescales = cms.vuint32( 0, 1, 1, 2, 2, 1, 2, 2, 2, 2, 2, 2, 2 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_L1DoubleIsoTau32er_v1" ),
        prescales = cms.vuint32( 0, 5, 5, 4, 4, 2, 4, 4, 4, 4, 4, 4, 4 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1DoubleJetC50_v1" ),
        prescales = cms.vuint32( 0, 70, 70, 28, 28, 20, 28, 28, 28, 28, 28, 28, 28 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_Random_v1" ),
        prescales = cms.vuint32( 4000, 60, 60, 4000, 4000, 60, 4000, 4000, 4000, 4000, 4000, 4000, 4000 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_v2" ),
        prescales = cms.vuint32( 330, 300, 300, 330, 330, 300, 330, 330, 330, 330, 330, 220, 110 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_FirstCollisionAfterAbortGap_v3" ),
        prescales = cms.vuint32( 0, 32, 32, 1100, 1100, 6, 1100, 1100, 1100, 1100, 1100, 1100, 1100 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_IsolatedBunches_v3" ),
        prescales = cms.vuint32( 0, 10, 10, 1100, 1100, 10, 1100, 1100, 1100, 1100, 1100, 1100, 1100 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_Random_v1" ),
        prescales = cms.vuint32( 0, 1, 1, 50, 50, 1, 50, 50, 50, 50, 50, 50, 50 )
      ),
