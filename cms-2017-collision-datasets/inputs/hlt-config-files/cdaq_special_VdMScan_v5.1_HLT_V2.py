# /cdaq/special/VdMScan/v5.1/HLT/V2 (CMSSW_9_1_0_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/VdMScan/v5.1/HLT/V2')
)
...
process.streams = cms.PSet( 
  ...
  Physics2 = cms.vstring( 'ZeroBias5',
    'ZeroBias6',
    'ZeroBias7',
    'ZeroBiasIsolatedBunches5',
    'ZeroBiasIsolatedBunches6',
    'ZeroBiasIsolatedBunches7' ),
  Physics3 = cms.vstring( 'ZeroBias10',
    'ZeroBias8',
    'ZeroBias9',
    'ZeroBiasIsolatedBunches10',
    'ZeroBiasIsolatedBunches8',
    'ZeroBiasIsolatedBunches9' ),
...
process.datasets = cms.PSet( 
  ...
  MinimumBias = cms.vstring( 'HLT_Physics_v2',
    'HLT_Random_v1',
    'HLT_ZeroBias_v2' ),
  ...
  ZeroBiasIsolatedBunches1 = cms.vstring( 'HLT_ZeroBias_IsolatedBunches_part0_v3' ),
  ZeroBiasIsolatedBunches10 = cms.vstring( 'HLT_ZeroBias_IsolatedBunches_part9_v3' ),
  ZeroBiasIsolatedBunches2 = cms.vstring( 'HLT_ZeroBias_IsolatedBunches_part1_v3' ),
  ZeroBiasIsolatedBunches3 = cms.vstring( 'HLT_ZeroBias_IsolatedBunches_part2_v3' ),
  ZeroBiasIsolatedBunches4 = cms.vstring( 'HLT_ZeroBias_IsolatedBunches_part3_v3' ),
  ZeroBiasIsolatedBunches5 = cms.vstring( 'HLT_ZeroBias_IsolatedBunches_part4_v3' ),
  ZeroBiasIsolatedBunches6 = cms.vstring( 'HLT_ZeroBias_IsolatedBunches_part5_v3' ),
  ZeroBiasIsolatedBunches7 = cms.vstring( 'HLT_ZeroBias_IsolatedBunches_part6_v3' ),
  ZeroBiasIsolatedBunches8 = cms.vstring( 'HLT_ZeroBias_IsolatedBunches_part7_v3' ),
  ZeroBiasIsolatedBunches9 = cms.vstring( 'HLT_ZeroBias_IsolatedBunches_part8_v3' )
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_IsolatedBunches_part6_v3" ),
        prescales = cms.vuint32( 20, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_IsolatedBunches_part7_v3" ),
        prescales = cms.vuint32( 20, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_IsolatedBunches_part8_v3" ),
        prescales = cms.vuint32( 20, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_IsolatedBunches_part9_v3" ),
        prescales = cms.vuint32( 20, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_part0_v2" ),
        prescales = cms.vuint32( 440, 220 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_v2" ),
        prescales = cms.vuint32( 12, 12 )
      )
    ),
    lvl1DefaultLabel = cms.string( "4.5kHz" ),
    lvl1Labels = cms.vstring( '2.25kHz',
      '4.5kHz' )
)
...
process.hltPreZeroBiasIsolatedBunchespart6 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 6 )
)
process.hltPreZeroBiasIsolatedBunchespart7 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 7 )
)
process.hltPreZeroBiasIsolatedBunchespart8 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 8 )
)
process.hltPreZeroBiasIsolatedBunchespart9 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 9 )
)
...
process.hltPreDQMOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring( '( HLT_Random_v1 OR FALSE OR HLT_HcalNZS_v2 OR HLT_HcalPhiSym_v2 OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE ) / 10',
...
process.hltOutputPhysics = cms.OutputModule( "ShmStreamConsumer",
  ...
  'HLT_Physics_v2',
  'HLT_Random_v1',
  'HLT_ZeroBias_IsolatedBunches_part0_v3',
  'HLT_ZeroBias_IsolatedBunches_part1_v3',
  'HLT_ZeroBias_IsolatedBunches_part2_v3',
  'HLT_ZeroBias_IsolatedBunches_part3_v3',
  'HLT_ZeroBias_part0_v2',
...
process.hltOutputPhysics2 = cms.OutputModule( "ShmStreamConsumer",
  ...
  'HLT_ZeroBias_IsolatedBunches_part5_v3',
  'HLT_ZeroBias_IsolatedBunches_part6_v3',
...
process.hltOutputPhysics3 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_ZeroBias_IsolatedBunches_part7_v3',
  'HLT_ZeroBias_IsolatedBunches_part8_v3',
  'HLT_ZeroBias_IsolatedBunches_part9_v3',
...
process.HLT_ZeroBias_IsolatedBunches_part6_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sIsolatedBunch + process.hltPreZeroBiasIsolatedBunchespart6 + process.HLTEndSequence )
process.HLT_ZeroBias_IsolatedBunches_part7_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sIsolatedBunch + process.hltPreZeroBiasIsolatedBunchespart7 + process.HLTEndSequence )
process.HLT_ZeroBias_IsolatedBunches_part8_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sIsolatedBunch + process.hltPreZeroBiasIsolatedBunchespart8 + process.HLTEndSequence )
process.HLT_ZeroBias_IsolatedBunches_part9_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sIsolatedBunch + process.hltPreZeroBiasIsolatedBunchespart9 + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_L1FatEvents_v1, process.HLT_Physics_v2, process.HLT_Random_v1, process.HLT_ZeroBias_v2, process.HLT_ZeroBias_FirstCollisionAfterAbortGap_v3, process.HLT_ZeroBias_IsolatedBunches_v3, process.HLT_ZeroBias_IsolatedBunches_part0_v3, process.HLT_ZeroBias_IsolatedBunches_part1_v3, process.HLT_ZeroBias_IsolatedBunches_part2_v3, process.HLT_ZeroBias_IsolatedBunches_part3_v3, process.HLT_ZeroBias_IsolatedBunches_part4_v3, process.HLT_ZeroBias_IsolatedBunches_part5_v3, process.HLT_ZeroBias_IsolatedBunches_part6_v3, process.HLT_ZeroBias_IsolatedBunches_part7_v3, process.HLT_ZeroBias_IsolatedBunches_part8_v3, process.HLT_ZeroBias_IsolatedBunches_part9_v3, process.HLT_ZeroBias_part0_v2, process.HLT_ZeroBias_part1_v2, process.HLT_ZeroBias_part2_v2, process.HLT_ZeroBias_part3_v2, process.HLT_ZeroBias_part4_v2, process.HLT_ZeroBias_part5_v2, process.HLT_ZeroBias_part6_v2, process.HLT_ZeroBias_part7_v2, process.HLT_ZeroBias_part8_v2, process.HLT_ZeroBias_part9_v2, process.HLT_EcalCalibration_v2, process.HLT_HcalCalibration_v1, process.HLT_HcalNZS_v2, process.HLT_HcalPhiSym_v2, process.AlCa_EcalEtaEBonly_v8, process.AlCa_EcalEtaEEonly_v8, process.AlCa_EcalPi0EBonly_v8, process.AlCa_EcalPi0EEonly_v8, process.AlCa_EcalPhiSym_v1, process.AlCa_RPCMuonNormalisation_v2, process.AlCa_LumiPixels_Random_v1, process.AlCa_LumiPixels_ZeroBias_v2, process.DST_Physics_v1, process.HLTriggerFinalPath, process.RatesMonitoring, process.PhysicsOutput, process.PhysicsOutput2, process.PhysicsOutput3, process.DQMOutput, process.DQMCalibrationOutput, process.DQMEventDisplayOutput, process.RPCMONOutput, process.CalibrationOutput, process.EcalCalibrationOutput, process.ALCAPHISYMOutput, process.ALCALUMIPIXELSOutput, process.ExpressOutput, process.NanoDSTOutput, process.DQMHistograms, process.ALCAP0Output ))
