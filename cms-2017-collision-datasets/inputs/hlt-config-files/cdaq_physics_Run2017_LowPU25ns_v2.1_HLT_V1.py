# /cdaq/physics/Run2017/LowPU25ns/v2.1/HLT/V1 (CMSSW_9_2_6_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2017/LowPU25ns/v2.1/HLT/V1')
)
...
process.streams = cms.PSet( 
  ...
  PhysicsZeroBias4 = cms.vstring( 'ZeroBias7',
    'ZeroBias8' ),
  PhysicsZeroBias5 = cms.vstring( 'ZeroBias10',
    'ZeroBias9' ),
...
process.datasets = cms.PSet( 
  ...
  ExpressPhysics = cms.vstring( 'HLT_Physics_v7',
    ...
    'HLT_ZeroBias_v6' ),
  FSQJet1 = cms.vstring( 'HLT_DiPFJet15_NoCaloMatched_v10',
    'HLT_DiPFJet25_NoCaloMatched_v10' ),
  ...
  OnlineMonitor = cms.vstring( 'HLT_AK4CaloJet100_v7',
    ...
    'HLT_DiPFJet15_NoCaloMatched_v10',
    'HLT_DiPFJet25_FBEta3_NoCaloMatched_v11',
    'HLT_DiPFJet25_NoCaloMatched_v10',
    'HLT_DiPFJetAve15_HFJEC_v11',
    'HLT_DiPFJetAve25_HFJEC_v11',
  ...
  SingleElectron = cms.vstring( 'HLT_Ele20_WPLoose_Gsf_v2',
    'HLT_Ele20_WPTight_Gsf_v2',
    'HLT_Ele20_eta2p1_WPLoose_Gsf_v2' ),
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_Ele20_WPTight_Gsf_v2" ),
        prescales = cms.vuint32( 0, 1, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Ele20_WPLoose_Gsf_v2" ),
        prescales = cms.vuint32( 0, 1, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Ele20_eta2p1_WPLoose_Gsf_v2" ),
        prescales = cms.vuint32( 0, 1, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_DiEle27_WPTightCaloOnly_L1DoubleEG_v2" ),
        prescales = cms.vuint32( 0, 1, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_DiPFJet15_NoCaloMatched_v10" ),
        prescales = cms.vuint32( 0, 8, 8, 8, 8 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_DiPFJet25_NoCaloMatched_v10" ),
        prescales = cms.vuint32( 0, 1, 1, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_FullTrack_Multiplicity85_part0_v4" ),
        prescales = cms.vuint32( 0, 5, 5, 5, 5 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_L1FatEvents_v2" ),
        prescales = cms.vuint32( 2333, 2333, 2333, 2333, 2333 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_Random_v3" ),
        prescales = cms.vuint32( 101, 101, 101, 101, 101 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_AK4CaloJet30_v8" ),
        prescales = cms.vuint32( 0, 3, 3, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_AK4PFJet100_v12" ),
        prescales = cms.vuint32( 0, 5, 3, 2, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_HISinglePhoton40_Eta3p1ForPPRef_v6" ),
        prescales = cms.vuint32( 0, 3, 2, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_Photon20_HoverELoose_v8" ),
        prescales = cms.vuint32( 0, 2, 1, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_EcalPhiSym_v8" ),
        prescales = cms.vuint32( 4, 1, 1, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_v8" ),
        prescales = cms.vuint32( 11, 11, 11, 11, 11 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_Mu17_v9" ),
        prescales = cms.vuint32( 100, 1, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "DQMOutput" ),
        prescales = cms.vuint32( 7, 7, 7, 7, 7 )
      ),
      cms.PSet(  pathName = cms.string( "PhysicsParkingScoutingMonitorOutput" ),
        prescales = cms.vuint32( 0, 0, 0, 0, 0 )
      )
    ),
    lvl1DefaultLabel = cms.string( "600bx_pu1.3" ),
    lvl1Labels = cms.vstring( 'Emergency_lowpu',
      '600bx_pu1.3',
      '600bx_pu1.0',
      '600bx_pu0.7',
      '600bx_pu0.5' )
...
process.hltEle20WPTightGsfDetaFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    ...
    saveTags = cms.bool( True ),
    thrOverE2EB = cms.vdouble( -1.0 ),
    thrRegularEE = cms.vdouble( 999.005 ),
    thrOverEEE = cms.vdouble( -1.0 ),
...
process.hltEle20WPTightGsfDphiFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    ...
    saveTags = cms.bool( True ),
    thrOverE2EB = cms.vdouble( -1.0 ),
    thrRegularEE = cms.vdouble( 999.023 ),
    thrOverEEE = cms.vdouble( -1.0 ),
...
process.hltEle20WPLoose1GsfDetaFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    ...
    saveTags = cms.bool( True ),
    thrOverE2EB = cms.vdouble( -1.0 ),
    thrRegularEE = cms.vdouble( 999.0055 ),
    thrOverEEE = cms.vdouble( -1.0 ),
    varTag = cms.InputTag( 'hltEgammaGsfTrackVars','DetaSeed' ),
    thrOverEEB = cms.vdouble( -1.0 ),
    thrRegularEB = cms.vdouble( 0.004 ),
...
process.hltEle20WPLoose1GsfDphiFilter = cms.EDFilter( "HLTEgammaGenericFilter",
    ...
    saveTags = cms.bool( True ),
    thrOverE2EB = cms.vdouble( -1.0 ),
    thrRegularEE = cms.vdouble( 999.025 ),
    thrOverEEE = cms.vdouble( -1.0 ),
    varTag = cms.InputTag( 'hltEgammaGsfTrackVars','Dphi' ),
    thrOverEEB = cms.vdouble( -1.0 ),
...
process.hltL1sETT50to60to80BptxAND = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_ETT50_BptxAND OR L1_ETT60_BptxAND OR  L1_ETT80_BptxAND" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltL1sETT50to60BptxAND = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_ETT50_BptxAND OR L1_ETT60_BptxAND OR  L1_ETT80_BptxAND" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
...
process.hltPreDQMOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring( 'HLT_Ele20_WPTight_Gsf_v2 / 3',
      'HLT_Ele20_WPLoose_Gsf_v2 / 3',
      'HLT_Ele20_eta2p1_WPLoose_Gsf_v2 / 3',
      'HLT_DiEle27_WPTightCaloOnly_L1DoubleEG_v2 / 3',
      'HLT_DiPFJet15_NoCaloMatched_v10 / 3',
      'HLT_DiPFJet25_NoCaloMatched_v10 / 3',
...
process.hltOutputPhysicsZeroBias1 = cms.OutputModule( "ShmStreamConsumer",
...
process.hltOutputPhysicsZeroBias2 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_ZeroBias_part2_v2',
  'HLT_ZeroBias_part3_v2' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep FEDRawDataCollection_rawDataCollector_*_*',
      'keep FEDRawDataCollection_source_*_*',
...
process.hltOutputPhysicsZeroBias3 = cms.OutputModule( "ShmStreamConsumer",
...
process.hltOutputPhysicsZeroBias4 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_ZeroBias_part6_v2',
  'HLT_ZeroBias_part7_v2' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep FEDRawDataCollection_rawDataCollector_*_*',
      'keep FEDRawDataCollection_source_*_*',
...
process.hltOutputPhysicsZeroBias5 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_ZeroBias_part8_v2',
  'HLT_ZeroBias_part9_v2' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep FEDRawDataCollection_rawDataCollector_*_*',
      'keep FEDRawDataCollection_source_*_*',
...
process.HLT_Ele20_WPTight_Gsf_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEGLowETor + process.hltPreEle20WPTightGsf + process.HLTEle20WPTightGsfSequence + process.HLTEndSequence )
process.HLT_Ele20_WPLoose_Gsf_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEGLowETor + process.hltPreEle20WPLooseGsf + process.HLTEle20WPLooseGsfSequence + process.HLTEndSequence )
process.HLT_Ele20_eta2p1_WPLoose_Gsf_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEGLowETor + process.hltPreEle20eta2p1WPLooseGsf + process.HLTEle20Eta2p1WPLooseGsfSequence + process.HLTEndSequence )
...
process.HLT_DiPFJet15_NoCaloMatched_v10 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet12BptxAND + process.hltPreDiPFJet15NoCaloMatched + process.HLTAK4PFJetsSequence + process.hltDoublePFJet15 + process.HLTEndSequence )
process.HLT_DiPFJet25_NoCaloMatched_v10 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet12BptxAND + process.hltPreDiPFJet25NoCaloMatched + process.HLTAK4PFJetsSequence + process.hltDoublePFJet25 + process.HLTEndSequence )
...
process.HLT_DiPFJetAve15_HFJEC_v11 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreDiPFJetAve15HFJEC + process.HLTAK4PFJetsSequence + process.hltDiPFJetAve15ForHFJEC + process.HLTEndSequence )
process.HLT_DiPFJetAve25_HFJEC_v11 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreDiPFJetAve25HFJEC + process.HLTAK4PFJetsSequence + process.hltDiPFJetAve25ForHFJEC + process.HLTEndSequence )
...
process.HLT_FullTrack_Multiplicity85_part0_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60to80BptxAND + process.hltPreFullTrackMultiplicity85part0 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult85 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity85_part1_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60to80BptxAND + process.hltPreFullTrackMultiplicity85part1 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult85 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity85_part2_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60to80BptxAND + process.hltPreFullTrackMultiplicity85part2 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult85 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity85_part3_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60to80BptxAND + process.hltPreFullTrackMultiplicity85part3 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult85 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity85_part4_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60to80BptxAND + process.hltPreFullTrackMultiplicity85part4 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult85 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity100_part0_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity100part0 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult100 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity100_part1_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity100part1 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult100 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity100_part2_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity100part2 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult100 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity100_part3_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity100part3 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult100 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity100_part4_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity100part4 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult100 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity130_part0_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity130part0 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult130 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity130_part1_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity130part1 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult130 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity130_part2_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity130part2 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult130 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity130_part3_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity130part3 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult130 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity130_part4_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity130part4 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult130 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity155_part0_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity155part0 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult155 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity155_part1_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity155part1 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult155 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity155_part2_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity155part2 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult155 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity155_part3_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity155part3 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult155 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity155_part4_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity155part4 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult155 + process.HLTEndSequence )
...
process.HLT_AK4CaloJet30_v8 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreAK4CaloJet30 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet30 + process.HLTEndSequence )
process.HLT_AK4CaloJet40_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreAK4CaloJet40 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet40 + process.HLTEndSequence )
process.HLT_AK4CaloJet50_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreAK4CaloJet50 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet50 + process.HLTEndSequence )
...
process.HLT_AK4PFJet30_v12 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreAK4PFJet30 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet15 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedMatchedToCaloJets15 + process.hltSingleAK4PFJet30 + process.HLTEndSequence )
process.HLT_AK4PFJet50_v12 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreAK4PFJet50 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet30 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedMatchedToCaloJets30 + process.hltSingleAK4PFJet50 + process.HLTEndSequence )
...
process.HLT_HISinglePhoton10_Eta3p1ForPPRef_v6 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreHISinglePhoton10Eta3p1ForPPRef + process.HLTDoCaloSequence + process.HLTDoHIEcalClusWithCleaningSequence + process.hltHIPhoton10Eta3p1 + process.HLTEndSequence )
