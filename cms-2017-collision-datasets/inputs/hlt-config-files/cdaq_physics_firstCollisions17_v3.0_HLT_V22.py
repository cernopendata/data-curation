# /cdaq/physics/firstCollisions17/v3.0/HLT/V22 (CMSSW_9_0_0)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions17/v3.0/HLT/V22')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_Random_v1" ),
        prescales = cms.vuint32( 4000, 4000, 4000, 4000, 4000, 60, 4000, 4000, 4000, 4000, 4000, 4000, 4000 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_Random_v1" ),
        prescales = cms.vuint32( 0, 50, 50, 50, 50, 1, 50, 50, 50, 50, 50, 50, 50 )
      ),
