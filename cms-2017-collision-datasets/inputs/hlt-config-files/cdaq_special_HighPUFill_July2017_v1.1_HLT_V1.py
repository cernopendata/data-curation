# /cdaq/special/HighPUFill/July2017/v1.1/HLT/V1 (CMSSW_9_2_2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/HighPUFill/July2017/v1.1/HLT/V1')
)
...
process.streams = cms.PSet( 
  ...
  ParkingHLTPhysics1 = cms.vstring( 'ParkingHLTPhysics1',
    'ParkingHLTPhysics2' ),
  ParkingHLTPhysics2 = cms.vstring( 'ParkingHLTPhysics3',
    'ParkingHLTPhysics4' ),
  ParkingHLTPhysics3 = cms.vstring( 'ParkingHLTPhysics5',
    'ParkingHLTPhysics6' ),
  ParkingHLTPhysics4 = cms.vstring( 'ParkingHLTPhysics7',
    'ParkingHLTPhysics8' ),
  PhysicsCommissioning = cms.vstring( 'HLTPhysics',
    'HcalNZS',
    'IsolatedBunch',
    'ZeroBias' ),
  PhysicsZeroBias1 = cms.vstring( 'ParkingZeroBias1',
    'ParkingZeroBias2' ),
  PhysicsZeroBias2 = cms.vstring( 'ParkingZeroBias3',
    'ParkingZeroBias4' ),
  RPCMON = cms.vstring( 'RPCMonitor' )
)
process.datasets = cms.PSet( 
  AlCaLumiPixels = cms.vstring( 'AlCa_LumiPixels_Random_v3',
  ...
  ExpressPhysics = cms.vstring( 'HLT_Physics_v6',
    'HLT_Random_v2',
  ...
  HcalNZS = cms.vstring( 'HLT_HcalNZS_v11',
    'HLT_HcalPhiSym_v12' ),
  IsolatedBunch = cms.vstring( 'HLT_HcalIsolatedbunch_v3' ),
  L1Accept = cms.vstring( 'DST_ZeroBias_v1' ),
  OnlineMonitor = cms.vstring( 'HLT_HcalNZS_v11',
    'HLT_HcalPhiSym_v12',
    'HLT_L1FatEvents_v1',
    'HLT_Physics_v6',
    'HLT_Random_v2',
    ...
    'HLT_ZeroBias_v5' ),
  ParkingHLTPhysics1 = cms.vstring( 'HLT_Physics_part0_v6' ),
  ParkingHLTPhysics2 = cms.vstring( 'HLT_Physics_part1_v6' ),
  ParkingHLTPhysics3 = cms.vstring( 'HLT_Physics_part2_v6' ),
  ParkingHLTPhysics4 = cms.vstring( 'HLT_Physics_part3_v6' ),
  ParkingHLTPhysics5 = cms.vstring( 'HLT_Physics_part4_v6' ),
  ParkingHLTPhysics6 = cms.vstring( 'HLT_Physics_part5_v6' ),
  ParkingHLTPhysics7 = cms.vstring( 'HLT_Physics_part6_v6' ),
  ParkingHLTPhysics8 = cms.vstring( 'HLT_Physics_part7_v6' ),
  ParkingZeroBias1 = cms.vstring( 'HLT_ZeroBias_part0_v2' ),
  ParkingZeroBias2 = cms.vstring( 'HLT_ZeroBias_part1_v2' ),
  ParkingZeroBias3 = cms.vstring( 'HLT_ZeroBias_part2_v2' ),
  ParkingZeroBias4 = cms.vstring( 'HLT_ZeroBias_part3_v2' ),
  RPCMonitor = cms.vstring( 'AlCa_RPCMuonNormalisation_v12' ),
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_Physics_v6" ),
        prescales = cms.vuint32( 25, 1, 2, 5, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_part0_v6" ),
        prescales = cms.vuint32( 0, 8, 16, 40, 80 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_part1_v6" ),
        prescales = cms.vuint32( 0, 8, 16, 40, 80 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_part2_v6" ),
        prescales = cms.vuint32( 0, 8, 16, 40, 80 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_part3_v6" ),
        prescales = cms.vuint32( 0, 8, 16, 40, 80 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_part4_v6" ),
        prescales = cms.vuint32( 0, 8, 16, 40, 80 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_part5_v6" ),
        prescales = cms.vuint32( 0, 8, 16, 40, 80 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_part6_v6" ),
        prescales = cms.vuint32( 0, 8, 16, 40, 80 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_part7_v6" ),
        prescales = cms.vuint32( 0, 8, 16, 40, 80 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Random_v2" ),
        prescales = cms.vuint32( 2000, 2000, 2000, 2000, 2000 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_v5" ),
        prescales = cms.vuint32( 200, 200, 200, 200, 200 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1FatEvents_v1" ),
        prescales = cms.vuint32( 25, 1, 2, 5, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HcalIsolatedbunch_v3" ),
        prescales = cms.vuint32( 16, 16, 16, 16, 16 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_IsolatedBunches_v4" ),
        prescales = cms.vuint32( 800, 800, 800, 800, 800 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_Random_v3" ),
        prescales = cms.vuint32( 50, 50, 50, 50, 50 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_v7" ),
        prescales = cms.vuint32( 5, 5, 5, 5, 5 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_EcalPi0EBonly_v9" ),
        prescales = cms.vuint32( 2, 2, 2, 2, 2 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_part0_v2" ),
        prescales = cms.vuint32( 0, 32, 32, 32, 32 )
      ),
    ...
    lvl1DefaultLabel = cms.string( "HLT_Physics 1" ),
...
process.hltL1IsolatedBunchVETO = cms.EDFilter( "TriggerResultsFilter",
    hltResults = cms.InputTag( "" ),
    l1tResults = cms.InputTag( "hltGtStage2Digis" ),
    triggerConditions = cms.vstring( 'L1_IsolatedBunch' ),
    l1tIgnoreMaskAndPrescale = cms.bool( True ),
    throw = cms.bool( True )
)
process.hltL1sL1ZeroBiascopyVETO = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "NOT L1_ZeroBias_copy" ),
...
process.hltL1sL1ZeroBiascopy = cms.EDFilter( "HLTL1TSeed",
...
process.hltL1sHcalNZS = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_ZeroBias_copy OR L1_IsolatedBunch OR L1_SingleEG5 OR L1_SingleEG24 OR L1_SingleJet35 OR L1_SingleJet60 OR L1_SingleMuOpen OR L1_ZeroBias" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltL1sSingleEG5IorSingleMuOpenIorDoubleMuIorZeroBias = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_ZeroBias_copy OR L1_IsolatedBunch OR L1_SingleEG5 OR L1_SingleEG10 OR L1_SingleEG15 OR L1_SingleEG18 OR L1_SingleEG24 OR L1_SingleEG26 OR L1_SingleEG28 OR L1_SingleEG30 OR L1_SingleEG32 OR L1_SingleEG34 OR L1_SingleEG36 OR L1_SingleEG38 OR L1_SingleEG40 OR L1_SingleEG45 OR L1_SingleMuOpen OR L1_SingleMu3 OR L1_SingleMu5 OR L1_SingleMu7 OR L1_SingleMu16 OR L1_SingleMu18 OR L1_SingleMu20 OR L1_SingleMu22 OR L1_SingleMu25 OR L1_SingleMu30 OR L1_DoubleMu_12_5 OR L1_DoubleMu_12_8 OR L1_DoubleMu_13_6 OR L1_DoubleMu_15_5" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltL1sL1ZeroBiasFirstCollisionInOrbitVETO = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "NOT L1_FirstCollisionInOrbit" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltL1sZeroBiascopyIorIorIsolatedBunch = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_ZeroBias_copy OR L1_IsolatedBunch" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
...
process.hltPreParkingHLTPhysics1Output = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreParkingHLTPhysics2Output = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreParkingHLTPhysics3Output = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreParkingHLTPhysics4Output = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreDQMOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring( 'HLT_Physics_v6',
      'HLT_Random_v2 / 3',
      'HLT_ZeroBias_v5 / 3',
      'HLT_HcalNZS_v11 / 3',
      'HLT_HcalPhiSym_v12 / 3',
      'HLT_ZeroBias_FirstCollisionAfterAbortGap_v4 / 3',
      'HLT_ZeroBias_IsolatedBunches_v4 / 3',
      'HLT_ZeroBias_FirstCollisionInTrain_v2 / 3',
      'HLT_ZeroBias_LastCollisionInTrain_v2 / 3',
      'HLT_ZeroBias_FirstBXAfterTrain_v2 / 3',
      'HLT_L1FatEvents_v1' ),
...
process.hltOutputParkingHLTPhysics1 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_Physics_part0_v6',
  'HLT_Physics_part1_v6' ) ),
...
process.hltOutputParkingHLTPhysics2 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_Physics_part2_v6',
  'HLT_Physics_part3_v6' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep FEDRawDataCollection_rawDataCollector_*_*',
      'keep FEDRawDataCollection_source_*_*',
      'keep GlobalObjectMapRecord_hltGtStage2ObjectMap_*_*',
...
process.hltOutputParkingHLTPhysics3 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_Physics_part4_v6',
  'HLT_Physics_part5_v6' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep FEDRawDataCollection_rawDataCollector_*_*',
      'keep FEDRawDataCollection_source_*_*',
      'keep GlobalObjectMapRecord_hltGtStage2ObjectMap_*_*',
...
process.hltOutputParkingHLTPhysics4 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_Physics_part6_v6',
  'HLT_Physics_part7_v6' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep FEDRawDataCollection_rawDataCollector_*_*',
      'keep FEDRawDataCollection_source_*_*',
      'keep GlobalObjectMapRecord_hltGtStage2ObjectMap_*_*',
...
process.hltOutputPhysicsCommissioning = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_HcalIsolatedbunch_v3',
  'HLT_HcalNZS_v11',
  'HLT_HcalPhiSym_v12',
  'HLT_Physics_v6',
  'HLT_Random_v2',
...
process.hltOutputDQM = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_HcalNZS_v11',
  'HLT_HcalPhiSym_v12',
  'HLT_L1FatEvents_v1',
  'HLT_Physics_v6',
  'HLT_Random_v2',
...
process.hltOutputRPCMON = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'AlCa_RPCMuonNormalisation_v12' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
...
process.hltOutputALCALUMIPIXELS = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'AlCa_LumiPixels_Random_v3',
  'AlCa_LumiPixels_ZeroBias_v7' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
...
process.hltOutputALCAP0 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'AlCa_EcalEtaEBonly_v9',
  'AlCa_EcalEtaEEonly_v9',
  'AlCa_EcalPi0EBonly_v9',
  'AlCa_EcalPi0EEonly_v9' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
...
process.hltOutputExpress = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_Physics_v6',
  'HLT_Random_v2',
  'HLT_ZeroBias_FirstCollisionAfterAbortGap_v4',
  'HLT_ZeroBias_IsolatedBunches_v4',
  'HLT_ZeroBias_v5' ) ),
...
process.hltOutputNanoDST = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'DST_ZeroBias_v1' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
...
process.HLT_Physics_v6 = cms.Path( process.HLTBeginSequenceL1Fat + ~process.hltL1IsolatedBunchVETO + process.hltL1sL1ZeroBiascopyVETO + process.hltPrePhysics + process.HLTEndSequence )
process.HLT_Physics_part0_v6 = cms.Path( process.HLTBeginSequence + ~process.hltL1IsolatedBunchVETO + process.hltL1sL1ZeroBiascopyVETO + process.hltPrePhysicspart0 + process.HLTEndSequence )
process.HLT_Physics_part1_v6 = cms.Path( process.HLTBeginSequence + ~process.hltL1IsolatedBunchVETO + process.hltL1sL1ZeroBiascopyVETO + process.hltPrePhysicspart1 + process.HLTEndSequence )
process.HLT_Physics_part2_v6 = cms.Path( process.HLTBeginSequence + ~process.hltL1IsolatedBunchVETO + process.hltL1sL1ZeroBiascopyVETO + process.hltPrePhysicspart2 + process.HLTEndSequence )
process.HLT_Physics_part3_v6 = cms.Path( process.HLTBeginSequence + ~process.hltL1IsolatedBunchVETO + process.hltL1sL1ZeroBiascopyVETO + process.hltPrePhysicspart3 + process.HLTEndSequence )
process.HLT_Physics_part4_v6 = cms.Path( process.HLTBeginSequence + ~process.hltL1IsolatedBunchVETO + process.hltL1sL1ZeroBiascopyVETO + process.hltPrePhysicspart4 + process.HLTEndSequence )
process.HLT_Physics_part5_v6 = cms.Path( process.HLTBeginSequence + ~process.hltL1IsolatedBunchVETO + process.hltL1sL1ZeroBiascopyVETO + process.hltPrePhysicspart5 + process.HLTEndSequence )
process.HLT_Physics_part6_v6 = cms.Path( process.HLTBeginSequence + ~process.hltL1IsolatedBunchVETO + process.hltL1sL1ZeroBiascopyVETO + process.hltPrePhysicspart6 + process.HLTEndSequence )
process.HLT_Physics_part7_v6 = cms.Path( process.HLTBeginSequence + ~process.hltL1IsolatedBunchVETO + process.hltL1sL1ZeroBiascopyVETO + process.hltPrePhysicspart7 + process.HLTEndSequence )
process.HLT_Random_v2 = cms.Path( process.HLTBeginSequenceRandom + process.hltPreRandom + process.HLTEndSequence )
process.HLT_ZeroBias_v5 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBiascopy + process.hltPreZeroBias + process.HLTEndSequence )
process.DST_ZeroBias_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBiascopy + process.hltPreDSTZeroBias + process.HLTEndSequence )
...
process.HLT_L1FatEvents_v1 = cms.Path( process.HLTBeginSequenceL1Fat + ~process.hltL1IsolatedBunchVETO + process.hltL1sL1ZeroBiascopyVETO + process.hltPreL1FatEvents + process.HLTEndSequence )
process.HLT_HcalNZS_v11 = cms.Path( process.HLTBeginSequenceNZS + process.hltL1sHcalNZS + process.hltPreHcalNZS + process.HLTEndSequence )
process.HLT_HcalPhiSym_v12 = cms.Path( process.HLTBeginSequenceNZS + process.hltL1sSingleEG5IorSingleMuOpenIorDoubleMuIorZeroBias + process.hltPreHcalPhiSym + process.HLTEndSequence )
process.HLT_HcalIsolatedbunch_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sIsolatedBunch + process.hltL1sSingleJetOR + process.hltPreHcalIsolatedbunch + process.HLTEndSequence )
process.HLT_ZeroBias_FirstCollisionAfterAbortGap_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBiasFirstCollisionAfterAbortGap + process.hltPreZeroBiasFirstCollisionAfterAbortGap + process.HLTEndSequence )
process.HLT_ZeroBias_IsolatedBunches_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sIsolatedBunch + process.hltPreZeroBiasIsolatedBunches + process.HLTEndSequence )
process.HLT_ZeroBias_FirstCollisionInTrain_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBiasFirstCollisionInTrain + process.hltL1sL1ZeroBiasFirstCollisionInOrbitVETO + process.hltPreZeroBiasFirstCollisionInTrain + process.HLTEndSequence )
process.HLT_ZeroBias_LastCollisionInTrain_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBiasLastBunchInTrain + process.hltPreZeroBiasLastCollisionInTrain + process.HLTEndSequence )
process.HLT_ZeroBias_FirstBXAfterTrain_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBiasFirstBunchAfterTrain + process.hltPreZeroBiasFirstBXAfterTrain + process.HLTEndSequence )
process.AlCa_EcalPhiSym_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBiascopyIorIorIsolatedBunch + process.hltPreAlCaEcalPhiSym + process.HLTDoFullUnpackingEgammaEcalSequence + process.hltEcalPhiSymFilter + process.HLTEndSequence )
process.AlCa_RPCMuonNormalisation_v12 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleMu5IorSingleMu14erIorSingleMu16er + process.hltPreAlCaRPCMuonNormalisation + process.hltRPCMuonNormaL1Filtered0 + process.HLTMuonLocalRecoSequence + process.HLTEndSequence )
process.AlCa_LumiPixels_Random_v3 = cms.Path( process.HLTBeginSequenceRandom + process.hltPixelTrackerHVOn + process.hltPreAlCaLumiPixelsRandom + process.hltFEDSelectorLumiPixels + process.HLTEndSequence )
process.AlCa_LumiPixels_ZeroBias_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBiascopy + process.hltPixelTrackerHVOn + process.hltPreAlCaLumiPixelsZeroBias + process.hltFEDSelectorLumiPixels + process.HLTEndSequence )
process.AlCa_EcalPi0EBonly_v9 = cms.Path( process.HLTBeginSequence + process.hltL1sAlCaEcalPi0Eta + process.hltPreAlCaEcalPi0EBonly + process.HLTDoFullUnpackingEgammaEcalSequence + process.hltSimple3x3Clusters + process.hltAlCaPi0RecHitsFilterEBonlyRegional + process.hltAlCaPi0EBUncalibrator + process.hltAlCaPi0EBRechitsToDigis + process.HLTEndSequence )
process.AlCa_EcalPi0EEonly_v9 = cms.Path( process.HLTBeginSequence + process.hltL1sAlCaEcalPi0Eta + process.hltPreAlCaEcalPi0EEonly + process.HLTDoFullUnpackingEgammaEcalSequence + process.hltSimple3x3Clusters + process.hltAlCaPi0RecHitsFilterEEonlyRegional + process.hltAlCaPi0EEUncalibrator + process.hltAlCaPi0EERechitsToDigis + process.HLTEndSequence )
process.AlCa_EcalEtaEBonly_v9 = cms.Path( process.HLTBeginSequence + process.hltL1sAlCaEcalPi0Eta + process.hltPreAlCaEcalEtaEBonly + process.HLTDoFullUnpackingEgammaEcalSequence + process.hltSimple3x3Clusters + process.hltAlCaEtaRecHitsFilterEBonlyRegional + process.hltAlCaEtaEBUncalibrator + process.hltAlCaEtaEBRechitsToDigis + process.HLTEndSequence )
process.AlCa_EcalEtaEEonly_v9 = cms.Path( process.HLTBeginSequence + process.hltL1sAlCaEcalPi0Eta + process.hltPreAlCaEcalEtaEEonly + process.HLTDoFullUnpackingEgammaEcalSequence + process.hltSimple3x3Clusters + process.hltAlCaEtaRecHitsFilterEEonlyRegional + process.hltAlCaEtaEEUncalibrator + process.hltAlCaEtaEERechitsToDigis + process.HLTEndSequence )
process.HLT_ZeroBias_part0_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBiascopy + process.hltPreZeroBiaspart0 + process.HLTEndSequence )
process.HLT_ZeroBias_part1_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBiascopy + process.hltPreZeroBiaspart1 + process.HLTEndSequence )
process.HLT_ZeroBias_part2_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBiascopy + process.hltPreZeroBiaspart2 + process.HLTEndSequence )
process.HLT_ZeroBias_part3_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBiascopy + process.hltPreZeroBiaspart3 + process.HLTEndSequence )
...
process.ParkingHLTPhysics1Output = cms.EndPath( process.hltGtStage2Digis + process.hltPreParkingHLTPhysics1Output + process.hltOutputParkingHLTPhysics1 )
process.ParkingHLTPhysics2Output = cms.EndPath( process.hltGtStage2Digis + process.hltPreParkingHLTPhysics2Output + process.hltOutputParkingHLTPhysics2 )
process.ParkingHLTPhysics3Output = cms.EndPath( process.hltGtStage2Digis + process.hltPreParkingHLTPhysics3Output + process.hltOutputParkingHLTPhysics3 )
process.ParkingHLTPhysics4Output = cms.EndPath( process.hltGtStage2Digis + process.hltPreParkingHLTPhysics4Output + process.hltOutputParkingHLTPhysics4 )
...
process.ALCAELECTRONOutput = cms.EndPath( process.hltGtStage2Digis + process.hltPreALCAELECTRONOutput + process.hltPreALCAELECTRONOutputSmart + process.hltSelectedElectronFEDListProducerGsf )
...
process.ScoutingCaloOutput = cms.EndPath( process.hltGtStage2Digis + process.hltPreScoutingCaloOutput + process.hltPreScoutingCaloOutputSmart + process.hltFEDSelectorL1 + process.hltScoutingCaloPacker )
process.ScoutingPFOutput = cms.EndPath( process.hltGtStage2Digis + process.hltPreScoutingPFOutput + process.hltPreScoutingPFOutputSmart + process.hltFEDSelectorL1 + process.HLTPFScoutingPackingSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_Physics_v6, process.HLT_Physics_part0_v6, process.HLT_Physics_part1_v6, process.HLT_Physics_part2_v6, process.HLT_Physics_part3_v6, process.HLT_Physics_part4_v6, process.HLT_Physics_part5_v6, process.HLT_Physics_part6_v6, process.HLT_Physics_part7_v6, process.HLT_Random_v2, process.HLT_ZeroBias_v5, process.DST_ZeroBias_v1, process.HLT_EcalCalibration_v3, process.HLT_HcalCalibration_v4, process.HLT_L1FatEvents_v1, process.HLT_HcalNZS_v11, process.HLT_HcalPhiSym_v12, process.HLT_HcalIsolatedbunch_v3, process.HLT_ZeroBias_FirstCollisionAfterAbortGap_v4, process.HLT_ZeroBias_IsolatedBunches_v4, process.HLT_ZeroBias_FirstCollisionInTrain_v2, process.HLT_ZeroBias_LastCollisionInTrain_v2, process.HLT_ZeroBias_FirstBXAfterTrain_v2, process.AlCa_EcalPhiSym_v7, process.AlCa_RPCMuonNormalisation_v12, process.AlCa_LumiPixels_Random_v3, process.AlCa_LumiPixels_ZeroBias_v7, process.AlCa_EcalPi0EBonly_v9, process.AlCa_EcalPi0EEonly_v9, process.AlCa_EcalEtaEBonly_v9, process.AlCa_EcalEtaEEonly_v9, process.HLT_ZeroBias_part0_v2, process.HLT_ZeroBias_part1_v2, process.HLT_ZeroBias_part2_v2, process.HLT_ZeroBias_part3_v2, process.HLTriggerFinalPath, process.RatesMonitoring, process.DQMHistograms, process.ParkingHLTPhysicsOutput, process.ParkingHLTPhysics1Output, process.ParkingHLTPhysics2Output, process.ParkingHLTPhysics3Output, process.ParkingHLTPhysics4Output, process.ParkingZeroBiasOutput, process.PhysicsCommissioningOutput, process.PhysicsMinimumBias0Output, process.PhysicsMinimumBias1Output, process.PhysicsMinimumBias2Output, process.ParkingOutput, process.DQMOutput, process.DQMCalibrationOutput, process.RPCMONOutput, process.CalibrationOutput, process.EcalCalibrationOutput, process.ALCAPHISYMOutput, process.ALCALUMIPIXELSOutput, process.ALCAP0Output, process.ALCAELECTRONOutput, process.ExpressOutput, process.NanoDSTOutput, process.PhysicsParkingScoutingMonitorOutput, process.ScoutingCaloOutput, process.ScoutingPFOutput, process.PhysicsZeroBias1Output, process.PhysicsZeroBias2Output ))
