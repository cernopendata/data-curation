# /cdaq/physics/firstCollisions17/v3.0/HLT/V19 (CMSSW_9_0_0)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions17/v3.0/HLT/V19')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_L1SingleMu7_v1" ),
        prescales = cms.vuint32( 0, 45, 45, 45, 45, 35, 45, 45, 45, 45, 45, 45, 45 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleMu20_v1" ),
        prescales = cms.vuint32( 0, 8, 8, 8, 8, 4, 8, 8, 8, 8, 8, 8, 8 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG5_v1" ),
        prescales = cms.vuint32( 0, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG10_v1" ),
        prescales = cms.vuint32( 0, 35, 35, 35, 35, 25, 35, 35, 35, 35, 35, 35, 35 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG18_v1" ),
        prescales = cms.vuint32( 0, 35, 35, 35, 35, 25, 35, 35, 35, 35, 35, 35, 35 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleJet35_v1" ),
        prescales = cms.vuint32( 0, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 2 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_L1DoubleIsoTau32er_v1" ),
        prescales = cms.vuint32( 0, 4, 4, 4, 4, 2, 4, 4, 4, 4, 4, 4, 4 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1DoubleJetC50_v1" ),
        prescales = cms.vuint32( 0, 28, 28, 28, 28, 20, 28, 28, 28, 28, 28, 28, 28 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1FatEvents_v1" ),
        prescales = cms.vuint32( 0, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 20 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_v2" ),
        prescales = cms.vuint32( 0, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 1000 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Random_v1" ),
        prescales = cms.vuint32( 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_v2" ),
        prescales = cms.vuint32( 330, 330, 330, 330, 330, 330, 330, 330, 330, 330, 330, 220, 110 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_FirstCollisionAfterAbortGap_v3" ),
        prescales = cms.vuint32( 0, 1100, 1100, 1100, 1100, 6, 1100, 1100, 1100, 1100, 1100, 1100, 1100 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_IsolatedBunches_v3" ),
        prescales = cms.vuint32( 0, 1100, 1100, 1100, 1100, 10, 1100, 1100, 1100, 1100, 1100, 1100, 1100 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_part0_v2" ),
        prescales = cms.vuint32( 0, 110, 110, 110, 110, 110, 110, 110, 110, 110, 110, 75, 40 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_Random_v1" ),
        prescales = cms.vuint32( 0, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_v2" ),
        prescales = cms.vuint32( 0, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 8, 4 )
      )
    ),
