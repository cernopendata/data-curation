# /cdaq/physics/firstCollisions17/v3.0/HLT/V4 (CMSSW_9_0_0)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions17/v3.0/HLT/V4')
)
...
process.datasets = cms.PSet( 
  ...
  MinimumBias = cms.vstring( 'HLT_L1DoubleIsoTau32er_v1',
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_FirstCollisionAfterAbortGap_v3" ),
        prescales = cms.vuint32( 0, 1100, 1100, 1100, 1100, 1100, 1100, 1100, 1100, 1100, 1100, 1100, 1100 )
      ),
