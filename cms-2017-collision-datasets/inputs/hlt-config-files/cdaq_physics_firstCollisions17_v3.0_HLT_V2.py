# /cdaq/physics/firstCollisions17/v3.0/HLT/V2 (CMSSW_9_0_0)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions17/v3.0/HLT/V2')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_L1FatEvents_v1" ),
        prescales = cms.vuint32( 0, 50, 50, 50, 20 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_v2" ),
        prescales = cms.vuint32( 0, 2000, 2000, 2000, 1000 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_Random_v1" ),
        prescales = cms.vuint32( 0, 50, 50, 50, 50 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_v2" ),
        prescales = cms.vuint32( 0, 12, 12, 8, 4 )
      )
    ),
    lvl1DefaultLabel = cms.string( "2b" ),
