# /cdaq/special/150INDIV/Oct2017v2/HLT/V1 (CMSSW_9_2_10)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/150INDIV/Oct2017v2/HLT/V1')
)
...
process.streams = cms.PSet( 
  ALCALUMIPIXELS1 = cms.vstring( 'AlCaLumiPixels0',
    'AlCaLumiPixels1' ),
  ALCALUMIPIXELS2 = cms.vstring( 'AlCaLumiPixels2',
    'AlCaLumiPixels3' ),
  ALCALUMIPIXELS3 = cms.vstring( 'AlCaLumiPixels4',
    'AlCaLumiPixels5' ),
  ALCALUMIPIXELS4 = cms.vstring( 'AlCaLumiPixels6',
    'AlCaLumiPixels7' ),
  ALCALUMIPIXELS5 = cms.vstring( 'AlCaLumiPixels8',
    'AlCaLumiPixels9' ),
  ALCALUMIPIXELS6 = cms.vstring( 'AlCaLumiPixels10',
    'AlCaLumiPixels11' ),
  ...
  Physics = cms.vstring( 'HcalNZS',
    'ZeroBias' ),
  PhysicsMuons = cms.vstring( 'SingleMuon' ),
  PhysicsZeroBias1 = cms.vstring( 'ZeroBias0',
    'ZeroBias1' ),
  PhysicsZeroBias2 = cms.vstring( 'ZeroBias2',
    'ZeroBias3' ),
  PhysicsZeroBias3 = cms.vstring( 'ZeroBias4',
    'ZeroBias5' ),
  PhysicsZeroBias4 = cms.vstring( 'ZeroBias6',
    'ZeroBias7' ),
  PhysicsZeroBias5 = cms.vstring( 'ZeroBias8',
    'ZeroBias9' ),
  RPCMON = cms.vstring( 'RPCMonitor' )
)
process.datasets = cms.PSet( 
  AlCaLumiPixels0 = cms.vstring( 'AlCa_LumiPixels_Random_v1',
    'AlCa_LumiPixels_ZeroBias_part0_v2' ),
  AlCaLumiPixels1 = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part1_v2' ),
  AlCaLumiPixels10 = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part10_v2' ),
  AlCaLumiPixels11 = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part11_v2' ),
  AlCaLumiPixels2 = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part2_v2' ),
  AlCaLumiPixels3 = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part3_v2' ),
  AlCaLumiPixels4 = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part4_v2' ),
  AlCaLumiPixels5 = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part5_v2' ),
  AlCaLumiPixels6 = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part6_v2' ),
  AlCaLumiPixels7 = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part7_v2' ),
  AlCaLumiPixels8 = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part8_v2' ),
  AlCaLumiPixels9 = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part9_v2' ),
  AlCaPhiSym = cms.vstring( 'AlCa_EcalPhiSym_v3' ),
  EcalLaser = cms.vstring( 'HLT_EcalCalibration_v2' ),
  ExpressPhysics = cms.vstring( 'HLT_Random_v1',
    'HLT_ZeroBias_FirstCollisionAfterAbortGap_v5',
    'HLT_ZeroBias_v2' ),
  HcalNZS = cms.vstring( 'HLT_HcalNZS_v2',
    'HLT_HcalPhiSym_v2' ),
  L1Accept = cms.vstring( 'DST_Physics_v1' ),
  OnlineMonitor = cms.vstring( 'AlCa_EcalPhiSym_v3',
    'HLT_HcalNZS_v2',
    'HLT_HcalPhiSym_v2',
    'HLT_L1SingleMu25_v1',
    'HLT_Random_v1',
  ...
  SingleMuon = cms.vstring( 'HLT_L1SingleMu25_v1' ),
  ...
  ZeroBias = cms.vstring( 'HLT_Random_v1',
    'HLT_ZeroBias_v2' ),
  ZeroBias0 = cms.vstring( 'HLT_ZeroBias_part0_v2' ),
  ...
  ZeroBias9 = cms.vstring( 'HLT_ZeroBias_part9_v2' )
)
...
process.GlobalTag = cms.ESSource( "PoolDBESSource",
    ...
    connect = cms.string( "frontier://(proxyurl=http://localhost:3128)(serverurl=http://localhost:8000/FrontierProd)(serverurl=http://localhost:8000/FrontierProd)(retrieve-ziplevel=0)/CMS_CONDITIONS" ),
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_Random_v1" ),
        prescales = cms.vuint32( 1000, 100, 200, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleMu25_v1" ),
        prescales = cms.vuint32( 1000, 2, 4, 1000 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_v2" ),
        prescales = cms.vuint32( 300, 40, 80, 5000 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_part0_v2" ),
        prescales = cms.vuint32( 0, 10, 20, 30 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_Random_v1" ),
        prescales = cms.vuint32( 0, 400, 800, 1 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_part0_v2" ),
        prescales = cms.vuint32( 0, 2400, 4800, 12 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_part1_v2" ),
        prescales = cms.vuint32( 0, 2400, 4800, 12 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_part2_v2" ),
        prescales = cms.vuint32( 0, 2400, 4800, 12 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_part3_v2" ),
        prescales = cms.vuint32( 0, 2400, 4800, 12 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_part4_v2" ),
        prescales = cms.vuint32( 0, 2400, 4800, 12 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_part5_v2" ),
        prescales = cms.vuint32( 0, 2400, 4800, 12 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_part6_v2" ),
        prescales = cms.vuint32( 0, 2400, 4800, 12 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_part7_v2" ),
        prescales = cms.vuint32( 0, 2400, 4800, 12 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_part8_v2" ),
        prescales = cms.vuint32( 0, 2400, 4800, 12 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_part9_v2" ),
        prescales = cms.vuint32( 0, 2400, 4800, 12 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_part10_v2" ),
        prescales = cms.vuint32( 0, 2400, 4800, 12 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_part11_v2" ),
        prescales = cms.vuint32( 0, 2400, 4800, 12 )
      ),
      cms.PSet(  pathName = cms.string( "DQMCalibrationOutput" ),
        prescales = cms.vuint32( 1, 10, 10, 10 )
      )
    ),
    lvl1DefaultLabel = cms.string( "Emergency" ),
    lvl1Labels = cms.vstring( 'Emergency',
      '150Indiv',
      '150Indiv_halfHLTrate',
      'MuScan' )
)
...
process.hltL1sL1ZeroBiasCopyORAlwaysTrue = cms.EDFilter( "HLTL1TSeed",
...
process.hltPreAlCaLumiPixelsZeroBiaspart0 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreAlCaLumiPixelsZeroBiaspart1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 1 )
)
process.hltPreAlCaLumiPixelsZeroBiaspart2 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 2 )
)
process.hltPreAlCaLumiPixelsZeroBiaspart3 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 3 )
)
process.hltPreAlCaLumiPixelsZeroBiaspart4 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 4 )
)
process.hltPreAlCaLumiPixelsZeroBiaspart5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 5 )
)
process.hltPreAlCaLumiPixelsZeroBiaspart6 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 6 )
)
process.hltPreAlCaLumiPixelsZeroBiaspart7 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 7 )
)
process.hltPreAlCaLumiPixelsZeroBiaspart8 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 8 )
)
process.hltPreAlCaLumiPixelsZeroBiasPart9 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 9 )
)
process.hltPreAlCaLumiPixelsZeroBiaspart10 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 10 )
)
process.hltPreAlCaLumiPixelsZeroBiaspart11 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
...
process.hltPreZeroBias1Output = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreZeroBias2Output = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreZeroBias3Output = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreZeroBias4Output = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreZeroBias5Output = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreDQMOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring( 'HLT_Random_v1 / 10',
      'HLT_L1SingleMu25_v1 / 10',
      'HLT_ZeroBias_v2 / 10',
      'HLT_HcalNZS_v2 / 10',
      'HLT_HcalPhiSym_v2 / 10',
      'AlCa_EcalPhiSym_v3 / 1000' ),
...
process.hltPreALCALUMIPIXELSOutput2 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreALCALUMIPIXELSOutput3 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreALCALUMIPIXELSOutput4 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreALCALUMIPIXELSOutput5 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreALCALUMIPIXELSOutput6 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltOutputALCALUMIPIXELS1 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'AlCa_LumiPixels_Random_v1',
  'AlCa_LumiPixels_ZeroBias_part0_v2',
  'AlCa_LumiPixels_ZeroBias_part1_v2' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep *_hltFEDSelectorLumiPixels_*_*',
      'keep *_hltGtStage2Digis_*_*',
      'keep edmTriggerResults_*_*_*' )
)
process.hltOutputALCALUMIPIXELS2 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part2_v2',
  'AlCa_LumiPixels_ZeroBias_part3_v2' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep *_hltFEDSelectorLumiPixels_*_*',
      'keep *_hltGtStage2Digis_*_*',
      'keep edmTriggerResults_*_*_*' )
)
process.hltOutputALCALUMIPIXELS3 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part4_v2',
  'AlCa_LumiPixels_ZeroBias_part5_v2' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep *_hltFEDSelectorLumiPixels_*_*',
      'keep *_hltGtStage2Digis_*_*',
      'keep edmTriggerResults_*_*_*' )
)
process.hltOutputALCALUMIPIXELS4 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part6_v2',
  'AlCa_LumiPixels_ZeroBias_part7_v2' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep *_hltFEDSelectorLumiPixels_*_*',
      'keep *_hltGtStage2Digis_*_*',
      'keep edmTriggerResults_*_*_*' )
)
process.hltOutputALCALUMIPIXELS5 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part8_v2',
  'AlCa_LumiPixels_ZeroBias_part9_v2' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep *_hltFEDSelectorLumiPixels_*_*',
      'keep *_hltGtStage2Digis_*_*',
      'keep edmTriggerResults_*_*_*' )
)
process.hltOutputALCALUMIPIXELS6 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'AlCa_LumiPixels_ZeroBias_part10_v2',
  'AlCa_LumiPixels_ZeroBias_part11_v2' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep *_hltFEDSelectorLumiPixels_*_*',
      'keep *_hltGtStage2Digis_*_*',
      'keep edmTriggerResults_*_*_*' )
...
process.hltOutputPhysicsMuons = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_L1SingleMu25_v1' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep FEDRawDataCollection_rawDataCollector_*_*',
      'keep FEDRawDataCollection_source_*_*',
      'keep GlobalObjectMapRecord_hltGtStage2ObjectMap_*_*',
...
process.HLT_L1SingleMu25_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleMu25 + process.hltPreL1SingleMu25 + process.hltL1fL1sMu5L1Filtered0 + process.HLTEndSequence )
...
process.HLT_HcalPhiSym_v2 = cms.Path( process.HLTBeginSequenceNZS + process.hltL1sSingleEG5IorSingleEG24IorSingleMuOpen + process.hltPreHcalPhiSym + process.HLTEndSequence )
process.AlCa_EcalPhiSym_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBiasCopyORAlwaysTrue + process.hltPreAlCaEcalPhiSym + process.HLTDoFullUnpackingEgammaEcalSequence + process.hltEcalPhiSymFilter + process.HLTEndSequence )
process.AlCa_RPCMuonNoTriggers_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleMu5IorSingleMu14erIorSingleMu16erIorSingleMu18erIorSingleMu20er + process.hltPreAlCaRPCMuonNoTriggers + process.hltRPCMuonNoTriggersL1Filtered0 + process.HLTMuonLocalRecoSequence + process.HLTEndSequence )
process.AlCa_RPCMuonNoHits_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleMu5IorSingleMu14erIorSingleMu16erIorSingleMu18erIorSingleMu20er + process.hltPreAlCaRPCMuonNoHits + process.HLTMuonLocalRecoSequence + process.hltRPCPointProducer + process.hltRPCFilter + process.HLTEndSequence )
process.AlCa_RPCMuonNormalisation_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleMu5IorSingleMu14erIorSingleMu16erIorSingleMu18erIorSingleMu20er + process.hltPreAlCaRPCMuonNormalisation + process.hltRPCMuonNormaL1Filtered0 + process.HLTMuonLocalRecoSequence + process.HLTEndSequence )
...
process.AlCa_LumiPixels_ZeroBias_part0_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAlCaLumiPixelsZeroBiaspart0 + process.hltFEDSelectorLumiPixels + process.HLTEndSequence )
process.AlCa_LumiPixels_ZeroBias_part1_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAlCaLumiPixelsZeroBiaspart1 + process.hltFEDSelectorLumiPixels + process.HLTEndSequence )
process.AlCa_LumiPixels_ZeroBias_part2_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAlCaLumiPixelsZeroBiaspart2 + process.hltFEDSelectorLumiPixels + process.HLTEndSequence )
process.AlCa_LumiPixels_ZeroBias_part3_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAlCaLumiPixelsZeroBiaspart3 + process.hltFEDSelectorLumiPixels + process.HLTEndSequence )
process.AlCa_LumiPixels_ZeroBias_part4_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAlCaLumiPixelsZeroBiaspart4 + process.hltFEDSelectorLumiPixels + process.HLTEndSequence )
process.AlCa_LumiPixels_ZeroBias_part5_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAlCaLumiPixelsZeroBiaspart5 + process.hltFEDSelectorLumiPixels + process.HLTEndSequence )
process.AlCa_LumiPixels_ZeroBias_part6_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAlCaLumiPixelsZeroBiaspart6 + process.hltFEDSelectorLumiPixels + process.HLTEndSequence )
process.AlCa_LumiPixels_ZeroBias_part7_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAlCaLumiPixelsZeroBiaspart7 + process.hltFEDSelectorLumiPixels + process.HLTEndSequence )
process.AlCa_LumiPixels_ZeroBias_part8_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAlCaLumiPixelsZeroBiaspart8 + process.hltFEDSelectorLumiPixels + process.HLTEndSequence )
process.AlCa_LumiPixels_ZeroBias_part9_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAlCaLumiPixelsZeroBiasPart9 + process.hltFEDSelectorLumiPixels + process.HLTEndSequence )
process.AlCa_LumiPixels_ZeroBias_part10_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAlCaLumiPixelsZeroBiaspart10 + process.hltFEDSelectorLumiPixels + process.HLTEndSequence )
process.AlCa_LumiPixels_ZeroBias_part11_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBias + process.hltPreAlCaLumiPixelsZeroBiaspart11 + process.hltFEDSelectorLumiPixels + process.HLTEndSequence )
...
process.ZeroBias1Output = cms.EndPath( process.hltGtStage2Digis + process.hltPreZeroBias1Output + process.hltOutputPhysicsZeroBias1 )
process.ZeroBias2Output = cms.EndPath( process.hltGtStage2Digis + process.hltPreZeroBias2Output + process.hltOutputPhysicsZeroBias2 )
process.ZeroBias3Output = cms.EndPath( process.hltGtStage2Digis + process.hltPreZeroBias3Output + process.hltOutputPhysicsZeroBias3 )
process.ZeroBias4Output = cms.EndPath( process.hltGtStage2Digis + process.hltPreZeroBias4Output + process.hltOutputPhysicsZeroBias4 )
process.ZeroBias5Output = cms.EndPath( process.hltGtStage2Digis + process.hltPreZeroBias5Output + process.hltOutputPhysicsZeroBias5 )
...
process.ALCALUMIPIXELSOutput = cms.EndPath( process.hltGtStage2Digis + process.hltPreALCALUMIPIXELSOutput + process.hltOutputALCALUMIPIXELS1 )
process.ALCALUMIPIXELSOutput2 = cms.EndPath( process.hltGtStage2Digis + process.hltPreALCALUMIPIXELSOutput2 + process.hltOutputALCALUMIPIXELS2 )
process.ALCALUMIPIXELSOutput3 = cms.EndPath( process.hltGtStage2Digis + process.hltPreALCALUMIPIXELSOutput3 + process.hltOutputALCALUMIPIXELS3 )
process.ALCALUMIPIXELSOutput4 = cms.EndPath( process.hltGtStage2Digis + process.hltPreALCALUMIPIXELSOutput4 + process.hltOutputALCALUMIPIXELS4 )
process.ALCALUMIPIXELSOutput5 = cms.EndPath( process.hltGtStage2Digis + process.hltPreALCALUMIPIXELSOutput5 + process.hltOutputALCALUMIPIXELS5 )
process.ALCALUMIPIXELSOutput6 = cms.EndPath( process.hltGtStage2Digis + process.hltPreALCALUMIPIXELSOutput6 + process.hltOutputALCALUMIPIXELS6 )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.DST_Physics_v1, process.HLT_Random_v1, process.HLT_L1SingleMu25_v1, process.HLT_ZeroBias_v2, process.HLT_ZeroBias_part0_v2, process.HLT_ZeroBias_part1_v2, process.HLT_ZeroBias_part2_v2, process.HLT_ZeroBias_part3_v2, process.HLT_ZeroBias_part4_v2, process.HLT_ZeroBias_part5_v2, process.HLT_ZeroBias_part6_v2, process.HLT_ZeroBias_part7_v2, process.HLT_ZeroBias_part8_v2, process.HLT_ZeroBias_part9_v2, process.HLT_EcalCalibration_v2, process.HLT_ZeroBias_FirstCollisionAfterAbortGap_v5, process.HLT_HcalCalibration_v1, process.HLT_HcalNZS_v2, process.HLT_HcalPhiSym_v2, process.AlCa_EcalPhiSym_v3, process.AlCa_RPCMuonNoTriggers_v2, process.AlCa_RPCMuonNoHits_v2, process.AlCa_RPCMuonNormalisation_v2, process.AlCa_LumiPixels_Random_v1, process.AlCa_LumiPixels_ZeroBias_part0_v2, process.AlCa_LumiPixels_ZeroBias_part1_v2, process.AlCa_LumiPixels_ZeroBias_part2_v2, process.AlCa_LumiPixels_ZeroBias_part3_v2, process.AlCa_LumiPixels_ZeroBias_part4_v2, process.AlCa_LumiPixels_ZeroBias_part5_v2, process.AlCa_LumiPixels_ZeroBias_part6_v2, process.AlCa_LumiPixels_ZeroBias_part7_v2, process.AlCa_LumiPixels_ZeroBias_part8_v2, process.AlCa_LumiPixels_ZeroBias_part9_v2, process.AlCa_LumiPixels_ZeroBias_part10_v2, process.AlCa_LumiPixels_ZeroBias_part11_v2, process.HLTriggerFinalPath, process.PhysicsEGammaCommissioningOutput, process.ZeroBias1Output, process.ZeroBias2Output, process.ZeroBias3Output, process.ZeroBias4Output, process.ZeroBias5Output, process.RatesMonitoring, process.DQMOutput, process.DQMCalibrationOutput, process.DQMEventDisplayOutput, process.RPCMONOutput, process.CalibrationOutput, process.EcalCalibrationOutput, process.ALCAPHISYMOutput, process.ALCALUMIPIXELSOutput, process.ALCALUMIPIXELSOutput2, process.ALCALUMIPIXELSOutput3, process.ALCALUMIPIXELSOutput4, process.ALCALUMIPIXELSOutput5, process.ALCALUMIPIXELSOutput6, process.ExpressOutput, process.NanoDSTOutput, process.DQMHistograms, process.PhysicsMuonsOutput ))
