# /cdaq/physics/firstCollisions17/v3.0/HLT/V24 (CMSSW_9_0_0)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions17/v3.0/HLT/V24')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_v2" ),
        prescales = cms.vuint32( 330, 330, 330, 330, 330, 300, 330, 330, 330, 330, 330, 220, 110 )
      ),
