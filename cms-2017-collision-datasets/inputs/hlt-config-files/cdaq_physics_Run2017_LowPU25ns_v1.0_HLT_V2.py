# /cdaq/physics/Run2017/LowPU25ns/v1.0/HLT/V2 (CMSSW_9_1_0_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2017/LowPU25ns/v1.0/HLT/V2')
)
...
process.streams = cms.PSet( 
  ...
  PhysicsCommissioning = cms.vstring( 'HLTPhysics',
    ...
    'HighPtPhoton30AndZ',
    'ZeroBias' ),
  PhysicsEGamma = cms.vstring( 'SinglePhoton' ),
  PhysicsEndOfFill1 = cms.vstring( 'EmptyBX',
    ...
    'L1MinimumBias' ),
  PhysicsEndOfFill2 = cms.vstring( 'HighMultiplicityEOF2' ),
  PhysicsEndOfFill3 = cms.vstring( 'HighMultiplicityEOF3' ),
...
process.datasets = cms.PSet( 
  ...
  HcalNZS = cms.vstring( 'HLT_HcalNZS_v10',
    'HLT_HcalPhiSym_v11' ),
  HighMultiplicityEOF1 = cms.vstring( 'HLT_FullTrack_Multiplicity105_part0_v1',
    'HLT_FullTrack_Multiplicity135_part0_v1',
    'HLT_FullTrack_Multiplicity155_part0_v1',
    'HLT_FullTrack_Multiplicity85_part0_v1' ),
  HighMultiplicityEOF2 = cms.vstring( 'HLT_FullTrack_Multiplicity105_part1_v1',
    'HLT_FullTrack_Multiplicity135_part1_v1',
    'HLT_FullTrack_Multiplicity155_part1_v1',
    'HLT_FullTrack_Multiplicity85_part1_v1' ),
  HighMultiplicityEOF3 = cms.vstring( 'HLT_FullTrack_Multiplicity105_part2_v1',
    'HLT_FullTrack_Multiplicity135_part2_v1',
    'HLT_FullTrack_Multiplicity155_part2_v1',
  ...
  OnlineMonitor = cms.vstring( 'HLT_AK4CaloJet100_v4',
    ...
    'HLT_DiPFJetAve25_HFJEC_v6',
    'HLT_DiPFJetAve35_HFJEC_v6',
    'HLT_FullTrack_Multiplicity105_part0_v1',
    'HLT_FullTrack_Multiplicity135_part0_v1',
    'HLT_FullTrack_Multiplicity155_part0_v1',
    'HLT_FullTrack_Multiplicity85_part0_v1',
  ...
  SinglePhoton = cms.vstring( 'HLT_Photon20_HoverELoose_v6',
    'HLT_Photon30_HoverELoose_v6',
    'HLT_Photon40_HoverELoose_v6',
    'HLT_Photon50_HoverELoose_v6',
    'HLT_Photon60_HoverELoose_v6' ),
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_DiPFJet15_NoCaloMatched_v5" ),
        prescales = cms.vuint32( 35, 35, 35, 37, 35 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_DiPFJet25_NoCaloMatched_v5" ),
        prescales = cms.vuint32( 3, 3, 3, 3, 3 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_DiPFJetAve15_HFJEC_v6" ),
        prescales = cms.vuint32( 20, 20, 16, 18, 11 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_DiPFJetAve25_HFJEC_v6" ),
        prescales = cms.vuint32( 2, 2, 2, 2, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_FullTrack_Multiplicity85_part0_v1" ),
        prescales = cms.vuint32( 6, 3, 3, 3, 3 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_FullTrack_Multiplicity85_part1_v1" ),
        prescales = cms.vuint32( 6, 3, 3, 3, 3 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_FullTrack_Multiplicity85_part2_v1" ),
        prescales = cms.vuint32( 6, 3, 3, 3, 3 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_FullTrack_Multiplicity105_part0_v1" ),
        prescales = cms.vuint32( 6, 3, 3, 3, 3 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_FullTrack_Multiplicity105_part1_v1" ),
        prescales = cms.vuint32( 6, 3, 3, 3, 3 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_FullTrack_Multiplicity105_part2_v1" ),
        prescales = cms.vuint32( 6, 3, 3, 3, 3 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_FullTrack_Multiplicity135_part0_v1" ),
        prescales = cms.vuint32( 6, 3, 3, 3, 3 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_FullTrack_Multiplicity135_part1_v1" ),
        prescales = cms.vuint32( 6, 3, 3, 3, 3 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_FullTrack_Multiplicity135_part2_v1" ),
        prescales = cms.vuint32( 6, 3, 3, 3, 3 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_FullTrack_Multiplicity155_part0_v1" ),
        prescales = cms.vuint32( 6, 3, 3, 3, 3 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_FullTrack_Multiplicity155_part1_v1" ),
        prescales = cms.vuint32( 6, 3, 3, 3, 3 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_FullTrack_Multiplicity155_part2_v1" ),
        prescales = cms.vuint32( 6, 3, 3, 3, 3 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_v4" ),
        prescales = cms.vuint32( 100, 160, 160, 160, 220 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_AK4CaloJet30_v5" ),
        prescales = cms.vuint32( 39, 39, 29, 19, 21 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_AK4CaloJet40_v4" ),
        prescales = cms.vuint32( 11, 11, 5, 3, 3 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_AK4CaloJet50_v4" ),
        prescales = cms.vuint32( 3, 3, 2, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_AK4CaloJet100_v4" ),
        prescales = cms.vuint32( 17, 17, 11, 9, 7 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_AK4PFJet30_v7" ),
        prescales = cms.vuint32( 19, 19, 11, 7, 7 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_AK4PFJet50_v7" ),
        prescales = cms.vuint32( 2, 2, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_AK4PFJet100_v7" ),
        prescales = cms.vuint32( 15, 15, 11, 7, 5 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HISinglePhoton10_Eta3p1ForPPRef_v3" ),
        prescales = cms.vuint32( 11, 11, 7, 5, 5 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HISinglePhoton20_Eta3p1ForPPRef_v3" ),
        prescales = cms.vuint32( 5, 5, 5, 5, 5 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HISinglePhoton40_Eta3p1ForPPRef_v3" ),
        prescales = cms.vuint32( 11, 11, 9, 7, 5 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HISinglePhoton50_Eta3p1ForPPRef_v3" ),
        prescales = cms.vuint32( 5, 5, 3, 3, 2 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Photon20_HoverELoose_v6" ),
        prescales = cms.vuint32( 2, 2, 1, 2, 2 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Photon40_HoverELoose_v6" ),
        prescales = cms.vuint32( 3, 3, 3, 2, 2 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Photon50_HoverELoose_v6" ),
        prescales = cms.vuint32( 2, 2, 2, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_EcalPhiSym_v7" ),
        prescales = cms.vuint32( 4, 7, 7, 7, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1MinimumBiasHF_OR_v1" ),
        prescales = cms.vuint32( 0, 0, 0, 0, 0 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1MinimumBiasHF0OR_v2" ),
        prescales = cms.vuint32( 0, 0, 0, 0, 0 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_RPCMuonNormalisation_v10" ),
        prescales = cms.vuint32( 2, 2, 2, 2, 2 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_v5" ),
    ...
    lvl1DefaultLabel = cms.string( "4.3e31_lowPU" ),
...
process.hltHighMult50 = cms.EDFilter( "HLTSingleVertexPixelTrackFilter",
    saveTags = cms.bool( True ),
...
process.hltFullIter0PixelSeeds = cms.EDProducer( "SeedCreatorFromRegionConsecutiveHitsEDProducer",
    SeedComparitorPSet = cms.PSet(  ComponentName = cms.string( "none" ) ),
    forceKinematicWithRegionDirection = cms.bool( False ),
    magneticField = cms.string( "ParabolicMf" ),
    SeedMomentumForBOFF = cms.double( 5.0 ),
...
process.hltFullIter6MixedLayersA = cms.EDProducer( "SeedingLayersEDProducer",
...
process.hltFullIter6MixedTrackingRegionsA = cms.EDProducer( "GlobalTrackingRegionFromBeamSpotEDProducer",
    RegionPSet = cms.PSet( 
      nSigmaZ = cms.double( 0.0 ),
      beamSpot = cms.InputTag( "hltOnlineBeamSpot" ),
      ptMin = cms.double( 0.4 ),
...
process.hltFullIter6MixedClusterCheck = cms.EDProducer( "ClusterCheckerEDProducer",
    cut = cms.string( "" ),
    silentClusterCheck = cms.untracked.bool( False ),
    MaxNumberOfCosmicClusters = cms.uint32( 50000 ),
    PixelClusterCollectionLabel = cms.InputTag( "hltSiPixelClusters" ),
...
process.hltFullIter6MixedHitDoubletsA = cms.EDProducer( "HitPairEDProducer",
    trackingRegions = cms.InputTag( "hltFullIter6MixedTrackingRegionsA" ),
    layerPairs = cms.vuint32( 0 ),
    clusterCheck = cms.InputTag( "hltFullIter6MixedClusterCheck" ),
    produceSeedingHitSets = cms.bool( True ),
    produceIntermediateHitDoublets = cms.bool( True ),
    maxElement = cms.uint32( 0 ),
    seedingLayers = cms.InputTag( "hltFullIter6MixedLayersA" )
)
process.hltFullIter6MixedHitTripletsA = cms.EDProducer( "PixelTripletLargeTipEDProducer",
    useBending = cms.bool( True ),
    useFixedPreFiltering = cms.bool( False ),
    ...
    produceSeedingHitSets = cms.bool( True ),
    doublets = cms.InputTag( "hltFullIter6MixedHitDoubletsA" ),
    useMultScattering = cms.bool( True ),
    extraHitRZtolerance = cms.double( 0.0 )
)
process.hltFullIter6MixedSeedsA = cms.EDProducer( "SeedCreatorFromRegionConsecutiveHitsTripletOnlyEDProducer",
    SeedComparitorPSet = cms.PSet( 
      ComponentName = cms.string( "PixelClusterShapeSeedComparitor" ),
      FilterAtHelixStage = cms.bool( False ),
      FilterPixelHits = cms.bool( True ),
    ...
    TTRHBuilder = cms.string( "hltESPTTRHBWithTrackAngle" ),
    MinOneOverPtError = cms.double( 1.0 ),
    seedingHitSets = cms.InputTag( "hltFullIter6MixedHitTripletsA" ),
    propagator = cms.string( "PropagatorWithMaterialParabolicMf" )
)
process.hltFullIter6MixedLayersB = cms.EDProducer( "SeedingLayersEDProducer",
...
process.hltFullIter6MixedTrackingRegionsB = cms.EDProducer( "GlobalTrackingRegionFromBeamSpotEDProducer",
    RegionPSet = cms.PSet( 
      nSigmaZ = cms.double( 0.0 ),
      beamSpot = cms.InputTag( "hltOnlineBeamSpot" ),
...
process.hltFullIter6MixedHitDoubletsB = cms.EDProducer( "HitPairEDProducer",
    trackingRegions = cms.InputTag( "hltFullIter6MixedTrackingRegionsB" ),
    layerPairs = cms.vuint32( 0 ),
    clusterCheck = cms.InputTag( "hltFullIter6MixedClusterCheck" ),
    produceSeedingHitSets = cms.bool( True ),
    produceIntermediateHitDoublets = cms.bool( True ),
    maxElement = cms.uint32( 0 ),
    seedingLayers = cms.InputTag( "hltFullIter6MixedLayersB" )
)
process.hltFullIter6MixedHitTripletsB = cms.EDProducer( "PixelTripletLargeTipEDProducer",
    useBending = cms.bool( True ),
    useFixedPreFiltering = cms.bool( False ),
    produceIntermediateHitTriplets = cms.bool( False ),
    maxElement = cms.uint32( 1000000 ),
    ...
    extraHitRPhitolerance = cms.double( 0.0 ),
    produceSeedingHitSets = cms.bool( True ),
    doublets = cms.InputTag( "hltFullIter6MixedHitDoubletsB" ),
    useMultScattering = cms.bool( True ),
    extraHitRZtolerance = cms.double( 0.0 )
)
process.hltFullIter6MixedSeedsB = cms.EDProducer( "SeedCreatorFromRegionConsecutiveHitsTripletOnlyEDProducer",
    SeedComparitorPSet = cms.PSet( 
      ComponentName = cms.string( "PixelClusterShapeSeedComparitor" ),
      FilterAtHelixStage = cms.bool( False ),
      FilterPixelHits = cms.bool( True ),
    ...
    TTRHBuilder = cms.string( "hltESPTTRHBWithTrackAngle" ),
    MinOneOverPtError = cms.double( 1.0 ),
    seedingHitSets = cms.InputTag( "hltFullIter6MixedHitTripletsB" ),
    propagator = cms.string( "PropagatorWithMaterialParabolicMf" )
)
process.hltFullIter6MixedSeeds = cms.EDProducer( "SeedCombiner",
    seedCollections = cms.VInputTag( 'hltFullIter6MixedSeedsA','hltFullIter6MixedSeedsB' )
)
process.hltFullIter6CkfTrackCandidates = cms.EDProducer( "CkfTrackCandidateMaker",
    src = cms.InputTag( "hltFullIter6MixedSeeds" ),
    maxSeedsBeforeCleaning = cms.uint32( 5000 ),
    SimpleMagneticField = cms.string( "ParabolicMf" ),
    TransientInitialStateEstimatorParameters = cms.PSet( 
      propagatorAlongTISE = cms.string( "PropagatorWithMaterialParabolicMf" ),
...
process.hltFullIter6TrackMVAClassifier = cms.EDProducer( "TrackMVAClassifierDetached",
...
process.hltFullIter7PixelLessLayers = cms.EDProducer( "SeedingLayersEDProducer",
...
process.hltFullIter7PixelLessTrackingRegions = cms.EDProducer( "GlobalTrackingRegionFromBeamSpotEDProducer",
    RegionPSet = cms.PSet( 
      nSigmaZ = cms.double( 0.0 ),
      beamSpot = cms.InputTag( "hltOnlineBeamSpot" ),
      ptMin = cms.double( 0.4 ),
...
process.hltFullIter7PixelLessClusterCheck = cms.EDProducer( "ClusterCheckerEDProducer",
    cut = cms.string( "" ),
    silentClusterCheck = cms.untracked.bool( False ),
    MaxNumberOfCosmicClusters = cms.uint32( 50000 ),
    PixelClusterCollectionLabel = cms.InputTag( "hltSiPixelClusters" ),
...
process.hltFullIter7PixelLessHitDoublets = cms.EDProducer( "HitPairEDProducer",
    trackingRegions = cms.InputTag( "hltFullIter7PixelLessTrackingRegions" ),
    layerPairs = cms.vuint32( 0 ),
    clusterCheck = cms.InputTag( "hltFullIter7PixelLessClusterCheck" ),
    produceSeedingHitSets = cms.bool( False ),
    produceIntermediateHitDoublets = cms.bool( True ),
    maxElement = cms.uint32( 0 ),
    seedingLayers = cms.InputTag( "hltFullIter7PixelLessLayers" )
)
process.hltFullIter7PixelLessHitTriplets = cms.EDProducer( "MultiHitFromChi2EDProducer",
    ...
    doublets = cms.InputTag( "hltFullIter7PixelLessHitDoublets" ),
    maxElement = cms.uint32( 1000000 ),
    TTRHBuilder = cms.string( "hltESPTTRHBWithTrackAngle" ),
    phiPreFiltering = cms.double( 0.3 ),
    extraHitRZtolerance = cms.double( 0.0 ),
...
process.hltFullIter7PixelLessSeeds = cms.EDProducer( "SeedCreatorFromRegionConsecutiveHitsTripletOnlyEDProducer",
    SeedComparitorPSet = cms.PSet( 
    ...
    TTRHBuilder = cms.string( "hltESPTTRHBWithTrackAngle" ),
    MinOneOverPtError = cms.double( 1.0 ),
    seedingHitSets = cms.InputTag( "hltFullIter7PixelLessHitTriplets" ),
    propagator = cms.string( "PropagatorWithMaterialParabolicMf" )
)
process.hltFullIter7CkfTrackCandidates = cms.EDProducer( "CkfTrackCandidateMaker",
    src = cms.InputTag( "hltFullIter7PixelLessSeeds" ),
    maxSeedsBeforeCleaning = cms.uint32( 5000 ),
    SimpleMagneticField = cms.string( "ParabolicMf" ),
    TransientInitialStateEstimatorParameters = cms.PSet( 
      propagatorAlongTISE = cms.string( "PropagatorWithMaterialParabolicMf" ),
...
process.hltFullIter7TrackMVAClassifier = cms.EDProducer( "TrackMVAClassifierPrompt",
...
process.hltFullIter8TobTecLayersTripl = cms.EDProducer( "SeedingLayersEDProducer",
...
process.hltFullIter8TobTecTrackingRegionsTripl = cms.EDProducer( "GlobalTrackingRegionFromBeamSpotEDProducer",
    RegionPSet = cms.PSet( 
      nSigmaZ = cms.double( 0.0 ),
      beamSpot = cms.InputTag( "hltOnlineBeamSpot" ),
      ptMin = cms.double( 0.55 ),
...
process.hltFullIter8TobTecClusterCheck = cms.EDProducer( "ClusterCheckerEDProducer",
    cut = cms.string( "" ),
    silentClusterCheck = cms.untracked.bool( False ),
    MaxNumberOfCosmicClusters = cms.uint32( 50000 ),
    PixelClusterCollectionLabel = cms.InputTag( "hltSiPixelClusters" ),
...
process.hltFullIter8TobTecHitDoubletsTripl = cms.EDProducer( "HitPairEDProducer",
    trackingRegions = cms.InputTag( "hltFullIter8TobTecTrackingRegionsTripl" ),
    layerPairs = cms.vuint32( 0 ),
    clusterCheck = cms.InputTag( "hltFullIter8TobTecClusterCheck" ),
    produceSeedingHitSets = cms.bool( False ),
    produceIntermediateHitDoublets = cms.bool( True ),
    maxElement = cms.uint32( 0 ),
    seedingLayers = cms.InputTag( "hltFullIter8TobTecLayersTripl" )
)
process.hltFullIter8TobTecHitTripletsTripl = cms.EDProducer( "MultiHitFromChi2EDProducer",
    detIdsToDebug = cms.vint32( 0, 0, 0 ),
    ...
    chi2_cuts = cms.vdouble( 3.0, 4.0, 5.0, 5.0 ),
    extraZKDBox = cms.double( 0.2 ),
    doublets = cms.InputTag( "hltFullIter8TobTecHitDoubletsTripl" ),
    maxElement = cms.uint32( 1000000 ),
    TTRHBuilder = cms.string( "hltESPTTRHBWithTrackAngle" ),
    phiPreFiltering = cms.double( 0.3 ),
    extraHitRZtolerance = cms.double( 0.0 ),
...
process.hltFullIter8TobTecSeedsTripl = cms.EDProducer( "SeedCreatorFromRegionConsecutiveHitsEDProducer",
    SeedComparitorPSet = cms.PSet( 
      ComponentName = cms.string( "CombinedSeedComparitor" ),
      mode = cms.string( "and" ),
      comparitors = cms.VPSet( 
    ...
    TTRHBuilder = cms.string( "hltESPTTRHBWithTrackAngle" ),
    MinOneOverPtError = cms.double( 1.0 ),
    seedingHitSets = cms.InputTag( "hltFullIter8TobTecHitTripletsTripl" ),
    propagator = cms.string( "PropagatorWithMaterialParabolicMf" )
)
process.hltFullIter8TobTecLayersPair = cms.EDProducer( "SeedingLayersEDProducer",
...
process.hltFullIter8TobTecTrackingRegionsPair = cms.EDProducer( "GlobalTrackingRegionFromBeamSpotEDProducer",
    RegionPSet = cms.PSet( 
      nSigmaZ = cms.double( 0.0 ),
      beamSpot = cms.InputTag( "hltOnlineBeamSpot" ),
      ptMin = cms.double( 0.6 ),
...
process.hltFullIter8TobTecHitDoubletsPair = cms.EDProducer( "HitPairEDProducer",
    trackingRegions = cms.InputTag( "hltFullIter8TobTecTrackingRegionsPair" ),
    layerPairs = cms.vuint32( 0 ),
    clusterCheck = cms.InputTag( "hltFullIter8TobTecClusterCheck" ),
    produceSeedingHitSets = cms.bool( True ),
    produceIntermediateHitDoublets = cms.bool( True ),
    maxElement = cms.uint32( 0 ),
    seedingLayers = cms.InputTag( "hltFullIter8TobTecLayersPair" )
)
process.hltFullIter8TobTecSeedsPair = cms.EDProducer( "SeedCreatorFromRegionConsecutiveHitsEDProducer",
    SeedComparitorPSet = cms.PSet( 
      ComponentName = cms.string( "CombinedSeedComparitor" ),
      mode = cms.string( "and" ),
      comparitors = cms.VPSet( 
    ...
    TTRHBuilder = cms.string( "hltESPTTRHBWithTrackAngle" ),
    MinOneOverPtError = cms.double( 1.0 ),
    seedingHitSets = cms.InputTag( "hltFullIter8TobTecHitDoubletsPair" ),
    propagator = cms.string( "PropagatorWithMaterialParabolicMf" )
)
process.hltFullIter8TobTecSeeds = cms.EDProducer( "SeedCombiner",
    seedCollections = cms.VInputTag( 'hltFullIter8TobTecSeedsTripl','hltFullIter8TobTecSeedsPair' )
)
process.hltFullIter8CkfTrackCandidates = cms.EDProducer( "CkfTrackCandidateMaker",
    src = cms.InputTag( "hltFullIter8TobTecSeeds" ),
    maxSeedsBeforeCleaning = cms.uint32( 5000 ),
    SimpleMagneticField = cms.string( "ParabolicMf" ),
    TransientInitialStateEstimatorParameters = cms.PSet( 
      propagatorAlongTISE = cms.string( "PropagatorWithMaterialParabolicMf" ),
...
process.hltFullIter8TrackMVAClassifier = cms.EDProducer( "TrackMVAClassifierDetached",
...
process.hltPreFullTrackMultiplicity105part0 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltFullTrackHighMult105 = cms.EDFilter( "HLTSingleVertexPixelTrackFilter",
    saveTags = cms.bool( True ),
    MinTrks = cms.int32( 105 ),
    MinPt = cms.double( 0.4 ),
    MaxVz = cms.double( 15.0 ),
    MaxEta = cms.double( 2.4 ),
    trackCollection = cms.InputTag( "hltFullCandsForHighMultTrigger" ),
...
process.hltPreFullTrackMultiplicity105part1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 1 )
)
process.hltPreFullTrackMultiplicity105part2 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 2 )
)
...
process.hltPreFullTrackMultiplicity135part0 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltFullTrackHighMult135 = cms.EDFilter( "HLTSingleVertexPixelTrackFilter",
    saveTags = cms.bool( True ),
...
process.hltPreFullTrackMultiplicity135part1 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 1 )
)
process.hltPreFullTrackMultiplicity135part2 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 2 )
)
...
process.hltL1sL1UnpairedBunchBptxMinus = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( " L1_BPTX_B2NotB1_VME" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltL1sL1UnpairedBunchBptxPlus = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( " L1_BPTX_B1NotB2_VME" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1MinimumBiasHFOR = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltPreL1MinimumBiasHF0OR = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltL1sSingleEG5IorSingleEG24IorSingleMuOpen = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleEG5 OR L1_SingleEG24 OR L1_SingleMuOpen" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltL1sSingleMu5IorSingleMu14erIorSingleMu16erIorSingleMu18erIorSingleMu20er = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleMu5 OR L1_SingleMu14er2p1 OR L1_SingleMu16er2p1 OR L1_SingleMu18er2p1 OR L1_SingleMu20er2p1" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPrePhysicsEndOfFill3Output = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreDQMOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring( 'HLT_DiPFJet15_NoCaloMatched_v5 / 3',
      ...
      'HLT_FullTrack_Multiplicity85_part0_v1 / 50',
      'HLT_FullTrack_Multiplicity105_part0_v1 / 50',
      'HLT_FullTrack_Multiplicity135_part0_v1 / 50',
      'HLT_FullTrack_Multiplicity155_part0_v1 / 50',
      'HLT_Physics_v5',
      'HLT_Random_v2 / 3',
      'HLT_ZeroBias_v4 / 3',
      ...
      'HLT_L1UnpairedBunchBptxMinus_v1 / 3',
      'HLT_L1UnpairedBunchBptxPlus_v1 / 3',
...
process.hltPreDQMEventDisplayOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    hltResults = cms.InputTag( "TriggerResults" ),
    l1tResults = cms.InputTag( "" ),
    triggerConditions = cms.vstring( 'HLT_AK4PFJet100_v7' ),
    l1tIgnoreMaskAndPrescale = cms.bool( False ),
    throw = cms.bool( True )
)
...
process.hltOutputPhysicsCommissioning = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_HISinglePhoton10_Eta3p1ForPPRef_v3',
  'HLT_HISinglePhoton20_Eta3p1ForPPRef_v3',
  'HLT_HISinglePhoton30_Eta3p1ForPPRef_v3',
  'HLT_HISinglePhoton40_Eta3p1ForPPRef_v3',
  'HLT_HISinglePhoton50_Eta3p1ForPPRef_v3',
...
process.hltOutputPhysicsEGamma = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_Photon20_HoverELoose_v6',
  'HLT_Photon30_HoverELoose_v6',
  'HLT_Photon40_HoverELoose_v6',
  'HLT_Photon50_HoverELoose_v6',
  'HLT_Photon60_HoverELoose_v6' ) ),
...
process.hltOutputPhysicsEndOfFill2 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_FullTrack_Multiplicity105_part1_v1',
  'HLT_FullTrack_Multiplicity135_part1_v1',
  'HLT_FullTrack_Multiplicity155_part1_v1',
  'HLT_FullTrack_Multiplicity85_part1_v1' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
...
process.hltOutputPhysicsEndOfFill3 = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_FullTrack_Multiplicity105_part2_v1',
  'HLT_FullTrack_Multiplicity135_part2_v1',
  'HLT_FullTrack_Multiplicity155_part2_v1',
  'HLT_FullTrack_Multiplicity85_part2_v1' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
...
process.hltOutputRPCMON = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'AlCa_RPCMuonNormalisation_v10' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
...
process.HLTFullIterativeTrackingIteration6 = cms.Sequence( process.hltFullIter6ClustersRefRemoval + process.hltFullIter6MaskedMeasurementTrackerEvent + process.hltFullIter6MixedLayersA + process.hltFullIter6MixedTrackingRegionsA + process.hltFullIter6MixedClusterCheck + process.hltFullIter6MixedHitDoubletsA + process.hltFullIter6MixedHitTripletsA + process.hltFullIter6MixedSeedsA + process.hltFullIter6MixedLayersB + process.hltFullIter6MixedTrackingRegionsB + process.hltFullIter6MixedHitDoubletsB + process.hltFullIter6MixedHitTripletsB + process.hltFullIter6MixedSeedsB + process.hltFullIter6MixedSeeds + process.hltFullIter6CkfTrackCandidates + process.hltFullIter6CtfWithMaterialTracks + process.hltFullIter6TrackMVAClassifier + process.hltFullIter6HighPurityTracks )
process.HLTFullIterativeTrackingIteration7 = cms.Sequence( process.hltFullIter7ClustersRefRemoval + process.hltFullIter7MaskedMeasurementTrackerEvent + process.hltFullIter7PixelLessLayers + process.hltFullIter7PixelLessTrackingRegions + process.hltFullIter7PixelLessClusterCheck + process.hltFullIter7PixelLessHitDoublets + process.hltFullIter7PixelLessHitTriplets + process.hltFullIter7PixelLessSeeds + process.hltFullIter7CkfTrackCandidates + process.hltFullIter7CtfWithMaterialTracks + process.hltFullIter7TrackMVAClassifier + process.hltFullIter7HighPurityTracks )
process.HLTFullIterativeTrackingIteration8 = cms.Sequence( process.hltFullIter8ClustersRefRemoval + process.hltFullIter8MaskedMeasurementTrackerEvent + process.hltFullIter8TobTecLayersTripl + process.hltFullIter8TobTecTrackingRegionsTripl + process.hltFullIter8TobTecClusterCheck + process.hltFullIter8TobTecHitDoubletsTripl + process.hltFullIter8TobTecHitTripletsTripl + process.hltFullIter8TobTecSeedsTripl + process.hltFullIter8TobTecLayersPair + process.hltFullIter8TobTecTrackingRegionsPair + process.hltFullIter8TobTecHitDoubletsPair + process.hltFullIter8TobTecSeedsPair + process.hltFullIter8TobTecSeeds + process.hltFullIter8CkfTrackCandidates + process.hltFullIter8CtfWithMaterialTracks + process.hltFullIter8TrackMVAClassifier )
process.HLTFullIterativeTracking = cms.Sequence( process.HLTFullIterativeTrackingIteration0 + process.HLTFullIterativeTrackingIteration1 + process.HLTFullIterativeTrackingIteration2 + process.HLTFullIterativeTrackingIteration3 + process.HLTFullIterativeTrackingIteration4 + process.HLTFullIterativeTrackingIteration5 + process.HLTFullIterativeTrackingIteration6 + process.HLTFullIterativeTrackingIteration7 + process.HLTFullIterativeTrackingIteration8 + process.hltFullIterativeTrackingMerged )
...
process.HLT_DiPFJet15_NoCaloMatched_v5 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet12BptxAND + process.hltPreDiPFJet15NoCaloMatched + process.HLTAK4PFJetsSequence + process.hltDoublePFJet15 + process.HLTEndSequence )
process.HLT_DiPFJet25_NoCaloMatched_v5 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet12BptxAND + process.hltPreDiPFJet25NoCaloMatched + process.HLTAK4PFJetsSequence + process.hltDoublePFJet25 + process.HLTEndSequence )
process.HLT_DiPFJet15_FBEta3_NoCaloMatched_v6 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet12BptxAND + process.hltPreDiPFJet15FBEta3NoCaloMatched + process.HLTAK4PFJetsSequence + process.hltDoublePFJet15FBEta3 + process.HLTEndSequence )
process.HLT_DiPFJet25_FBEta3_NoCaloMatched_v6 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet12BptxAND + process.hltPreDiPFJet25FBEta3NoCaloMatched + process.HLTAK4PFJetsSequence + process.hltDoublePFJet25FBEta3 + process.HLTEndSequence )
process.HLT_DiPFJetAve15_HFJEC_v6 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreDiPFJetAve15HFJEC + process.HLTAK4PFJetsSequence + process.hltDiPFJetAve15ForHFJEC + process.HLTEndSequence )
process.HLT_DiPFJetAve25_HFJEC_v6 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreDiPFJetAve25HFJEC + process.HLTAK4PFJetsSequence + process.hltDiPFJetAve25ForHFJEC + process.HLTEndSequence )
process.HLT_DiPFJetAve35_HFJEC_v6 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet12BptxAND + process.hltPreDiPFJetAve35HFJEC + process.HLTAK4PFJetsSequence + process.hltDiPFJetAve35ForHFJEC + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity85_part0_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sETT55BptxAND + process.hltPreFullTrackMultiplicity85part0 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult50 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult85 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity85_part1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sETT55BptxAND + process.hltPreFullTrackMultiplicity85part1 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult50 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult85 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity85_part2_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sETT55BptxAND + process.hltPreFullTrackMultiplicity85part2 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult50 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult85 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity105_part0_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sETT55BptxAND + process.hltPreFullTrackMultiplicity105part0 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult50 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult105 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity105_part1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sETT55BptxAND + process.hltPreFullTrackMultiplicity105part1 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult50 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult105 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity105_part2_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sETT55BptxAND + process.hltPreFullTrackMultiplicity105part2 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult50 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult105 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity135_part0_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sETT70BptxAND + process.hltPreFullTrackMultiplicity135part0 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult50 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult135 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity135_part1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sETT70BptxAND + process.hltPreFullTrackMultiplicity135part1 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult50 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult135 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity135_part2_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sETT70BptxAND + process.hltPreFullTrackMultiplicity135part2 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult50 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult135 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity155_part0_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sETT70BptxAND + process.hltPreFullTrackMultiplicity155part0 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult50 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult155 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity155_part1_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sETT70BptxAND + process.hltPreFullTrackMultiplicity155part1 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult50 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult155 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity155_part2_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sETT70BptxAND + process.hltPreFullTrackMultiplicity155part2 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult50 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult155 + process.HLTEndSequence )
...
process.HLT_AK4CaloJet30_v5 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreAK4CaloJet30 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet30 + process.HLTEndSequence )
process.HLT_AK4CaloJet40_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreAK4CaloJet40 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet40 + process.HLTEndSequence )
process.HLT_AK4CaloJet50_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreAK4CaloJet50 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet50 + process.HLTEndSequence )
process.HLT_AK4CaloJet80_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet35 + process.hltPreAK4CaloJet80 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet80 + process.HLTEndSequence )
process.HLT_AK4CaloJet100_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet60 + process.hltPreAK4CaloJet100 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet100 + process.HLTEndSequence )
process.HLT_AK4CaloJet120_v4 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet60 + process.hltPreAK4CaloJet120 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet120 + process.HLTEndSequence )
process.HLT_AK4PFJet30_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreAK4PFJet30 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet15 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedMatchedToCaloJets15 + process.hltSingleAK4PFJet30 + process.HLTEndSequence )
process.HLT_AK4PFJet50_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreAK4PFJet50 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet30 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedMatchedToCaloJets30 + process.hltSingleAK4PFJet50 + process.HLTEndSequence )
process.HLT_AK4PFJet80_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet35 + process.hltPreAK4PFJet80 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet50 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedMatchedToCaloJets50 + process.hltSingleAK4PFJet80 + process.HLTEndSequence )
process.HLT_AK4PFJet100_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet60 + process.hltPreAK4PFJet100 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet70 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedMatchedToCaloJets70 + process.hltSingleAK4PFJet100 + process.HLTEndSequence )
process.HLT_AK4PFJet120_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJet60 + process.hltPreAK4PFJet120 + process.HLTAK4CaloJetsSequence + process.hltSingleAK4CaloJet70 + process.HLTAK4PFJetsSequence + process.hltAK4PFJetsCorrectedMatchedToCaloJets70 + process.hltSingleAK4PFJet120 + process.HLTEndSequence )
process.HLT_HISinglePhoton10_Eta3p1ForPPRef_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBias + process.hltPreHISinglePhoton10Eta3p1ForPPRef + process.HLTDoCaloSequence + process.HLTDoHIEcalClusWithCleaningSequence + process.hltHIPhoton10Eta3p1 + process.HLTEndSequence )
process.HLT_HISinglePhoton20_Eta3p1ForPPRef_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG10 + process.hltPreHISinglePhoton20Eta3p1ForPPRef + process.HLTDoCaloSequence + process.HLTDoHIEcalClusWithCleaningSequence + process.hltHIPhoton20Eta3p1 + process.HLTEndSequence )
process.HLT_HISinglePhoton30_Eta3p1ForPPRef_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG10 + process.hltPreHISinglePhoton30Eta3p1ForPPRef + process.HLTDoCaloSequence + process.HLTDoHIEcalClusWithCleaningSequence + process.hltHIPhoton30Eta3p1 + process.HLTEndSequence )
process.HLT_HISinglePhoton40_Eta3p1ForPPRef_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG24 + process.hltPreHISinglePhoton40Eta3p1ForPPRef + process.HLTDoCaloSequence + process.HLTDoHIEcalClusWithCleaningSequence + process.hltHIPhoton40Eta3p1 + process.HLTEndSequence )
process.HLT_HISinglePhoton50_Eta3p1ForPPRef_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG24 + process.hltPreHISinglePhoton50Eta3p1ForPPRef + process.HLTDoCaloSequence + process.HLTDoHIEcalClusWithCleaningSequence + process.hltHIPhoton50Eta3p1 + process.HLTEndSequence )
process.HLT_HISinglePhoton60_Eta3p1ForPPRef_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG24 + process.hltPreHISinglePhoton60Eta3p1ForPPRef + process.HLTDoCaloSequence + process.HLTDoHIEcalClusWithCleaningSequence + process.hltHIPhoton60Eta3p1 + process.HLTEndSequence )
process.HLT_Photon20_HoverELoose_v6 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG10 + process.hltPrePhoton20HoverELoose + process.HLTPhoton20SequenceLooseHOverE + process.HLTEndSequence )
process.HLT_Photon30_HoverELoose_v6 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG10 + process.hltPrePhoton30HoverELoose + process.HLTPhoton30SequenceLooseHOverE + process.HLTEndSequence )
process.HLT_Photon40_HoverELoose_v6 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG24 + process.hltPrePhoton40HoverELoose + process.HLTPhoton40SequenceLooseHOverE + process.HLTEndSequence )
process.HLT_Photon50_HoverELoose_v6 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG24 + process.hltPrePhoton50HoverELoose + process.HLTPhoton50SequenceLooseHOverE + process.HLTEndSequence )
process.HLT_Photon60_HoverELoose_v6 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG24 + process.hltPrePhoton60HoverELoose + process.HLTPhoton60SequenceLooseHOverE + process.HLTEndSequence )
...
process.AlCa_EcalPhiSym_v7 = cms.Path( process.HLTBeginSequence + process.hltL1sZeroBiasIorAlwaysTrueIorIsolatedBunch + process.hltPreAlCaEcalPhiSym + process.HLTDoFullUnpackingEgammaEcalSequence + process.hltEcalPhiSymFilter + process.HLTEndSequence )
process.HLT_L1UnpairedBunchBptxMinus_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1UnpairedBunchBptxMinus + process.hltPreL1UnpairedBunchBptxMinus + process.HLTEndSequence )
process.HLT_L1UnpairedBunchBptxPlus_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1UnpairedBunchBptxPlus + process.hltPreL1UnpairedBunchBptxPlus + process.HLTEndSequence )
process.HLT_L1NotBptxOR_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sNotBptxOR + process.hltPreL1NotBptxOR + process.HLTEndSequence )
process.HLT_L1MinimumBiasHF_OR_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sMinimumBiasHF0ORBptxAND + process.hltPreL1MinimumBiasHFOR + process.HLTEndSequence )
process.HLT_L1MinimumBiasHF0OR_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sMinimumBiasHF0ORBptxAND + process.hltPreL1MinimumBiasHF0OR + process.HLTEndSequence )
...
process.HLT_HcalPhiSym_v11 = cms.Path( process.HLTBeginSequenceNZS + process.hltL1sSingleEG5IorSingleEG24IorSingleMuOpen + process.hltPreHcalPhiSym + process.HLTEndSequence )
process.AlCa_RPCMuonNormalisation_v10 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleMu5IorSingleMu14erIorSingleMu16erIorSingleMu18erIorSingleMu20er + process.hltPreAlCaRPCMuonNormalisation + process.hltRPCMuonNormaL1Filtered0 + process.HLTMuonLocalRecoSequence + process.HLTEndSequence )
...
process.PhysicsEndOfFill3Output = cms.EndPath( process.hltGtStage2Digis + process.hltPrePhysicsEndOfFill3Output + process.hltOutputPhysicsEndOfFill3 )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_DiPFJet15_NoCaloMatched_v5, process.HLT_DiPFJet25_NoCaloMatched_v5, process.HLT_DiPFJet15_FBEta3_NoCaloMatched_v6, process.HLT_DiPFJet25_FBEta3_NoCaloMatched_v6, process.HLT_DiPFJetAve15_HFJEC_v6, process.HLT_DiPFJetAve25_HFJEC_v6, process.HLT_DiPFJetAve35_HFJEC_v6, process.HLT_FullTrack_Multiplicity85_part0_v1, process.HLT_FullTrack_Multiplicity85_part1_v1, process.HLT_FullTrack_Multiplicity85_part2_v1, process.HLT_FullTrack_Multiplicity105_part0_v1, process.HLT_FullTrack_Multiplicity105_part1_v1, process.HLT_FullTrack_Multiplicity105_part2_v1, process.HLT_FullTrack_Multiplicity135_part0_v1, process.HLT_FullTrack_Multiplicity135_part1_v1, process.HLT_FullTrack_Multiplicity135_part2_v1, process.HLT_FullTrack_Multiplicity155_part0_v1, process.HLT_FullTrack_Multiplicity155_part1_v1, process.HLT_FullTrack_Multiplicity155_part2_v1, process.HLT_Physics_v5, process.DST_Physics_v5, process.HLT_Random_v2, process.HLT_ZeroBias_v4, process.HLT_AK4CaloJet30_v5, process.HLT_AK4CaloJet40_v4, process.HLT_AK4CaloJet50_v4, process.HLT_AK4CaloJet80_v4, process.HLT_AK4CaloJet100_v4, process.HLT_AK4CaloJet120_v4, process.HLT_AK4PFJet30_v7, process.HLT_AK4PFJet50_v7, process.HLT_AK4PFJet80_v7, process.HLT_AK4PFJet100_v7, process.HLT_AK4PFJet120_v7, process.HLT_HISinglePhoton10_Eta3p1ForPPRef_v3, process.HLT_HISinglePhoton20_Eta3p1ForPPRef_v3, process.HLT_HISinglePhoton30_Eta3p1ForPPRef_v3, process.HLT_HISinglePhoton40_Eta3p1ForPPRef_v3, process.HLT_HISinglePhoton50_Eta3p1ForPPRef_v3, process.HLT_HISinglePhoton60_Eta3p1ForPPRef_v3, process.HLT_Photon20_HoverELoose_v6, process.HLT_Photon30_HoverELoose_v6, process.HLT_Photon40_HoverELoose_v6, process.HLT_Photon50_HoverELoose_v6, process.HLT_Photon60_HoverELoose_v6, process.HLT_EcalCalibration_v3, process.HLT_HcalCalibration_v4, process.AlCa_EcalPhiSym_v7, process.HLT_L1UnpairedBunchBptxMinus_v1, process.HLT_L1UnpairedBunchBptxPlus_v1, process.HLT_L1NotBptxOR_v2, process.HLT_L1MinimumBiasHF_OR_v1, process.HLT_L1MinimumBiasHF0OR_v2, process.HLT_HcalNZS_v10, process.HLT_HcalPhiSym_v11, process.AlCa_RPCMuonNormalisation_v10, process.AlCa_LumiPixels_Random_v2, process.AlCa_LumiPixels_ZeroBias_v5, process.HLT_ZeroBias_part0_v2, process.HLT_ZeroBias_part1_v2, process.HLT_ZeroBias_part2_v2, process.HLT_ZeroBias_part3_v2, process.HLT_ZeroBias_part4_v2, process.HLT_ZeroBias_part5_v2, process.HLT_ZeroBias_part6_v2, process.HLT_ZeroBias_part7_v2, process.HLT_ZeroBias_part8_v2, process.HLT_ZeroBias_part9_v2, process.HLT_ZeroBias_FirstCollisionAfterAbortGap_v3, process.HLT_ZeroBias_IsolatedBunches_v3, process.HLTriggerFinalPath, process.RatesMonitoring, process.DQMHistograms, process.PhysicsCommissioningOutput, process.PhysicsEGammaOutput, process.PhysicsEndOfFill1Output, process.PhysicsEndOfFill2Output, process.PhysicsEndOfFill3Output, process.PhysicsZeroBias1Output, process.PhysicsZeroBias2Output, process.PhysicsZeroBias3Output, process.PhysicsZeroBias4Output, process.PhysicsZeroBias5Output, process.DQMOutput, process.DQMCalibrationOutput, process.DQMEventDisplayOutput, process.RPCMONOutput, process.CalibrationOutput, process.EcalCalibrationOutput, process.ALCAPHISYMOutput, process.ALCALUMIPIXELSOutput, process.ExpressOutput, process.NanoDSTOutput ))
