# /cdaq/physics/Run2017/LowPU25ns/v2.0/HLT/V1 (CMSSW_9_2_6_HLT1)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2017/LowPU25ns/v2.0/HLT/V1')
)
...
process.datasets = cms.PSet( 
  ...
  HcalNZS = cms.vstring( 'HLT_HcalNZS_v12',
    'HLT_HcalPhiSym_v14' ),
  HighMultiplicityEOF1 = cms.vstring( 'HLT_FullTrack_Multiplicity100_v2',
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_Ele20_WPTight_Gsf_v2" ),
        prescales = cms.vuint32( 0, 1, 1, 1, 1, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_DiPFJet15_NoCaloMatched_v10" ),
        prescales = cms.vuint32( 0, 8, 6, 4, 6, 5, 3 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_L1FatEvents_v2" ),
        prescales = cms.vuint32( 2333, 2333, 2333, 2333, 2333, 2333, 2333 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_v7" ),
        prescales = cms.vuint32( 2333, 2333, 2333, 2333, 2333, 2333, 2333 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Random_v3" ),
        prescales = cms.vuint32( 101, 101, 101, 101, 101, 101, 101 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_v6" ),
        prescales = cms.vuint32( 1000, 1000, 1000, 1000, 1000, 1000, 1000 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_EcalPhiSym_v8" ),
        prescales = cms.vuint32( 4, 7, 7, 7, 7, 7, 7 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_IsolatedBunches_v5" ),
        prescales = cms.vuint32( 10, 10, 10, 10, 10, 10, 10 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_RPCMuonNormalisation_v13" ),
        prescales = cms.vuint32( 2, 2, 2, 2, 2, 2, 2 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_ZeroBias_v8" ),
        prescales = cms.vuint32( 11, 11, 11, 11, 11, 11, 11 )
      ),
...
process.hltL1sETT50to60BptxAND = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_ETT50_BptxAND OR L1_ETT60_BptxAND" ),
    L1EGammaInputTag = cms.InputTag( 'hltGtStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltGtStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreFullTrackMultiplicity85 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreFullTrackMultiplicity100 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreFullTrackMultiplicity130 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreFullTrackMultiplicity155 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreDQMOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring( 'HLT_Ele20_WPTight_Gsf_v2 / 3',
      ...
      'HLT_FullTrack_Multiplicity85_v3 / 3',
      'HLT_FullTrack_Multiplicity100_v2 / 3',
      'HLT_FullTrack_Multiplicity130_v2 / 3',
      'HLT_FullTrack_Multiplicity155_v3 / 3',
...
process.HLT_FullTrack_Multiplicity85_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity85 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult85 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity100_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity100 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult100 + process.HLTEndSequence )
process.HLT_FullTrack_Multiplicity130_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sETT50to60BptxAND + process.hltPreFullTrackMultiplicity130 + process.HLTDoLocalPixelSequence + process.HLTRecopixelvertexingForHighMultSequence + process.hltGoodPixelTracksForHighMult + process.hltPixelCandsForHighMult + process.hltHighMult30 + process.HLTDoLocalStripSequenceFull + process.HLTFullIterativeTracking + process.hltFullOnlinePrimaryVertices + process.hltFullGoodHighPurityFullTrackCutClassifier + process.hltFullGoodHighPurityFullTracks + process.hltFullCandsForHighMultTrigger + process.hltFullTrackHighMult130 + process.HLTEndSequence )
