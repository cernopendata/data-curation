# /cdaq/special/2017TS2RampUp/50b/HLT/V3 (CMSSW_9_2_10)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/2017TS2RampUp/50b/HLT/V3')
)
...
process.streams = cms.PSet( 
  ...
  ZeroBias1 = cms.vstring( 'ZeroBiasPD01',
    'ZeroBiasPD02' ),
  ZeroBias2 = cms.vstring( 'ZeroBiasPD03',
    'ZeroBiasPD04' ),
  ZeroBias3 = cms.vstring( 'ZeroBiasPD05',
    'ZeroBiasPD06' ),
  ZeroBias4 = cms.vstring( 'ZeroBiasPD07',
    'ZeroBiasPD08' ),
  ZeroBias5 = cms.vstring( 'ZeroBiasPD09',
    'ZeroBiasPD10' )
)
process.datasets = cms.PSet( 
  ...
  TestEnablesEcalHcalDQM = cms.vstring( 'HLT_EcalCalibration_v2',
    'HLT_HcalCalibration_v1' ),
  ZeroBiasPD01 = cms.vstring( 'HLT_ZeroBias_part0_v2' ),
  ZeroBiasPD02 = cms.vstring( 'HLT_ZeroBias_part1_v2' ),
  ZeroBiasPD03 = cms.vstring( 'HLT_ZeroBias_part2_v2' ),
  ZeroBiasPD04 = cms.vstring( 'HLT_ZeroBias_part3_v2' ),
  ZeroBiasPD05 = cms.vstring( 'HLT_ZeroBias_part4_v2' ),
  ZeroBiasPD06 = cms.vstring( 'HLT_ZeroBias_part5_v2' ),
  ZeroBiasPD07 = cms.vstring( 'HLT_ZeroBias_part6_v2' ),
  ZeroBiasPD08 = cms.vstring( 'HLT_ZeroBias_part7_v2' ),
  ZeroBiasPD09 = cms.vstring( 'HLT_ZeroBias_part8_v2' ),
  ZeroBiasPD10 = cms.vstring( 'HLT_ZeroBias_part9_v2' )
)
...
process.hltOutputZeroBias1 = cms.OutputModule( "ShmStreamConsumer",
...
process.hltOutputZeroBias2 = cms.OutputModule( "ShmStreamConsumer",
...
process.hltOutputZeroBias3 = cms.OutputModule( "ShmStreamConsumer",
...
process.hltOutputZeroBias4 = cms.OutputModule( "ShmStreamConsumer",
...
process.hltOutputZeroBias5 = cms.OutputModule( "ShmStreamConsumer",
...
process.ZeroBias1Output = cms.EndPath( process.hltGtStage2Digis + process.hltPreZeroBias1Output + process.hltOutputZeroBias1 )
process.ZeroBias2Output = cms.EndPath( process.hltGtStage2Digis + process.hltPreZeroBias2Output + process.hltOutputZeroBias2 )
process.ZeroBias3Output = cms.EndPath( process.hltGtStage2Digis + process.hltPreZeroBias3Output + process.hltOutputZeroBias3 )
process.ZeroBias4Output = cms.EndPath( process.hltGtStage2Digis + process.hltPreZeroBias4Output + process.hltOutputZeroBias4 )
process.ZeroBias5Output = cms.EndPath( process.hltGtStage2Digis + process.hltPreZeroBias5Output + process.hltOutputZeroBias5 )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.DST_Physics_v1, process.HLT_Random_v1, process.HLT_ZeroBias_v2, process.HLT_ZeroBias_part0_v2, process.HLT_ZeroBias_part1_v2, process.HLT_ZeroBias_part2_v2, process.HLT_ZeroBias_part3_v2, process.HLT_ZeroBias_part4_v2, process.HLT_ZeroBias_part5_v2, process.HLT_ZeroBias_part6_v2, process.HLT_ZeroBias_part7_v2, process.HLT_ZeroBias_part8_v2, process.HLT_ZeroBias_part9_v2, process.HLT_EcalCalibration_v2, process.HLT_HcalCalibration_v1, process.HLT_HcalNZS_v2, process.HLT_HcalPhiSym_v2, process.AlCa_EcalPhiSym_v3, process.AlCa_RPCMuonNoTriggers_v2, process.AlCa_RPCMuonNoHits_v2, process.AlCa_RPCMuonNormalisation_v2, process.AlCa_LumiPixels_Random_v1, process.AlCa_LumiPixels_ZeroBias_v2, process.HLTriggerFinalPath, process.PhysicsEGammaCommissioningOutput, process.ZeroBias1Output, process.ZeroBias2Output, process.ZeroBias3Output, process.ZeroBias4Output, process.ZeroBias5Output, process.RatesMonitoring, process.DQMOutput, process.DQMCalibrationOutput, process.DQMEventDisplayOutput, process.RPCMONOutput, process.CalibrationOutput, process.EcalCalibrationOutput, process.ALCAPHISYMOutput, process.ALCALUMIPIXELSOutput, process.ExpressOutput, process.NanoDSTOutput, process.DQMHistograms ))
