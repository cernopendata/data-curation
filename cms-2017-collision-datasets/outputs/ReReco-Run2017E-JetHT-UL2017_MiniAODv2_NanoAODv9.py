...
process.NANOEDMAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ReReco-Run2017E-JetHT-UL2017_MiniAODv2_NanoAODv9-00001.root'),
