...
process.SKIMStreamSinglePhotonJetPlusHOFilter = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('SinglePhotonJetPlusHOFilterPath')
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('RAW-RECO'),
        filterName = cms.untracked.string('SinglePhotonJetPlusHOFilter')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('SinglePhotonJetPlusHOFilter.root'),
    outputCommands = cms.untracked.vstring( (
        'drop *', 
        'drop *', 
