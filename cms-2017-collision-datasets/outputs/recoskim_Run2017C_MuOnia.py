...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO,SKIM:BPHSkim,ALCA:TkAlUpsilonMuMu,EI,PAT,DQM:@rerecoCommon --runUnscheduled --nThreads 8 --data --era Run2_2017 --scenario pp --conditions 106X_dataRun2_v20 --eventcontent AOD,MINIAOD,DQM --datatier AOD,MINIAOD,DQMIO --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2017 --filein file:pippo.root -n 100 --python_filename=recoskim_Run2017C_MuOnia.py --no_exec
