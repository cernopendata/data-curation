...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO,SKIM:MuonPOGJPsiSkim+BPHSkim,ALCA:TkAlJpsiMuMu,EI,PAT,DQM:@rerecoCommon --runUnscheduled --nThreads 8 --data --era Run2_2017 --scenario pp --conditions 106X_dataRun2_v20 --eventcontent AOD,MINIAOD,DQM --datatier AOD,MINIAOD,DQMIO --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2017 --filein file:pippo.root -n 100 --python_filename=recoskim_Run2017C_Charmonium.py --no_exec
...
process.SKIMStreamMuonPOGJPsiSkim = cms.OutputModule("PoolOutputModule",
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring(
            'MuonPOGJPsiSkimTrackPath', 
            'MuonPOGJPsiSkimSTAPath'
        )
    ),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('USER'),
        filterName = cms.untracked.string('MuonPOGJPsiSkim')
    ),
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('MuonPOGJPsiSkim.root'),
    outputCommands = cms.untracked.vstring(
        'drop *', 
        'keep *_TriggerResults_*_*', 
