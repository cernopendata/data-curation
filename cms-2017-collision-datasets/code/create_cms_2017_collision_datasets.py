...
"""
Create CMS 2017 open data release collision datasets.
"""
...
def populate_dataset_trigger_list():
    ...
    for line in open("./inputs/hlt-2017-dataset.txt", "r").readlines():
        line = line.strip()
...
def populate_selection_descriptions():
    ...
    for input_file in ["./inputs/CMSDatasetDescription_Run2017.csv"]:
