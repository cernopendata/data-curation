# /cdaq/special/MuScan/v2.5/HLT/V1 (CMSSW_8_0_19_patch2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/MuScan/v2.5/HLT/V1')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_v3" ),
        prescales = cms.vuint32( 1650, 2475, 3300, 4125, 4950 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_Random_part0_v1" ),
        prescales = cms.vuint32( 64, 64, 64, 64, 64 )
      ),
    ...
    lvl1DefaultLabel = cms.string( "Col4" ),
