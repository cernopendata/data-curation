# /cdaq/physics/firstCollisions16/v1.7.1/HLT/V1 (CMSSW_8_0_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions16/v1.7.1/HLT/V1')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_part0_v1" ),
        prescales = cms.vuint32( 450, 350, 350, 200, 100, 50 )
      ),
