# /cdaq/physics/firstCollisions16/v1.3/HLT/V1 (CMSSW_8_0_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions16/v1.3/HLT/V1')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_part0_v1" ),
        prescales = cms.vuint32( 176, 176, 120, 90, 48, 24 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_v1" ),
        prescales = cms.vuint32( 2000, 1000, 1000, 500, 250, 250 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_HcalNZS_v9" ),
        prescales = cms.vuint32( 20, 20, 10, 7, 5, 3 )
      ),
...
process.hltPreExpressPhysicsOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring( 'HLT_Random_v2 / 3',
      'HLT_ZeroBias_v1' ),
    throw = cms.bool( True ),
