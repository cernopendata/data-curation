# /cdaq/special/Circulating2016/v4.0.1/HLT/V1 (CMSSW_8_0_19_patch2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/Circulating2016/v4.0.1/HLT/V1')
)
...
process.datasets = cms.PSet( 
  ...
  Cosmics = cms.vstring( 'HLT_L1DoubleMu0_v1',
    'HLT_L1SingleMu3_v1',
    'HLT_L1SingleMu5_v1',
    'HLT_L1SingleMu7_v1',
    'HLT_L1SingleMuOpen_v6',
    'HLT_L2Mu10_v1' ),
  CosmicsForEventDisplay = cms.vstring(  ),
  EcalLaser = cms.vstring( 'HLT_EcalCalibration_v3' ),
  ExpressCosmics = cms.vstring( 'HLT_L1SingleMuOpen_v6',
    'HLT_Random_v2' ),
  HcalNZS = cms.vstring( 'HLT_HcalNZS_v9',
    'HLT_HcalPhiSym_v10' ),
  L1Accept = cms.vstring( 'DST_Physics_v4' ),
  MinimumBias = cms.vstring( 'HLT_BptxXOR_v1',
    'HLT_ExternBptxAnd_v1',
    'HLT_L1ETT90BptxAND_v1',
    'HLT_L1SingleEG10BptxAND_v1',
    'HLT_L1SingleEG18BptxAND_v1',
    'HLT_L1SingleEG5_v1',
    'HLT_L1SingleIsoEG18BptxAND_v1',
    'HLT_L1SingleJet16_v1',
    'HLT_L1SingleJet36BptxAND_v1',
    'HLT_Physics_v4',
    'HLT_Random_v2',
    'HLT_ZeroBias_v1' ),
  OnlineMonitor = cms.vstring( 'HLT_BptxXOR_v1',
    'HLT_ExternBptxAnd_v1',
    'HLT_HcalNZS_v9',
    'HLT_HcalPhiSym_v10',
    'HLT_L1DoubleMu0_v1',
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG5_v1" ),
        prescales = cms.vuint32( 1, 1, 100, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG10BptxAND_v1" ),
        prescales = cms.vuint32( 1, 1, 100, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG18BptxAND_v1" ),
        prescales = cms.vuint32( 1, 1, 100, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleIsoEG18BptxAND_v1" ),
        prescales = cms.vuint32( 1, 1, 100, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleJet36BptxAND_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 100, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleJet16_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 100, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1ETT90BptxAND_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 100, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_v4" ),
        prescales = cms.vuint32( 80, 80, 800, 800, 800, 80 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_Random_v2" ),
        prescales = cms.vuint32( 120, 10000, 120, 120, 120, 120 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_Random_v1" ),
        prescales = cms.vuint32( 10, 1000, 10, 10, 10, 10 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ExternBptxAnd_v1" ),
        prescales = cms.vuint32( 100, 100, 100, 100, 10000, 100 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_BptxXOR_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 10000, 1 )
      ),
...
process.hltL1sL1SingleMu3 = cms.EDFilter( "HLTL1TSeed",
...
process.hltL1sL1SingleMu7 = cms.EDFilter( "HLTL1TSeed",
...
process.hltL1sL1DoubleMu0 = cms.EDFilter( "HLTL1TSeed",
...
process.hltL1sL1SingleEG10BptxAND = cms.EDFilter( "HLTL1TSeed",
...
process.hltPreL1SingleEG10BptxAND = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sL1SingleEG18 = cms.EDFilter( "HLTL1TSeed",
...
process.hltPreL1SingleEG18BptxAND = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sL1SingleIsoEG18BptxAND = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleIsoEG18_BptxAND" ),
    L1EGammaInputTag = cms.InputTag( 'hltCaloStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltCaloStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1SingleIsoEG18BptxAND = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sL1SingleJet36BptxAND = cms.EDFilter( "HLTL1TSeed",
...
process.hltPreL1SingleJet36BptxAND = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
process.hltL1sL1SingleJet16 = cms.EDFilter( "HLTL1TSeed",
...
process.hltL1sL1ETT90BptxAND = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_ETT90_BptxAND" ),
    L1EGammaInputTag = cms.InputTag( 'hltCaloStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltCaloStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1ETT90BptxAND = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltL1fL1sMu16L1Filtered0 = cms.EDFilter( "HLTMuonL1TFilter",
    saveTags = cms.bool( True ),
...
process.hltL2fL1sMu16L1f0L2Filtered10Q = cms.EDFilter( "HLTMuonL2FromL1TPreFilter",
    saveTags = cms.bool( True ),
...
process.hltL1sHcalNZS = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleEG5 OR L1_SingleJet24 OR L1_SingleMuOpen OR L1_ZeroBias" ),
    L1EGammaInputTag = cms.InputTag( 'hltCaloStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltCaloStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltL1sL1BptxAND = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_ZeroBias" ),
    L1EGammaInputTag = cms.InputTag( 'hltCaloStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltCaloStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
...
process.hltPreExternBptxAnd = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreBptxXOR = cms.EDFilter( "HLTPrescaler",
...
process.hltPreDQMOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring( 'HLT_L1SingleMuOpen_v6',
      'HLT_L1SingleMu3_v1 / 10',
      'HLT_L1SingleMu5_v1 / 10',
      'HLT_L1SingleMu7_v1 / 10',
      'HLT_L1DoubleMu0_v1 / 10',
      'HLT_L1SingleEG5_v1 / 10',
      'HLT_L1SingleEG10BptxAND_v1 / 10',
      'HLT_L1SingleEG18BptxAND_v1 / 10',
      'HLT_L1SingleIsoEG18BptxAND_v1 / 10',
      'HLT_L1SingleJet36BptxAND_v1 / 10',
      'HLT_L1SingleJet16_v1 / 10',
      'HLT_L1ETT90BptxAND_v1 / 10',
      'HLT_L2Mu10_v1 / 10',
      'HLT_Physics_v4 / 10',
      'HLT_ZeroBias_v1',
      'HLT_Random_v2 / 10',
...
process.hltPreExpressCosmicsOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    hltResults = cms.InputTag( "TriggerResults" ),
    l1tResults = cms.InputTag( "" ),
    triggerConditions = cms.vstring( 'HLT_L1SingleMuOpen_v6 / 5',
      'HLT_Random_v2' ),
    l1tIgnoreMaskAndPrescale = cms.bool( False ),
    throw = cms.bool( True )
)
...
process.hltOutputPhysics = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_BptxXOR_v1',
  'HLT_ExternBptxAnd_v1',
  'HLT_HcalNZS_v9',
  'HLT_HcalPhiSym_v10',
  'HLT_L1DoubleMu0_v1',
...
process.hltOutputPhysicsPACastor = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_PAL1CastorHaloMuon_v1' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep FEDRawDataCollection_rawDataCollector_*_*',
      'keep FEDRawDataCollection_source_*_*',
      'keep GlobalObjectMapRecord_hltGtStage2ObjectMap_*_*',
...
process.hltOutputExpressCosmics = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_L1SingleMuOpen_v6',
  'HLT_Random_v2' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep FEDRawDataCollection_rawDataCollector_*_*',
      'keep FEDRawDataCollection_source_*_*',
...
process.HLT_L1SingleMu3_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleMu3 + process.hltPreL1SingleMu3 + process.HLTEndSequence )
...
process.HLT_L1SingleMu7_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleMu7 + process.hltPreL1SingleMu7 + process.HLTEndSequence )
process.HLT_L1DoubleMu0_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1DoubleMu0 + process.hltPreL1DoubleMu0 + process.HLTEndSequence )
...
process.HLT_L1SingleEG10BptxAND_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleEG10BptxAND + process.hltPreL1SingleEG10BptxAND + process.HLTEndSequence )
process.HLT_L1SingleEG18BptxAND_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleEG18 + process.hltPreL1SingleEG18BptxAND + process.HLTEndSequence )
process.HLT_L1SingleIsoEG18BptxAND_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleIsoEG18BptxAND + process.hltPreL1SingleIsoEG18BptxAND + process.HLTEndSequence )
process.HLT_L1SingleJet36BptxAND_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleJet36BptxAND + process.hltPreL1SingleJet36BptxAND + process.HLTEndSequence )
...
process.HLT_L1ETT90BptxAND_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ETT90BptxAND + process.hltPreL1ETT90BptxAND + process.HLTEndSequence )
process.HLT_L2Mu10_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1SingleMuOpen + process.hltPreL2Mu10 + process.hltL1fL1sMu16L1Filtered0 + process.HLTL2muonrecoSequence + process.hltL2fL1sMu16L1f0L2Filtered10Q + process.HLTEndSequence )
...
process.HLT_ExternBptxAnd_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1BptxAND + process.hltPreExternBptxAnd + process.HLTEndSequence )
process.HLT_BptxXOR_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1BptxXOR + process.hltPreBptxXOR + process.HLTEndSequence )
...
process.ExpressForCosmicsOutput = cms.EndPath( process.hltGtStage2Digis + process.hltPreExpressCosmicsOutput + process.hltPreExpressCosmicsOutputSmart + process.hltOutputExpressCosmics )
...
process.TrackerCalibrationOutput = cms.EndPath( process.hltGtStage2Digis + process.hltPreTrackerCalibrationOutput )
process.RateMonitoring = cms.EndPath( process.hltGtStage2Digis + process.hltHLTriggerJSONMonitoring + process.hltL1TriggerJSONMonitoring )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_L1SingleMuOpen_v6, process.HLT_L1SingleMu3_v1, process.HLT_L1SingleMu5_v1, process.HLT_L1SingleMu7_v1, process.HLT_L1DoubleMu0_v1, process.HLT_L1SingleEG5_v1, process.HLT_L1SingleEG10BptxAND_v1, process.HLT_L1SingleEG18BptxAND_v1, process.HLT_L1SingleIsoEG18BptxAND_v1, process.HLT_L1SingleJet36BptxAND_v1, process.HLT_L1SingleJet16_v1, process.HLT_L1ETT90BptxAND_v1, process.HLT_L2Mu10_v1, process.HLT_Physics_v4, process.HLT_ZeroBias_v1, process.HLT_Random_v2, process.HLT_HcalNZS_v9, process.HLT_HcalPhiSym_v10, process.DST_Physics_v4, process.HLT_L1FatEvents_v1, process.HLT_EcalCalibration_v3, process.HLT_HcalCalibration_v3, process.AlCa_EcalPhiSym_v2, process.AlCa_LumiPixels_ZeroBias_v4, process.AlCa_LumiPixels_Random_v1, process.AlCa_RPCMuonNormalisation_v9, process.AlCa_RPCMuonNoHits_v9, process.AlCa_RPCMuonNoTriggers_v9, process.HLT_ExternBptxAnd_v1, process.HLT_BptxXOR_v1, process.HLT_PAL1CastorHaloMuon_v1, process.HLTriggerFinalPath, process.PhysicsOutput, process.PhysicsPACastorOutput, process.ALCALUMIPIXELSOutput, process.ALCAPHISYMOutput, process.CalibrationOutput, process.DQMOutput, process.DQMCalibrationOutput, process.EcalCalibrationOutput, process.DQMEventDisplayOutput, process.ExpressForCosmicsOutput, process.NanoDSTOutput, process.RPCMONOutput, process.TrackerCalibrationOutput, process.RateMonitoring, process.DQMHistograms ))
