# /cdaq/special/VirginRaw/Aug2016/FromTCDSInput/HLT/V1 (CMSSW_8_0_12)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/VirginRaw/Aug2016/FromTCDSInput/HLT/V1')
)
...
process.streams = cms.PSet( 
  PhysicsVirginRaw1 = cms.vstring( 'VRZeroBias0',
    ...
    'VRZeroBias2',
    'VRZeroBias3' ),
  PhysicsVirginRaw2 = cms.vstring( 'VRZeroBias4',
    'VRZeroBias5',
    'VRZeroBias6',
    'VRZeroBias7' )
)
process.datasets = cms.PSet( 
  ...
  VRZeroBias1 = cms.vstring( 'HLT_TCDSType9_1_v1' ),
  VRZeroBias2 = cms.vstring( 'HLT_TCDSType9_2_v1' ),
  VRZeroBias3 = cms.vstring( 'HLT_TCDSType9_3_v1' ),
  VRZeroBias4 = cms.vstring( 'HLT_TCDSType9_4_v1' ),
  VRZeroBias5 = cms.vstring( 'HLT_TCDSType9_5_v1' ),
  VRZeroBias6 = cms.vstring( 'HLT_TCDSType9_6_v1' ),
  VRZeroBias7 = cms.vstring( 'HLT_TCDSType9_7_v1' )
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    lvl1DefaultLabel = cms.string( "VirginRaw" ),
    lvl1Labels = cms.vstring( 'VirginRaw',
      'VirginRaw1',
      'VirginRaw2',
      'VirginRaw3',
      'VirginRaw4' )
...
process.hltTCDSEventsFilterType9 = cms.EDFilter( "HLTTriggerTypeFilter",
...
process.HLTBeginSequenceTCDS = cms.Sequence( process.hltTCDSEventsFilterType9 + process.hltGtStage2Digis )
