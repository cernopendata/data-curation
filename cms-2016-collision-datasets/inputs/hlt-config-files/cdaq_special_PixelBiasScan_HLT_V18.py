# /cdaq/special/PixelBiasScan/HLT/V18 (CMSSW_8_0_12)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/PixelBiasScan/HLT/V18')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_Random_v2" ),
        prescales = cms.vuint32( 2000, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60, 60 )
      ),
