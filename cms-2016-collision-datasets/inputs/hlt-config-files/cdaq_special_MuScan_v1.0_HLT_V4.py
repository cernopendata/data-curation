# /cdaq/special/MuScan/v1.0/HLT/V4 (CMSSW_8_0_12)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/MuScan/v1.0/HLT/V4')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_Random_v2" ),
        prescales = cms.vuint32( 120, 120, 120, 120, 120 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_v3" ),
        prescales = cms.vuint32( 1000, 1500, 2000, 2500, 3000 )
      ),
