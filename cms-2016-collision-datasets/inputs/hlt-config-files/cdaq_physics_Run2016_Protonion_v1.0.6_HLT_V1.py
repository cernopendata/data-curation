# /cdaq/physics/Run2016/Protonion/v1.0.6/HLT/V1 (CMSSW_8_0_19_patch2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2016/Protonion/v1.0.6/HLT/V1')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "DQMOutput" ),
        prescales = cms.vuint32( 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 32, 16, 8, 4, 2, 2, 1 )
      )
    ),
