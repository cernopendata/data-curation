# /cdaq/special/Tests/PixelDQM/HLT/V2 (CMSSW_8_0_19_patch2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/Tests/PixelDQM/HLT/V2')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_Physics_v2" ),
        prescales = cms.vuint32( 1, 80, 800, 800, 800, 80 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_Random_v1" ),
        prescales = cms.vuint32( 1, 10000, 60, 60, 60, 60 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "DQMOutput" ),
        prescales = cms.vuint32( 1, 1, 5, 5, 5, 5 )
      ),
