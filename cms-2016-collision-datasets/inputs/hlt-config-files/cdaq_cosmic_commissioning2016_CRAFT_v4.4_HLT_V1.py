# /cdaq/cosmic/commissioning2016/CRAFT/v4.4/HLT/V1 (CMSSW_8_0_19_patch2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/cosmic/commissioning2016/CRAFT/v4.4/HLT/V1')
)
...
process.datasets = cms.PSet( 
  ...
  ExpressCosmics = cms.vstring( 'HLT_L1SingleMuOpen_DT_v2',
    'HLT_L1SingleMuOpen_v2',
    'HLT_Random_v1' ),
  ...
  MinimumBias = cms.vstring( 'HLT_L1SingleEG5_v1',
    'HLT_L1TowerCount40_v1',
    'HLT_Physics_v2',
    'HLT_Random_v1',
    'HLT_ZeroBias_v2' ),
  NoBPTX = cms.vstring( 'HLT_JetE50_NoBPTX3BX_v5',
    'HLT_JetE70_NoBPTX3BX_v5',
    'HLT_L2Mu10_NoVertex_NoBPTX_v2' ),
  OnlineMonitor = cms.vstring( 'HLT_HcalNZS_v2',
    'HLT_HcalPhiSym_v2',
    'HLT_JetE50_NoBPTX3BX_v5',
    'HLT_JetE70_NoBPTX3BX_v5',
    'HLT_L1DoubleMu0_v1',
    'HLT_L1FatEvents_v1',
    'HLT_L1SingleEG5_v1',
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_Random_v1" ),
        prescales = cms.vuint32( 60, 10000, 60, 60, 60, 60 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG5_v1" ),
        prescales = cms.vuint32( 3, 3, 100, 3, 3, 3 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_LumiPixels_Random_v1" ),
        prescales = cms.vuint32( 10, 1500, 10, 10, 10, 10 )
      ),
...
process.hltL1sHcalNZS = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleEG5 OR L1_SingleJet24 OR L1_ZeroBias" ),
    L1EGammaInputTag = cms.InputTag( 'hltCaloStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltCaloStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltL1sTowerCount40 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_TowerCount40" ),
    L1EGammaInputTag = cms.InputTag( 'hltCaloStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltCaloStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreL1TowerCount40 = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltL1sSingleJetC40NotBptxOR3BXIorSingleJetC40NotBptxOR5BX = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleJetC40_NotBptxOR_3BX OR L1_SingleJetC40_NotBptxOR_5BX" ),
    L1EGammaInputTag = cms.InputTag( 'hltCaloStage2Digis','EGamma' ),
    L1JetInputTag = cms.InputTag( 'hltCaloStage2Digis','Jet' ),
    saveTags = cms.bool( True ),
    L1ObjectMapInputTag = cms.InputTag( "hltGtStage2ObjectMap" ),
...
process.hltPreJetE50NoBPTX3BX = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtStage2Digis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreDQMOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring( '( FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR HLT_L1SingleMu3_v1 OR HLT_L1SingleMuOpen_v2 OR HLT_L1SingleMuOpen_DT_v2 OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR FALSE OR HLT_Random_v1 OR HLT_L1SingleEG5_v1 OR FALSE OR HLT_HcalNZS_v2 OR HLT_HcalPhiSym_v2 ) / 2',
      'HLT_L1FatEvents_v1',
      'HLT_Physics_v2 / 10',
      'HLT_ZeroBias_v2 / 30',
      'HLT_L1DoubleMu0_v1 / 30' ),
...
process.hltPreExpressOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    hltResults = cms.InputTag( "TriggerResults" ),
    l1tResults = cms.InputTag( "" ),
    triggerConditions = cms.vstring( 'HLT_L1SingleMuOpen_v2 / 4',
      'HLT_Random_v1 / 2' ),
    l1tIgnoreMaskAndPrescale = cms.bool( False ),
    throw = cms.bool( True )
)
...
process.hltOutputExpressCosmics = cms.OutputModule( "ShmStreamConsumer",
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_L1SingleMuOpen_DT_v2',
  'HLT_L1SingleMuOpen_v2',
  'HLT_Random_v1' ) ),
    outputCommands = cms.untracked.vstring( 'drop *',
      'keep FEDRawDataCollection_rawDataCollector_*_*',
...
process.HLT_L1TowerCount40_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sTowerCount40 + process.hltPreL1TowerCount40 + process.HLTEndSequence )
...
process.HLT_JetE50_NoBPTX3BX_v5 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJetC40NotBptxOR3BXIorSingleJetC40NotBptxOR5BX + process.hltPreJetE50NoBPTX3BX + process.HLTStoppedHSCPLocalHcalReco + process.hltStoppedHSCPHpdFilter + process.HLTStoppedHSCPJetSequence + process.hltStoppedHSCP1CaloJetEnergy50 + process.HLTEndSequence )
process.HLT_JetE70_NoBPTX3BX_v5 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleJetC40NotBptxOR3BXIorSingleJetC40NotBptxOR5BX + process.hltPreJetE70NoBPTX3BX + process.HLTStoppedHSCPLocalHcalReco + process.hltStoppedHSCPHpdFilter + process.HLTStoppedHSCPJetSequence + process.hltStoppedHSCP1CaloJetEnergy70 + process.HLTEndSequence )
process.HLT_L2Mu10_NoVertex_NoBPTX_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sSingleMuOpenNotBptxOR + process.hltPreL2Mu10NoVertexNoBPTX + process.hltL1fL1sMuOpenNotBptxORL1Filtered0 + process.HLTL2muonrecoSequenceNoVtxCosmicSeedMeanTimer + process.hltL2fL1sMuOpenNotBptxORL1f0NoVtxCosmicSeedMeanTimerL2Filtered10 + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_L1SingleMu3_v1, process.HLT_L1SingleMu5_v1, process.HLT_L1SingleMu7_v1, process.HLT_L1SingleMuOpen_v2, process.HLT_L1SingleMuOpen_DT_v2, process.HLT_L1FatEvents_v1, process.HLT_Physics_v2, process.DST_Physics_v1, process.HLT_Random_v1, process.HLT_ZeroBias_v2, process.HLT_L1DoubleMu0_v1, process.HLT_L1SingleEG5_v1, process.HLT_EcalCalibration_v2, process.HLT_HcalCalibration_v1, process.AlCa_EcalPhiSym_v4, process.HLT_HcalNZS_v2, process.HLT_HcalPhiSym_v2, process.HLT_L1TowerCount40_v1, process.AlCa_RPCMuonNoTriggers_v2, process.AlCa_RPCMuonNoHits_v2, process.AlCa_RPCMuonNormalisation_v2, process.AlCa_LumiPixels_Random_v1, process.AlCa_LumiPixels_ZeroBias_v2, process.HLT_JetE50_NoBPTX3BX_v5, process.HLT_JetE70_NoBPTX3BX_v5, process.HLT_L2Mu10_NoVertex_NoBPTX_v2, process.HLT_PAL1CastorHaloMuon_v1, process.HLTriggerFinalPath, process.RatesMonitoring, process.PhysicsEGammaCommissioningOutput, process.PhysicsPACastorOutput, process.DQMOutput, process.DQMCalibrationOutput, process.DQMEventDisplayOutput, process.RPCMONOutput, process.CalibrationOutput, process.EcalCalibrationOutput, process.ALCAPHISYMOutput, process.ALCALUMIPIXELSOutput, process.ExpressOutput, process.NanoDSTOutput, process.DQMHistograms ))
