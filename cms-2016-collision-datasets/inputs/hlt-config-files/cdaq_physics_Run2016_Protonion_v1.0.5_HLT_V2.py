# /cdaq/physics/Run2016/Protonion/v1.0.5/HLT/V2 (CMSSW_8_0_19_patch2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/Run2016/Protonion/v1.0.5/HLT/V2')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_PADmesonPPTrackingGlobal_Dpt5_v1" ),
        prescales = cms.vuint32( 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 3, 2, 1, 1, 1, 1, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_PAL1MinimumBiasHF_OR_v1" ),
        prescales = cms.vuint32( 101, 101, 101, 101, 101, 101, 101, 101, 101, 101, 65, 33, 17, 9, 4, 2, 2, 1 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_L1FatEvents_v2" ),
        prescales = cms.vuint32( 71, 71, 71, 71, 71, 71, 71, 71, 39, 24, 16, 9, 4, 3, 2, 1, 1, 1 )
      ),
...
process.hltPreDQMOutputSmart = cms.EDFilter( "TriggerResultsFilter",
    ...
    triggerConditions = cms.vstring( 'HLT_PAL1CastorMediumJet_BptxAND_v1',
      ...
      'HLT_PAFullTracks_HFSumEt005_HighPt8_v2',
      'HLT_PAFullTracks_HFSumEt005_HighPt16_v2',
      'HLT_PAL1MinimumBiasHF_OR_v1 / 16',
      'HLT_PAL1MinimumBiasHF_OR_SinglePixelTrack_v1',
      'HLT_PAL1MinimumBiasHF_OR_SinglePixelTrack_FirstCollisionAfterAbortGap_v1',
      'HLT_PAL1MinimumBiasHF_OR_SinglePixelTrack_part1_v1',
      'HLT_PAL1MinimumBiasHF_OR_SinglePixelTrack_part2_v1',
