# /cdaq/physics/firstCollisions16/v1.5/HLT/V2 (CMSSW_8_0_5)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/physics/firstCollisions16/v1.5/HLT/V2')
)
...
process.datasets = cms.PSet( 
  ...
  HLTPhysicspart0 = cms.vstring( 'HLT_Physics_part0_v4' ),
  HLTPhysicspart1 = cms.vstring( 'HLT_Physics_part1_v4' ),
  HLTPhysicspart2 = cms.vstring( 'HLT_Physics_part2_v4' ),
  HLTPhysicspart3 = cms.vstring( 'HLT_Physics_part3_v4' ),
  HLTPhysicspart4 = cms.vstring( 'HLT_Physics_part4_v4' ),
  HLTPhysicspart5 = cms.vstring( 'HLT_Physics_part5_v4' ),
  HLTPhysicspart6 = cms.vstring( 'HLT_Physics_part6_v4' ),
  HLTPhysicspart7 = cms.vstring( 'HLT_Physics_part7_v4' ),
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "HLT_L1SingleMu5_v1" ),
        prescales = cms.vuint32( 10, 10, 10, 5, 2, 1 )
      ),
