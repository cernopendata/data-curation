# /cdaq/special/VdMScan/v4.1/HLT/V2 (CMSSW_8_0_7)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/VdMScan/v4.1/HLT/V2')
)
...
process.streams = cms.PSet( 
  ...
  PhysicsVdM0 = cms.vstring( 'ZeroBias0' ),
...
process.datasets = cms.PSet( 
  ...
  OnlineMonitor = cms.vstring( 'HLT_L1AlwaysTrue_part1_v1',
    ...
    'HLT_ZeroBias_part7_v1',
    'HLT_ZeroBias_part8_v1' ),
  ZeroBias0 = cms.vstring( 'HLT_Random_v1',
    'HLT_ZeroBias_Ungated_v1' ),
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      ...
      cms.PSet(  pathName = cms.string( "ExpressPhysicsOutput" ),
    ...
    lvl1Labels = cms.vstring( 'ZeroBias',
      'AlwaysTrue',
      'Test' )
)
...
process.hltL1sL1ZeroBiasUngated = cms.EDFilter( "HLTL1TSeed",
...
process.HLT_ZeroBias_Ungated_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ZeroBiasUngated + process.hltPreZeroBiasUngated + process.HLTEndSequence )
...
process.LookAreaOutput = cms.EndPath( process.hltDQMFileSaver + process.hltGtStage2Digis + process.hltPreLookAreaOutput + process.hltPreLookAreaOutputSmart )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_L1AlwaysTrue_part1_v1, process.HLT_L1AlwaysTrue_part2_v1, process.HLT_L1AlwaysTrue_part3_v1, process.HLT_L1AlwaysTrue_part4_v1, process.HLT_L1AlwaysTrue_part5_v1, process.HLT_L1AlwaysTrue_part6_v1, process.HLT_L1AlwaysTrue_part7_v1, process.HLT_L1AlwaysTrue_part8_v1, process.HLT_ZeroBias_part1_v1, process.HLT_ZeroBias_part2_v1, process.HLT_ZeroBias_part3_v1, process.HLT_ZeroBias_part4_v1, process.HLT_ZeroBias_part5_v1, process.HLT_ZeroBias_part6_v1, process.HLT_ZeroBias_part7_v1, process.HLT_ZeroBias_part8_v1, process.HLT_ZeroBias_Ungated_v1, process.HLT_Random_v1, process.DST_Physics_v1, process.HLTriggerFinalPath, process.PhysicsVdM0Output, process.PhysicsVdM1Output, process.PhysicsVdM2Output, process.PhysicsVdM3Output, process.PhysicsVdM4Output, process.PhysicsVdM5Output, process.PhysicsVdM6Output, process.PhysicsVdM7Output, process.PhysicsVdM8Output, process.ExpressPhysicsOutput, process.DQMOutput, process.DQMEventDisplayOutput, process.NanoDSTOutput, process.RatesMonitoring, process.LookAreaOutput, process.DQMHistograms ))
