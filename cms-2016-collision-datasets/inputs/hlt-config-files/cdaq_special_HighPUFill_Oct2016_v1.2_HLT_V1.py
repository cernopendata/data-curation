# /cdaq/special/HighPUFill/Oct2016/v1.2/HLT/V1 (CMSSW_8_0_19_patch2)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/cdaq/special/HighPUFill/Oct2016/v1.2/HLT/V1')
)
...
process.PrescaleService = cms.Service( "PrescaleService",
    ...
    prescaleTable = cms.VPSet( 
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_v4" ),
        prescales = cms.vuint32( 92, 92, 92, 92, 75, 95, 175, 265 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_BunchTrains_part0_v1" ),
        prescales = cms.vuint32( 6, 6, 6, 6, 6, 6, 6, 6 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_ZeroBias_IsolatedBunches_v3" ),
        prescales = cms.vuint32( 90, 90, 90, 90, 150, 190, 350, 530 )
      ),
      ...
      cms.PSet(  pathName = cms.string( "HLT_Random_v2" ),
        prescales = cms.vuint32( 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_Physics_v4" ),
        prescales = cms.vuint32( 35, 25, 19, 14, 2, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_PhysicsIsolatedBunches_part0_v1" ),
        prescales = cms.vuint32( 50, 34, 17, 7, 6, 5, 5, 5 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_PhysicsBunchTrains_part0_v1" ),
        prescales = cms.vuint32( 220, 176, 133, 98, 1, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1FatEvents_v1" ),
        prescales = cms.vuint32( 35, 25, 19, 14, 2, 1, 1, 1 )
      ),
      cms.PSet(  pathName = cms.string( "AlCa_EcalPhiSym_v6" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 2, 3, 5, 7 )
      ),
      cms.PSet(  pathName = cms.string( "HLT_L1SingleEG34_IsolatedBunches_v1" ),
        prescales = cms.vuint32( 1, 1, 1, 1, 4, 2, 2, 2 )
      )
    ),
    lvl1DefaultLabel = cms.string( "HighPU_0" ),
    lvl1Labels = cms.vstring( 'HighPU_0',
      'HighPU_1',
      'HighPU_2',
      'HighPU_3',
      '10b_0',
