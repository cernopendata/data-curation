...
# with command line options: RECO --conditions 106X_dataRun2_v35 --datatier MINIAOD --eventcontent MINIAOD --filein _placeholder_.root --fileout file:ReReco-Run2016H-MuOnia-UL2016_MiniAODv2-00002.root --nThreads 2 --no_exec --python_filename ReReco-Run2016H-MuOnia-UL2016_MiniAODv2-00002_0_cfg.py --scenario pp --step PAT --runUnscheduled --data --procModifiers run2_miniAOD_UL_preSummer20
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ReReco-Run2016H-MuOnia-UL2016_MiniAODv2-00002.root'),
