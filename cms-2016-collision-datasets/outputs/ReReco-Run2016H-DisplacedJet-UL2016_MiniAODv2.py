...
# with command line options: RECO --conditions 106X_dataRun2_v35 --datatier MINIAOD --eventcontent MINIAOD --filein _placeholder_.root --fileout file:ReReco-Run2016H-DisplacedJet-UL2016_MiniAODv2-00001.root --nThreads 2 --no_exec --python_filename ReReco-Run2016H-DisplacedJet-UL2016_MiniAODv2-00001_0_cfg.py --scenario pp --step PAT --runUnscheduled --data --procModifiers run2_miniAOD_UL_preSummer20
import FWCore.ParameterSet.Config as cms

from Configuration.ProcessModifiers.run2_miniAOD_UL_preSummer20_cff import run2_miniAOD_UL_preSummer20

process = cms.Process('PAT',run2_miniAOD_UL_preSummer20)
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ReReco-Run2016H-DisplacedJet-UL2016_MiniAODv2-00001.root'),
