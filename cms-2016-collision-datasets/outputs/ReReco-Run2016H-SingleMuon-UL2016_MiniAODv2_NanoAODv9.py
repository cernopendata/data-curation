...
process.NANOEDMAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ReReco-Run2016H-SingleMuon-UL2016_MiniAODv2_NanoAODv9-00001.root'),
