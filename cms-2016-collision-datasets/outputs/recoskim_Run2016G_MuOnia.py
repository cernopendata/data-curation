...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO,SKIM:BPHSkim+LogError+LogErrorMonitor,ALCA:TkAlUpsilonMuMu,EI,PAT,DQM:@rerecoCommon --runUnscheduled --nThreads 8 --data --era Run2_2016 --scenario pp --conditions 106X_dataRun2_v27 --eventcontent AOD,MINIAOD,DQM --datatier AOD,MINIAOD,DQMIO --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2016,Configuration/DataProcessing/Utils.addMonitoring --filein file:test.root -n 100 --python_filename=recoskim_Run2016G_MuOnia.py --no_exec
