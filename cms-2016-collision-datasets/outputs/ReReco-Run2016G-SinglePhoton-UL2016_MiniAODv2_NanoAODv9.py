...
process.NANOEDMAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:ReReco-Run2016G-SinglePhoton-UL2016_MiniAODv2_NanoAODv9-00002.root'),
